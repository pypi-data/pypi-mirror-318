...
from heaserver.folderawss3.util import delete_folder as util_delete_folder, get_result_or_see_other, MONGODB_AWS_S3_FOLDER_METADATA_COLLECTION
        ...
        async with mongo.MongoContext(request) as mongo_client:
            ...
            async with DesktopObjectActionLifecycle(request,
                ...
                if 'path' in request.url.query:
                    ...
                    target_path = None
                await rename(activity, request, mongo_client, sub, volume_id, bucket_id, old_id, old_key, project, AWSS3Project, target_path)
