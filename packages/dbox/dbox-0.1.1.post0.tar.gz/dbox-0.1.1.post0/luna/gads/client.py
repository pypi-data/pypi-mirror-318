...
if __name__ == "__main__":
    from luna.env import GOOGLE_ADS_DEVELOPER_TOKEN
    from luna.google.auth import read_user_credentials
    from luna.logging.colored import setup_colored_logging
