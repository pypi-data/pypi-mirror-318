...
class dataListTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.pfdat = js.dL([js.dynamic.simpleDiffusion(q=q, t=np.r_[1:100:5], D=1, w=0) for q in np.r_[0.2:2:0.4]])
    ...
    def test_fit(self):
        ...
        # test polyfit
        pfcalc = js.dynamic.simpleDiffusion(q=0.4, t=np.r_[1:100:5], D=1, w=0).Y
...
class formelTest(unittest.TestCase):
    ...
    def test_quadrature(self):
        ...
        diff_g = js.formel.parQuadratureSimpson(js.dynamic.simpleDiffusion, -3 * ds + D, 3 * ds + D, parname='D',
                                                weights=pdf, tol=0.01, q=0.5, t=t, w=0)
