...
A short version of the format of **.inx** files used at **backscattering and TOF** instruments.
I can only guess the meaning of numbers in first line (data lines; comment lines; par lines;...; sum of lines ).
Somewhere is the Q value (2.46 ?) (This is a short cut out)::
...
Read by::
 ...
 # this saves the lines in attribute line_2,...
 ino = js.dL('data.inx',block='  943    1',lines2parameter=[-1,-2,-3,-4])
