...
async def create_openai_client(endpoint_data):
    ...
    try:
        ...
        model_ids = [model.id for model in models.data] if endpoint_data['model'][0] == 'auto' else endpoint_data['model']
        owned_by = [model.owned_by for model in models.data] if endpoint_data['owned_by'][0] == 'auto' else endpoint_data['owned_by']
...
def parse_arguments():
    ...
    for i in range(num_endpoints):
        endpoint_data = {
            ...
            'report_file': args.report_file[i] if i < len(args.report_file) else args.report_file[0],
        }
