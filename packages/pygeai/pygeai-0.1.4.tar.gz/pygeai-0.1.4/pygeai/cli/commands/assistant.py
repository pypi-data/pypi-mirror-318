...
def create_assistant(option_list: list):
    ...
    sys.stdout.write(f"New assistant detail: \n{result}\n")


def get_llm_settings(provider_name, model_name, temperature, max_tokens):
    llm_settings = {}
...
def get_welcome_data(welcome_data_title, welcome_data_description, feature_list, examples_prompt_list):
    features = []
    examples_prompt = []
    if any(feature_list):
        try:
...
def update_assistant(option_list: list):
    ...
    sys.stdout.write(f"Updated assistant detail: \n{result}\n")
...
def send_chat_request(option_list: list):
    ...
    sys.stdout.write(f"Chat request response: \n{result}\n")
...
def get_request_status(option_list: list):
    ...
    sys.stdout.write(f"Request status: \n{result}\n")
...
def cancel_request(option_list: list):
    ...
    sys.stdout.write(f"Cancel request detail: \n{result}\n")
