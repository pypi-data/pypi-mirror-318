...
module mkAXI4_top(CLK,
  ...
  wire [31 : 0] a_araddr__h5563, a_awaddr__h4387;
  wire NOT_fabric_cfg_verbosity_read__7_ULE_1_8___d29,
  ...
  assign fabric_xactors_to_slaves_0_f_rd_addr_D_IN =
	     { 18'd0, fabric_xactors_from_masters_0_f_rd_addr_D_OUT[16:0] } ;
  ...
  assign fabric_xactors_to_slaves_0_f_wr_addr_D_IN =
	     { 18'd0, fabric_xactors_from_masters_0_f_wr_addr_D_OUT[16:0] } ;
  ...
  // remaining internal signals
  assign NOT_fabric_cfg_verbosity_read__7_ULE_1_8___d29 =
	     fabric_cfg_verbosity > 4'd1 ;
  assign a_araddr__h5563 =
	     { 18'd0, fabric_xactors_from_masters_0_f_rd_addr_D_OUT[16:3] } ;
  assign a_awaddr__h4387 =
	     { 18'd0, fabric_xactors_from_masters_0_f_wr_addr_D_OUT[16:3] } ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  NOT_fabric_cfg_verbosity_read__7_ULE_1_8___d29)
	begin
	  v__h4571 = $stime;
	  #0;
	end
    v__h4565 = v__h4571 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_fabric_rl_wr_xaction_master_to_slave &&
	  NOT_fabric_cfg_verbosity_read__7_ULE_1_8___d29)
    ...
    v__h2995 = v__h3001 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (fabric_rg_reset)
	$display("%0d: AXI4_Lite_Fabric.rl_reset", v__h2995);
  end
  // synopsys translate_on
endmodule  // mkAXI4_top
