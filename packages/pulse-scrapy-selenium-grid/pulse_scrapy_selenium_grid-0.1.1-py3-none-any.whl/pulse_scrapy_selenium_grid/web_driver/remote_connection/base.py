...
class RemoteConnection(BaseRemoteConnection):
    ...
    def __init__(self, remote_server_addr: str, keep_alive: bool = True):
        self.remove_server_addr = remote_server_addr
        self.keep_alive = keep_alive
        super().__init__(remote_server_addr=remote_server_addr, keep_alive=keep_alive)
    ...
    async def execute(self, command, params):
        ...
        url = f"{self.remove_server_addr}{path}"
