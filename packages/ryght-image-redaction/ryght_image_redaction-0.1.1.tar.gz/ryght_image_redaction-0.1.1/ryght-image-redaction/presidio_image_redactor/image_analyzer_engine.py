...
from presidio_image_redactor import OCR, ImagePreprocessor, TesseractOCR, DocumentIntelligenceOCR
...
class ImageAnalyzerEngine:
    ...
    def __init__(
        ...
        self.ocr = DocumentIntelligenceOCR("something", "we dont")
    ...
    def analyze(
        ...
        **text_analyzer_kwargs
        ...
        ocr_result = self.ocr.perform_ocr(preprocessed_ocr_result=preprocessed_ocr_result)
