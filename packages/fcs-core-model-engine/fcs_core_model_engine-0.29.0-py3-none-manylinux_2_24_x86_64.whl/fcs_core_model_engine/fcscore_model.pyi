...
class Model:
    ...
    def add_geometry(self, 
                     file_id: int, geometry: GEOM_Object, 
                     add_with_refined_resolution: bool = True) -> GeometryInstance: ...
    ...
    # def move_geometric_shape(self, 
    #                source_shape_id: int, 
    #                target_file_id: int, 
    #                perform_copy_paste: bool=True) -> List[int]: ...
