...
# User
RegisterCliArgument('user',                   'User',                 typ=str, default=None,           description='If given, this user is used for accessing the domain')
RegisterCliArgument('password',               'Password',             typ=str, default=None,           description='If given and user is given, this password is used for accessing the domain', isSecret=True)
# Logging
...
RegisterCliArgument('logDir',                 "Log path",             typ=str, default='./log/domain', description='Destination folder for log files')
