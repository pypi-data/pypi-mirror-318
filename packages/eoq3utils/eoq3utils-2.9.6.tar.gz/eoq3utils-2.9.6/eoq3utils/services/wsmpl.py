...
def PyEoq3WebSocketMpl(argv:List[Any])->int:
    ...
    # print header
    PrintCliHeader("eoq3utils.services.wsmpl", version,{"eoq3": eoqVersion, "eoq3pyecorempl": pyEcoreMplVersion, "eoq3autobahnws": autobahnWsVersion}, shallPrint=args.printHeader)
    # print args
