...
# eoq cli commons
from ..cli.common import PrintCliHeader, GetCliPredefinedArguments, ArgparseToEoqConfig, CliArgument, LogginIfDesired, PrintCliArgumentValues
...
def PyEoq3WebSocketActionHandler(argv:List[Any])->int:
    ...
    # print header
    PrintCliHeader("eoq3utils.services.wsactionhandler", version,{"eoq3": eoqVersion, "eoq3pyactions": pyActionsVersion, "eoq3autobahnws": autobahnWsVersion}, shallPrint=args.printHeader)
    # print args
