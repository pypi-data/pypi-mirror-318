...
# eoq cli commons
from ..cli.common import PrintCliHeader, GetCliPredefinedArguments, ArgparseToEoqConfig, PrintCliArgumentValues
...
def PyEoq3WebSocketDomain(argv:List[Any])->int:
    ...
    # print header
    PrintCliHeader("eoq3utils.services.wsdomain",version,{"eoq3":eoqVersion, "eoq3pyecoremdb":pyEcoreMdbVersion,"eoq3autobahnws":autobahnWsVersion, "eoq3pyaccesscontroller":pyAccessControllerVersion},shallPrint=args.printHeader)
    #print args
