...
def DomainDoWsCli(argv:List[Any]):
    ...
    # print header
    PrintCliHeader("eoq3utils.cli.domaindowscli", version, None, shallPrint=args.printHeader)
    # print args
...
if __name__ == '__main__':
    ...
    #os._exit(code) #prevents the last line to be printed