...
class SSH(Integration):
    ...
    def register(self, member):
        ...
        if (path / 'id_solar.pub').is_file():
            with open(path / 'id_solar.pub', 'r') as f:
                pub = f.read()
        ...
        with open(path / 'id_solar', 'w') as f:
            f.write(sec)

        with open(path / 'id_solar.pub', 'w') as f:
            f.write(pub)

        os.chmod(path / 'id_solar', 0o600)
        os.chmod(path / 'id_solar.pub', 0o600)
