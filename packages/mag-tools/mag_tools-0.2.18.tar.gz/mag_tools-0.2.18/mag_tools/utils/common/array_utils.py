...
class ArrayUtils:
    ...
    @staticmethod
    def lines_to_array_2d(lines: List[str], nx: int, ny: int, data_type: DataType = DataType.INTEGER) -> List[
        List[Any]]:
        """
        从文本块获取数值列表
    ...
    @staticmethod
    def lines_to_array_3d(block_lines: List[str], nx: int, ny: int, nz: int, data_type: DataType = DataType.INTEGER) -> \
    List[List[List[Any]]]:
        """
        从文本块获取数值列表
