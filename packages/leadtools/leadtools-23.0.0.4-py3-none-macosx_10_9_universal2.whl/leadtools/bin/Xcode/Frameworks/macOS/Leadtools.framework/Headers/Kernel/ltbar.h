...
#define BARCODE_IMAGETYPE_UNKOWN          0x80000000  /* the image is a picture, not a scanned document */
#define BARCODE_QR_MODULAR_BOUNDS         0x00000020
...
#define BARCODES_1D                       0x00001
#define BARCODES_2D_READ                  0x00002
#define BARCODES_2D_WRITE                 0x00004
#define BARCODES_PDF_READ                 0x00008
#define BARCODES_PDF_WRITE                0x00010
#define BARCODES_DATAMATRIX_READ          0x00020
#define BARCODES_DATAMATRIX_WRITE         0x00040
#define BARCODES_QR_READ                  0x00080
#define BARCODES_QR_WRITE                 0x00100
#define BARCODES_MICRO_PDF_READ           0x00200
#define BARCODES_MICRO_PDF_WRITE          0x00400
#define BARCODES_MICRO_QR_READ            0x00800
#define BARCODES_MICRO_QR_WRITE           0x01000
#define BARCODES_AZTEC_READ               0x02000
#define BARCODES_AZTEC_WRITE              0x04000
#define BARCODES_MAXI_READ                0x08000
#define BARCODES_MAXI_WRITE               0x10000
...
/**
 * Defines barcode reading profiles to optimize performance based on input image characteristics.
 */
typedef enum {
   L_BARCODE_PROFILE_HIGH_QUALITY_SOURCE,  // Default, fastest processing for high-quality images.
   L_BARCODE_PROFILE_LOW_QUALITY_SOURCE,   // Optimized for low-quality images, prioritizes accuracy.
   L_BARCODE_PROFILE_SMALL_BARCODES,       // For small barcodes.
   L_BARCODE_PROFILE_NATURAL_PICTURE       // For barcodes in natural pictures.
} L_BARCODE_PROFILE;
...
L_LTBAR_API L_INT EXT_FUNCTION L_BarCodeGetProfileSettings(L_BARCODE_PROFILE profile, L_UINT32* puFlags, pBARCODE1D pBarCode1D, pBARCODEREADPDF pBarCodePDF,
   pBARCODECOLOR pBarCodeColor, L_INT* pUnits);

L_LTBAR_API L_INT EXT_FUNCTION L_BarCodesRead(pBITMAPHANDLE   pBitmap,
                                RECT*           prcSearch,
                                L_UINT32*       puSearchTypes,
                                L_UINT32        uSearchTypesCount,
                                L_INT           nUnits,
                                L_UINT32        uFlags,
                                ...
                                pBARCODEDATA*   ppBarCodesData,
                                L_UINT          uStructSize,
                                L_INT           nMaximumImageWidth,
                                L_INT           nMaximumImageHeight);
...
L_LTBAR_API L_INT EXT_FUNCTION L_BarCodeConvertToUTF8String(L_CHAR* pszBarCodeData, L_INT nDataLength, L_CHAR** pszUTF8String, L_INT* pUTF8StringLength);

L_LTBAR_API L_INT EXT_FUNCTION L_FreeBarCodeDataBuffer(L_CHAR** ppBarCodeData);
