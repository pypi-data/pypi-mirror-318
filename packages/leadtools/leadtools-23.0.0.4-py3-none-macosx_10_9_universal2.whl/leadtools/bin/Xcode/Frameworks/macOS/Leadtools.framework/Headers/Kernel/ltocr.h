...
L_LTOCR_API L_INT EXT_FUNCTION L_OcrPage_SwapZonesAtA(L_OcrPage page, L_INT index_1, L_INT index_2);
...
L_LTOCR_API L_INT EXT_FUNCTION L_OcrPage_SwapZonesAt(L_OcrPage page, L_INT index_1, L_INT index_2);
...
#define L_OcrPage_SwapZonesAt L_OcrPage_SwapZonesAtA
