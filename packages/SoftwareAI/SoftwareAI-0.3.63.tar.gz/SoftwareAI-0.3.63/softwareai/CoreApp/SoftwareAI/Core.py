...
class Agent_destilation:
    ...
    def DestilationResponseAgent(input, output, instructionsassistant, nameassistant):                        
        ...
        output_path_json2 = os.path.abspath(os.path.join(os.path.dirname(__file__), f'../Destilation/{nameassistant}/Jsonl_2/DestilationAgent{date}', f"DestilationDateTime_{datereplace}.json"))
        ...
        with open(output_path_json2, '+', encoding='utf-8') as json_file:
