...
class Agent_destilation:
    ...
    def DestilationResponseAgent(input, output, instructionsassistant, nameassistant):                        
        ...
        output_path_json2 = os.path.abspath(os.path.join(os.path.dirname(__file__), f'../Destilation/{nameassistant}/Jsonl_2/DestilationAgent{date}'))
        ...
        finaloutputjson2 = os.path.join(output_path_json2, f"DestilationDateTime_{datereplace}.json")
