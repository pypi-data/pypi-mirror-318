...
class SoftwareDevelopment:
    ...
    def AI_QuantumCore(
        ...
        allenvdic = load_env(repo_name)
        python_functions.save_TXT(allenvdic, os.path.abspath(os.path.join(os.path.dirname(__file__), "../../", f"environment.txt")), 'w')
        ...
        if UseVectorstoreToGenerateFiles == True:
            file_paths = [os.path.abspath(os.path.join(os.path.dirname(__file__), "../../", f"environment.txt")), timeline_file_path, spreadsheet_file_path, pre_project_file_path, Roadmap_file_path, analysis_txt_path]
            ...
            mensaxgem = f"""crie e salve utilizando autosave main.py, config.py, file_utils.py, module1.py, module2.py, service1.py, service2.py, test_module1.py, test_module2.py, test_service1.py, test_service2.py, Example.py, requirements.txt, LICENSE.txt, setup.py, pyproject.toml   com base nos requisitos fornecidos no analysis e nos outros documentos que estao armazenados em QuantumCore_Work_Environment \n
            """
            ...
            mensaxgem = f"""crie e salve utilizando autosave um script em python com base nos requisitos fornecidos no analysis e nos outros documentos\n
            analysis\n
