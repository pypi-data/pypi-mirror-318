...
class SoftwareDevelopment:
    ...
    def AI_QuantumCore(
        ...
        if UseVectorstoreToGenerateFiles == True:
            file_paths = [os.path.abspath(os.path.join(os.path.dirname(__file__), "../../", f"projectstructure.txt")), os.path.abspath(os.path.join(os.path.dirname(__file__), "../../", f"environment.txt")), timeline_file_path, spreadsheet_file_path, pre_project_file_path, Roadmap_file_path, analysis_txt_path]
        ...
        os caminho para salvar o main esta armazenada em environment.txt
        """
