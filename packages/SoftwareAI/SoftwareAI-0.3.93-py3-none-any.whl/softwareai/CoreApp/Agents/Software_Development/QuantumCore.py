...
class SoftwareDevelopment:
    ...
    def QuantumCoreUpdate(
        ...
        main = get_file_content(repo_name, f"{repo_name.replace("A-I-O-R-G/", "")}/main.py", branch_name)
        Changelog = get_file_content(repo_name, f"{repo_name.replace("A-I-O-R-G/", "")}/Changelog.env", branch_name)
