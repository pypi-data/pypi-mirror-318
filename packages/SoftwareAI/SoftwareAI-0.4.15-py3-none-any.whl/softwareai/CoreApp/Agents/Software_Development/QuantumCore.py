...
class SoftwareDevelopment:
    ...
    def AI_QuantumCore(
        ...
        if UseVectorstoreToGenerateFiles == True:
            ...
            mensaxgem = f"""crie e salve utilizando autosave main.py com base nos requisitos fornecidos no analysis e nos outros documentos que estao armazenados em QuantumCore_Work_Environment \n
            """
