...
class ByteManager:
    ...
    def AI_1_ByteManager_Company_Owners(self,mensagem):
        ...
        regra1 = "Regra 2 - Caso seja solicitado alguma atualização de repositorio de software Responda no formato JSON Exemplo: {'solicitadoatualizaçãoderepositoriosoftware': 'somente o nome do repositorio que o usuario informou'} "
