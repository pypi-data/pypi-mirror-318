...
class SoftwareDevelopment:
    ...
    def AI_QuantumCore(
        ...
        if UseVectorstoreToGenerateFiles == True:
            ...
            mensaxgem = f"""crie e salve utilizando autosave um script em python em main.py com base nos requisitos fornecidos em AnalysisRequirements.txt, doc.txt, Roadmap.txt, Schedule.txt e Spreadsheet.txt que estao armazenados em QuantumCore_Work_Environment \n
            """
