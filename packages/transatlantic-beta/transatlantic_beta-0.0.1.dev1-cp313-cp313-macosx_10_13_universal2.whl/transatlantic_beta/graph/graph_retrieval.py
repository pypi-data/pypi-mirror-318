...
class GraphRetrieval:
    ...
    def sparse_matrix_retrieval(self, conn_only: bool) -> scipy.sparse._csr.csr_matrix:
        '''
        Returns ```scipy.sparse.csr_matrix``` representation of the graph.
    ...
    def adjacency_matrix_retrieval(self, conn_only: bool) -> np.ndarray:
        '''
    ...
    def nx_graph_retrieval(self, conn_only: bool) -> nx.Graph:
        '''
        ...
        conn_only: bool
            Determines whether an edge is represented as ```1``` or weight of the edge.
        '''
        sparse_matrix = self.sparse_matrix_retrieval(conn_only)
