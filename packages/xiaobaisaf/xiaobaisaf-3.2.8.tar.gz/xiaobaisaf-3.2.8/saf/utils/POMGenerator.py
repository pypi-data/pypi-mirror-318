                ...
                for k, v in element_attrs_dict.items():
                    if 'name' in element_attrs_dict.keys() and "" != element_attrs_dict['name']:
                        query_result = html.xpath(
                            f'//{child.name}[@name="{element_attrs_dict["name"]}"]'
                        )
                        if len(query_result) == 1:
                            components.insert(
                                0, f'/{child.name}[@name="{element_attrs_dict["name"]}"]'
                            )
                        ...
                        query_result = html.xpath(
                            f'//{child.name}[contains(text(), "{child.get_text()[:NAME_MAX_LENGTH]}")]'
                        )
                        if len(query_result) == 1:
                            components.insert(
                                0,
                        ...
                        query_result = html.xpath(
                            f'//{child.name}[@placeholder="{element_attrs_dict["placeholder"]}"]'
                        )
                        if len(query_result) == 1:
                            components.insert(
                        ...
                        query_result = html.xpath(
                            f'//{child.name}[@value="{element_attrs_dict["value"]}"]'
                        )
                        if len(query_result) == 1:
                            components.insert(
                        ...
                        query_result = html.xpath(
                            f'//{child.name}[@title="{element_attrs_dict["title"]}"]'
                        )
                        if len(query_result) == 1:
                            components.insert(
                        ...
                        query_result = html.xpath(
                            f'//{child.name}[@class="{element_attrs_dict["class"]}"]'
                        )
                        if len(query_result) == 1:
                            components.insert(
