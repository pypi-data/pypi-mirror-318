...
if __name__ == "__main__":
    ...
    def deployEngine(self, engineName: str, uptProfile: str = "default", uptEnv: str = "dev", uptMaxDeployTimeMins: int = 20):
        ...
        respDict["additionalDockerCommands"] = self._uptEngineConfig.get(self._uptDeploymentParametersConfigKey, {}).get("AdditionalDockerCommands", "")
        ...
        ret = self._deployEngineOnUpt(engineName=engineName, engineId=engineId, uptProfile=uptProfile, uptEnv=uptEnv, permitTimeDiff=uptMaxDeployTimeMins)
