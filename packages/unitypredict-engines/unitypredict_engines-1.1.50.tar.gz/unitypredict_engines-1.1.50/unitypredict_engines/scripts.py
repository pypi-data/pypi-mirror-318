...
def main():
    ...
    parser.add_argument("--deployTimeoutInMins", type=int, default=20, help=argparse.SUPPRESS)
    parser.add_argument("--checkPrevDeploy", action="store_true", help=argparse.SUPPRESS)
    ...
    if args.engine:
        ...
        if args.create != None:
            ...
            ret = cliDriver.deployEngine(engineName=engineName, uptEnv=args.env, uptMaxDeployTimeMins=args.deployTimeoutInMins)
