...
class XIVAPIClient(XIVAPIWrapper):
    ...
    async def assets(self, asset_path: str, fmt: str = 'png') -> XIVAPIAsset:
        ...
        """
        return XIVAPIAsset(self.session, asset_path, fmt)

    async def map_assets(self, territory: int, index: int) -> XIVAPIAssetMap:
        """
        ...
        :return:
        """
        return XIVAPIAssetMap(self.session, territory, index)
    ...
    def _sanitize_queries(self, queries: list[tuple[str, str, str | int | float | bool]]) -> list[tuple[str, str, str | int | float | bool]]:
        """
    ...
    async def get_sheet_rows(self,
                             ...
                             after: int = None,
                             fields: list[str] = None,
                             transient: list[str] = None) -> dict | list:
        """
    ...
    async def get_result_row(self, result: dict) -> dict | list:
        """
