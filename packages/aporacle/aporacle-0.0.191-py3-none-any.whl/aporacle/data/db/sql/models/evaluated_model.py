...
class EvaluatedModel(Base):
    ...
    prediction = Column(Float, nullable=True)  # Correction Factor. Typically, the last observed Moving Average.
    target = Column(Float, nullable=True)
    diff = Column(Float, nullable=True)
    diff_clean = Column(Float, nullable=True)
    diff_ema = Column(Float, nullable=True)
    original_error = Column(Float, nullable=True)
    revision_confidence = Column(Float, nullable=True)
    revision_confidence_ema = Column(Float, nullable=True)
    revised_prediction = Column(Float, nullable=True)
    revised_error = Column(Float, nullable=True)
    revised_error_ema = Column(Float, nullable=True)
    rmse = Column(Float, nullable=True)
    r2 = Column(Float, nullable=True)
    score = Column(Float, nullable=True)
    stability_factor = Column(Float, nullable=True)
    revised_error_confidence = Column(Float, nullable=True)
