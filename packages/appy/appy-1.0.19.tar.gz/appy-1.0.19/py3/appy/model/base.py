...
class Base:
    ...
    def strinG(self, translated=False, path=True):
        ...
        if path:
            ...
            if container and container.iid != 1:
                cont = container.strinG(translated=translated)
                r = f'{cont} ∋ {r}'
        return r
    ...
    def relink(self, source, target, o):
        ...
        if fieldS.composite or fieldT.composite:
