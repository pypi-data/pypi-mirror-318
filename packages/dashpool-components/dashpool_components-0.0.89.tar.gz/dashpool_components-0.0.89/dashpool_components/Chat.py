...
- url (string; default ''):
    ...
    _type = 'Chat'
    @_explicitize_args
    def __init__(self, id=Component.REQUIRED, url=Component.UNDEFINED, messages=Component.UNDEFINED, title=Component.UNDEFINED, nodeChangeEvent=Component.UNDEFINED, dashpoolEvent=Component.UNDEFINED, style=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'dashpoolEvent', 'messages', 'nodeChangeEvent', 'style', 'title', 'url']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'dashpoolEvent', 'messages', 'nodeChangeEvent', 'style', 'title', 'url']
