...
class EveryVersion:
    ...
    def allchecks(self, exclude = ()):
        for check in self.licheck, self.nlcheck, self.execcheck, self.metacheck, self.divcheck, self.pyflakes, self.nose, self.readme, self.github, self.linktree:
    ...
    def metacheck(self):
        ...
        _runcheck('*', metacheck, self.info.projectdir, self.info.devversion(), self.docker)
