...
class JoggingResponseJogging(BaseModel):
    ...
    """ # noqa: E501
    state: Optional[JoggingState] = None
    robot_controller_state: Optional[RobotControllerState] = None
    __properties: ClassVar[List[str]] = ["state", "robot_controller_state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "state": JoggingState.from_dict(obj["state"]) if obj.get("state") is not None else None,
