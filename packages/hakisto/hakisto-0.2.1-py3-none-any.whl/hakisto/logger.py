...
from .severity import TRACE, DEBUG, VERBOSE, INFO, SUCCESS, WARNING, ERROR, CRITICAL  # noqa: F401

_Logger.register_excluded_source_file(_inspect.currentframe().f_code.co_filename)
