...
from .colors import RED, GREEN, YELLOW, MAGENTA, CYAN, LIGHT_RED, LIGHT_GREEN, LIGHT_YELLOW, LIGHT_MAGENTA, LIGHT_CYAN
...
DEBUG    = 200
"""Debugging (technical) information."""
VERBOSE  = 300
"""Additional (non-technical) information."""
INFO     = 400
"""Information."""
SUCCESS  = 500
"""Successful execution."""
WARNING  = 600
"""Warning that might require attention."""
ERROR    = 800
"""Significant issue. Processing might continue."""
CRITICAL = 900
"""Critical issue. Usually processing is aborted."""
