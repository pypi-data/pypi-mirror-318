...
class Sawalni:
    ...
    def embed(
        self, input: Union[str, List[str]], model: str = "fhamator"
    ) -> Dict[str, Any]:
        """Generate multilingual embeddings for text. Processes in batches of 2048 for fhamator and 512 for madmon."""
        ...
        return self._batch_process(
            input,
            batch_size=4096 if model == "fhamator" else 512,
