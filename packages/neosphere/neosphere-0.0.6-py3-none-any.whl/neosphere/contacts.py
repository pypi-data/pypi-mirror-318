...
class Contacts(metaclass=SingletonMeta):
    ...
    def _fetch_all_agents(self):
        ...
        self._fetch_and_cache_agents(list(self.agent_names), include_private=True)

    def _fetch_and_cache_agents(self, agent_names, include_private=False):
    ...
    def get_tool_schema(self, agent_names=None, backend=None, include_public=True, include_private=True, include_owned=False):
        ...
        self._fetch_and_cache_agents(agents_to_fetch, include_private=fetch_private)
