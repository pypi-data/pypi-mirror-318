...
from build.lib.sparqlin.testing.helpers import get_spark_dataframe
...
def test_base_test_config(spark_session, datasets_path):
    # Define the data
    expected_df = get_spark_dataframe(spark_session, datasets_path, "testdb.test_table")
    assert expected_df.count() == 3
