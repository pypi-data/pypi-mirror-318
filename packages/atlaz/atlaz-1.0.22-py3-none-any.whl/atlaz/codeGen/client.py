...
import getpass
import webbrowser  # For opening the frontend in the default web browser
from http.server import HTTPServer, SimpleHTTPRequestHandler
import threading

from atlaz.codeGen.generate_input.main import atlaz_code
            ...
            with requests.post(url, json=payload, headers=headers, stream=True) as response:
                ...
                if final_response and final_response.get("response"):
                    ...
                    for file_item in final_response["response"]:
                        ...
                        # Correctly identify the type based on the file name
                    ...
                    # Serve files through the frontend by updating the JSON file
                    ...
                    thread = threading.Thread(target=serve_forever_in_thread)
                    thread.daemon = True
                    thread.start()
