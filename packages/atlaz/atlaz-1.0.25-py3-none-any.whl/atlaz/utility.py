...
from atlaz.codeGen.generate_input.main_overview import gather_repository
...
def manual_overview():
    directory_data, directory_structure = gather_repository(script_path=Path(__file__).resolve().parent, focus_directories=['atlaz'], manual_ignore_files=['overview.py', 'utility.py', 'graph'])    
