...
def create_window(contents: Union[Pipeline, Viewport, None] = None):
    """
    Opens a new OVITO Pro main window, including all GUI elements such as the interactive pipeline editor.

    :param contents: The :py:class:`~ovito.pipeline.Pipeline` or :py:class:`~ovito.vis.Viewport` to be displayed in the OVITO Pro window.
    ...
    .. important::
        ...
        It is not available in the standalone OVITO Python package, because this version lacks support for a full graphical user interface.
