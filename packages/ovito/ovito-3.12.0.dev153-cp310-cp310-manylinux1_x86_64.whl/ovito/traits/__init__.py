...
# This lets exceptions propagate out of trait notification handlers (e.g. button event handlers)
# such that the GUI can catch them and display an error message to the user.
traits.observation.exception_handling.push_exception_handler(reraise_exceptions=True)
