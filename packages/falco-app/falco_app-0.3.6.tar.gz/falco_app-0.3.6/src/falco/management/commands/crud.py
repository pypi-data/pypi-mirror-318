...
class Command(CleanRepoOnlyCommand):
    ...
    def handle(self, *_, **options):
        ...
        project_name = settings.APPS_DIR.name
        ...
        entry_point = project_name != app_label and entry_point
...
def build_blueprint_context(
    ...
    *,
    ...
    model_name_lower = django_model["name_lower"]
    url_prefix = f"{app_label}:" if project_name != app_label else ""
    view_name_prefix = "" if entry_point else f"{model_name_lower}_"
    list_view_name = "index" if entry_point else f"{model_name_lower}_list"
    ...
    create_view_url = f"{{% url '{url_prefix}{view_name_prefix}create' %}}"
    return {
        "app_label": app_label,
        "model": django_model,
        ...
        "list_view_url": f"{{% url '{url_prefix}{list_view_name}' %}}",
        "create_view_url": create_view_url,
        "detail_view_url": f"{{% url '{url_prefix}{detail_view_name}' {model_name_lower}.{django_model['lookup_field']} %}}",
        "update_view_url": f"{{% url '{url_prefix}{update_view_name}' {model_name_lower}.{django_model['lookup_field']} %}}",
        "delete_view_url": f"{{% url '{url_prefix}{delete_view_name}' {model_name_lower}.{django_model['lookup_field']} %}}",
        "entry_point": entry_point,
        "login_required": login_required,
        "pagination_block": f"""
