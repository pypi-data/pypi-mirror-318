...
## <a name="BaseToken"></a>Class `BaseToken(cs.deco.Promotable)`
...
## <a name="common_suffix"></a>`common_suffix(*strs)`

Return the common suffix of the strings `strs`.

## <a name="CoreTokens"></a>Class `CoreTokens(BaseToken)`
...
## <a name="FFloat"></a>Class `FFloat(FNumericMixin, builtins.float)`
...
## <a name="get_qstr"></a>`get_qstr(s, offset=0, q='"', environ=None, default=None, env_specials=None)`
...
## <a name="get_sloshed_text"></a>`get_sloshed_text(s, delim, offset=0, slosh='\\', mapper=<function slosh_mapper at 0x10d05d3a0>, specials=None)`
...
## <a name="get_suffix_part"></a>`get_suffix_part(s, *, keywords=('part',), numeral_map=None)`
...
## <a name="has_format_attributes"></a>`has_format_attributes(*da, **dkw)`
...
## <a name="Identifier"></a>Class `Identifier(CoreTokens)`
...
## <a name="NumericValue"></a>Class `NumericValue(_LiteralValue)`
...
## <a name="QuotedString"></a>Class `QuotedString(_LiteralValue)`
...
## <a name="slosh_quote"></a>`slosh_quote(raw_s: str, q: str)`
