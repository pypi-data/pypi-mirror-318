...
class NatRule(BaseObject):
    """
    Manages NatRule objects in Palo Alto Networks' Strata Cloud Manager.
    Args:
    ...
    def create(
        ...
        address = NatRuleCreateModel(**data)
    ...
    def update(
        self,
        address: NatRuleUpdateModel,
    ) -> NatRuleResponseModel:
        """
        Updates an existing NAT rule.

        Args:
            address: NatRuleUpdateModel instance containing the update data
    ...
    @staticmethod
    def _apply_filters(
        addresses: List[NatRuleResponseModel],
        ...
        Args:
            addresses: List of NatRuleResponseModel objects
            filters: Dictionary of filter criteria

        Returns:
            List[NatRuleResponseModel]: Filtered list of addresses
        """
    ...
    def list(
        ...
        **filters,
        ...
        """
        Lists NAT rules with optional filtering.
        ...
        Returns:
            List[NatRuleResponseModel]: A list of NAT rules
        """
        if folder == "":
    ...
    def fetch(
        ...
        Returns:
            NatRuleResponseModel: The fetched NAT rule as a Pydantic model.
        """
        if not name:
            raise MissingQueryParameterError(
