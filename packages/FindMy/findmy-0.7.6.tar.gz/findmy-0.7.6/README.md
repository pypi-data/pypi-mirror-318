...
written by [several authors](https://github.com/malmeloo/FindMy.py/blob/main/#Credits). This project aims to
...
For usage examples, see the [examples](https://github.com/malmeloo/FindMy.py/blob/main/examples) directory. Documentation can be found [here](http://docs.mikealmel.ooo/FindMy.py/).
