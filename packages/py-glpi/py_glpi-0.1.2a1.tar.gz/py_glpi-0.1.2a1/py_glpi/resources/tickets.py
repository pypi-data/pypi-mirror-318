...
from py_glpi.resources.documents import Document_Item, Documents, Document, Path
...
class Ticket(GLPIItem):
    ...
    def link_document(self, document_id: int):
        ...
        self.linked_documents.create(
            set_parents_itemtype=True, documents_id=document_id, add="Add")
        return True
