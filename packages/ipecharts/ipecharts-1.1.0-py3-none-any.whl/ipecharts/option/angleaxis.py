...
This is unavailable for 'category' and 'time' axes. Logged value should be passed for [type](#angleAxis.type): 'log' axis.""").tag(sync=True)
...
The tooltip configuration for angleAxis, must set [triggerEvent](#angleAxis.triggerEvent) as `true` and enable global [option.tooltip](#tooltip) component.""").tag(sync=True)
