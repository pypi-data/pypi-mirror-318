...
This is unavailable for 'category' and 'time' axes. Logged value should be passed for [type](#xAxis.type): 'log' axis.""").tag(sync=True)
...
The tooltip configuration for xAxis, must set [triggerEvent](#xAxis.triggerEvent) as `true` and enable global [option.tooltip](#tooltip) component.""").tag(sync=True)
