...
setup(
    name='satvatsagarml',  # Name of your package
    version='2.1',  # Initial version of your package
    packages=find_packages(include=['satvatsagarml', 'satvatsagarml.*']),  # Specify package directories
