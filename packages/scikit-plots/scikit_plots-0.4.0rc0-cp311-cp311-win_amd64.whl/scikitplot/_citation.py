...
def _get_bibtex(
  preferred_type:str = 'software',
    ...
    try:
        ...
        logging.debug("_bibtex from file CITATION.bib")
        ...
        _bibtex = f"@{preferred_type}{refs}" if refs else ""
        logging.debug("_bibtex from attr CITATION text")
    except Exception as e:
        # Handle any unexpected errors
        logging.error(f"Unexpected error while reading CITATION.bib: {e}")
    return _bibtex
