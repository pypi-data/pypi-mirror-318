'''
 ...
 This file is generated form: gen/pyecoremdb.py.mako on 2024-12-21 11:54:14.446134 by calling E:/1_ILS/Projects/2018_EOQ/Groups/PYEOQ/pyeoq/eoq3conceptsgen/generatefromconceptscli.py -i gen/pyecoremdb.py.mako -o pyecoremdb.py -d gen/pyecoremdb.prev.json.
...
class PyEcoreMdb(Mdb):
    ...
    def Create(self, classId:Union[STR,Obj], createArgs:LST=LST([]), target:Obj=NON(), recoveryArgs:LST=LST([])) -> Tuple[Obj,EOQ_ERROR]:
        ...
        elif(isinstance(eClass, EClass)):# check if it is a normal EClass
    ...
    def Update(self, target:Obj, featureName:STR, value:SIV, position:I64=I64(0)) -> Tuple[Obj,Obj,Obj,I64,EOQ_ERROR]:
        ...
        if(IsConcept(eFeatureName)): #translate generic features
...
#         self.__PreventMetaMetaAccess(target,False)
    ...
    def _CreateM2Inheritance(self, createArgs:LST, target:Obj, recoveryArgs:LST) -> Obj:
        ...
        #augment properties
        self.__UpdateList(self.__GetAugmentedProperty(eSubClass,"_CON_specializations",[]), (-subPos-2), newEElem, ECORE_FEATURE_MAX_LEN)
        self.__UpdateList(self.__GetAugmentedProperty(eSuperClass,"_CON_generalizations",[]), (-superPos-2), newEElem, ECORE_FEATURE_MAX_LEN)
        #update cache
        newEElem._CON_strId = strId
        self.__UpdateCreateIdStrCache(newEElem,newEElem._CON_strId)
        return newElem
    ...
    def _CreateM1Object(self, createArgs:LST, target:Obj, recoveryArgs:LST) -> Obj:
        ...
        self.__SetAugmentedProperty(newEElem,"_CON_isM1Obj",True) #this is necessary, because a distinguishment by class is not possible
    ...
    def _ReadM2ClassAttributes(self, eObj:EClass, featureName:str=None, eContext:EObject=None) -> LST:
        ...
        Returns:
            value:LST
        """
        return self.__EncCollection(eObj.eAllAttributes())  
    ...
    def _ReadM2ClassSrcAssociations(self, eObj:EClass, featureName:str=None, eContext:EObject=None) -> LST:
        ...
        Returns:
            value:LST
        """
        return self.__EncCollection(self.__ReadM2ClassSrcAssociationsRaw(eObj,eContext))  
    ...
    def _ReadM2ClassDstAssociations(self, eObj:EClass, featureName:str=None, eContext:EObject=None) -> LST:
        ...
        Returns:
            value:LST
        """
        value = self.__EncCollection(self.__ReadM2ClassDstAssociationsRaw(eObj,eContext))
        return value
    ...
    def _ReadM2ClassParentCompositions(self, eObj:EClass, featureName:str=None, eContext:EObject=None) -> LST:
        ...
        Returns:
            value:LST
        """
        return self.__EncCollection(self.__ReadM2ClassParentCompositionsRaw(eObj,eContext))
    ...
    def _ReadM2ClassChildCompositions(self, eObj:EClass, featureName:str=None, eContext:EObject=None) -> LST:
        ...
        Returns:
            value:LST
        """
        value = self.__EncCollection(self.__ReadM2ClassChildCompositionsRaw(eObj,eContext))
        return value
    ...
    def _ReadM1ObjectFeatureInstances(self, eObj:EObject, featureName:str=None, eContext:EObject=None) -> Obj:
        ...
        if(0<len(normFeatureName)):
            ...
            if(self._IsM2Attribute(eFeature)):
                ...
                if(self.__GetAugmentedProperty(eObj,'_CON_isDst',False)):
    ...
    def _DeleteM2Inheritance(self, eObj:EM2Inheritance)->Tuple[STR,LST,LST]:
        ...
        subPos = eSubClass._CON_specializations.index(eObj)
        ...
        eSubClass._CON_specializations.remove(eObj)
        eSuperClass._CON_generalizations.remove(eObj)
        # clean up cache
        self.__UpdateCreateIdStrCache(None,None,eObj._CON_strId)
        # get rid of the EObject
        eObj.delete()
    ...
    def __GetConceptFeatureHandler(self,eObj,featureName,handlerTable):
        ...
        try: 
            ...
            raise EOQ_ERROR_DOES_NOT_EXIST("Concept feature %s is not supported for %s"%(featureName,concept))
    ...
    def __ReadNative(self,eObj:EObject,normalizedFeatureName:str)->Any:
        ...
        try:
            ...
            raise EOQ_ERROR_DOES_NOT_EXIST('%s is no valid feature: %s'%(normalizedFeatureName,str(e)))
    ...
    def __ReadM2ClassSpecializationsRaw(self, eObj:EClass) -> List[EObject]:
        ...
        inheritItems = []
        for i in ownItems:
            inheritItems += self.__ReadM2ClassSpecializationsRaw(i._CON_superClass)
    ...
    def __ReadM2ClassGeneralizationsRaw(self, eObj:EClass) -> List[EObject]:
        ...
        inheritItems = []
        for i in ownItems:
            inheritItems += self.__ReadM2ClassGeneralizationsRaw(i._CON_subClass)
        return ownItems + inheritItems
    ...
    def __DecTarget(self,target:Obj)->EObject:
        ''' Special decode function that allows NON targets 
        and returns eMdb in this case.
        '''
        if(target.IsNone()):
            return self.eMdb
        else: 
