...
[![kaizen-deploy](https://img.shields.io/static/v1?label=kaizen-deploy-cmt&message=v1.2.1&color=yellowgreen)](https://pypi.org/project/kaizen-deploy/)
[![release](https://img.shields.io/static/v1?label=release&message=v1.2.1&color=orange)](https://pypi.org/project/kaizen-deploy/1.2.1/)
