...
class DataCube:
    ...
    def _process_function(self, idx, f, args, kwargs, tile_kwargs, output, group):
        """Helper method for apply_function that can be pickled"""
        _args = []
        for arg in args:
    ...
    def apply_function(
        ...
        results = self.executor.map(
            lambda idx: self._process_function(idx, f, args, kwargs, tile_kwargs, output, group),
            idxs
        )
