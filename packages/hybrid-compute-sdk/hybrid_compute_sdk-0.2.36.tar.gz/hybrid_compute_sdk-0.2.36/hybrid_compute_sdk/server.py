...
class HybridComputeSDK:
    ...
    def gen_response(self, req, err_code, resp_payload):
        ...
        call_gas = 705*len(resp_payload) + 300000
        ...
        packed = ethabi.encode([
            ...
            self.HybridAcctAddr,
            req['opNonce'],
            Web3.to_bytes(hexstr='0x'),  # empty initCode
            p_enc2,                      # actual callData
            account_gas_limits,          # packed gas limits
            Web3.to_int(hexstr=limits['preVerificationGas']),
            gas_fees,                    # packed fees
            Web3.to_bytes(hexstr='0x')   # empty paymasterAndData
        ])
