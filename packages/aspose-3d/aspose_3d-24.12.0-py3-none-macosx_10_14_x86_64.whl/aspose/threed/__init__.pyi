...
class AxisSystem:
    ...
    @overload
    def __init__(self, up : aspose.threed.Axis, front : Optional[aspose.threed.Axis]) -> None:
        raise NotImplementedError()
    
    @overload
    def __init__(self, coordinate_system : Optional[aspose.threed.CoordinateSystem], up : Optional[aspose.threed.Axis], front : Optional[aspose.threed.Axis]) -> None:
        raise NotImplementedError()
