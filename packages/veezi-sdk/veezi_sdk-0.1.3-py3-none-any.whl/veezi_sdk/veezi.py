...
class Film(BaseModel):
    ...
    people: List[Staff]
    audio_language: Optional[str] = Field(default=None, alias="AudioLanguage")
    government_film_title: Optional[str] = Field(default=None, alias="GovernmentFilmTitle")
    ...
    film_trailer_url: Optional[str] = Field(default=None, alias="FilmTrailerUrl")
