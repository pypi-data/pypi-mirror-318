...
from ....types.document_ai.extract import schema_create_params, schema_enhance_params, schema_validate_params
from ....types.document_ai.extract.created_json_schema import CreatedJsonSchema
from ....types.document_ai.extract.enhanced_json_schema import EnhancedJsonSchema
from ....types.document_ai.extract.validated_json_schema import ValidatedJsonSchema
...
class SchemaResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Args:
          description: Natural language description of the schema to create
    ...
    def enhance(
        ...
        *,
        ...
        Args:
          json_schema: The base schema to enhance
        ...
        """
        return self._post(
            "/v1/document-ai/extract/schema/enhance",
    ...
    def validate(
        ...
        *,
        ...
        Args:
          json_schema: The schema definition to validate
        ...
        """
        return self._post(
            "/v1/document-ai/extract/schema/validate",
