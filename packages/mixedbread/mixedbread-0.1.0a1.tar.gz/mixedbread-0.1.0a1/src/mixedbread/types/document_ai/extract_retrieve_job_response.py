...
__all__ = ["ExtractRetrieveJobResponse", "RunningJob", "FailedJob", "SuccessfulExtractionJob"]
...
ExtractRetrieveJobResponse: TypeAlias = Union[RunningJob, FailedJob, SuccessfulExtractionJob]
