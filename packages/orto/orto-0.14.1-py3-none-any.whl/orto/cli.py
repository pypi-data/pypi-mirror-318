...
def extract_gmatrix_func(uargs):
    ...
    data = choices[uargs.type]().extract(uargs.output_file)[0]
    ...
    if uargs.output_format == 'docx':
        ...
        if uargs.type == 'eff':
            title = titles['eff'] + f' (S={data['spin_mult']:2d})'
        else:
        ...
        table.cell(0, 0).text = 'Eigenvalues'
        table.cell(0, 1).text = 'Eigenvectors'

        table.cell(1, 0).text = '{:.4f}'.format(data['eigenvalues'][0])
        table.cell(2, 0).text = '{:.4f}'.format(data['eigenvalues'][1])
        table.cell(3, 0).text = '{:.4f}'.format(data['eigenvalues'][2])

        table.cell(1, 1).text = '{:.4f}'.format(data['eigenvectors'][0, 0])
        table.cell(2, 1).text = '{:.4f}'.format(data['eigenvectors'][0, 1])
        table.cell(3, 1).text = '{:.4f}'.format(data['eigenvectors'][0, 2])

        table.cell(1, 2).text = '{:.4f}'.format(data['eigenvectors'][1, 0])
        table.cell(2, 2).text = '{:.4f}'.format(data['eigenvectors'][1, 1])
        table.cell(3, 2).text = '{:.4f}'.format(data['eigenvectors'][1, 2])

        table.cell(1, 3).text = '{:.4f}'.format(data['eigenvectors'][2, 0])
        table.cell(2, 3).text = '{:.4f}'.format(data['eigenvectors'][2, 1])
        table.cell(3, 3).text = '{:.4f}'.format(data['eigenvectors'][2, 2])
