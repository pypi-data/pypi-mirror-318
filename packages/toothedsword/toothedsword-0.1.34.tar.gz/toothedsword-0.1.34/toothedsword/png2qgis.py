...
import json
from qgisfig.tiff2png import createQGISMap
from qgisfig.tiff2png import createQGISMaps
import time
import cv2
    ...
    def png2qgs_json(self):
        ...
        if tiffile == '':
            ...
            if 'cbpos' in self.png_json:
                ...
                cbfile = self.prodir+'/'+str(time.time())+'.cb.png'
        ...
        if 'outcolorbar' in self.png_json:
            cmd = 'cp '+self.colorbarfile+' '+self.png_json['outcolorbar']
            os.system(cmd)
