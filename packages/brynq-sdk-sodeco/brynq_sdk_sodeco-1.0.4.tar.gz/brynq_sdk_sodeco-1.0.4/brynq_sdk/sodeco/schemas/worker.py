from pandera import DataFrameModel, Field as PanderaField
...
class GetWorkerSchema(DataFrameModel):
    ...
    # Optional PanderaFields with specific validations
    ...
    Birthdate: Optional[str] = PanderaField(nullable=True, str_length={'min_value': 8, 'max_value': 8}, pattern=r'^[0-9]*$')
    ...
    BirthplaceCountry: Optional[str] = PanderaField(nullable=True, str_length={'min_value': 5, 'max_value': 5}, pattern=r'^[0-9]*$', default='00150')
    Nationality: Optional[str] = PanderaField(nullable=True, str_length={'min_value': 5, 'max_value': 5}, pattern=r'^[0-9]*$', default='00150')
    ...
    IDValidUntil: Optional[str] = PanderaField(nullable=True, str_length={'min_value': 8, 'max_value': 8}, pattern=r'^[0-9]*$')
    ...
    InterimFrom: Optional[str] = PanderaField(nullable=True, str_length={'min_value': 8, 'max_value': 8}, pattern=r'^[0-9]*$')
    InterimTo: Optional[str] = PanderaField(nullable=True, str_length={'min_value': 8, 'max_value': 8}, pattern=r'^[0-9]*$')
