...
def move_to_use(imagem, click_on_final=False):
    """ Primeiro parâmetro é o caminho da imagem, segundo é se tem clique no final ou não.
        Exemplo:
            ...
            bc.move_to_use(caminho_imagem, click_on_final=True)
    ...
    """
    localizacao = pyautogui.locateOnScreen('C:\\Users\\eliezer.gimenes\\Pictures\\Screenshots\\teste3.png')
