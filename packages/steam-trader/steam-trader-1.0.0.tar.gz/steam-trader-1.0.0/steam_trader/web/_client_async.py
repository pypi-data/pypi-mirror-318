...
class WebClientAsync(WebClientObject):
    ...
    async def get_main_page(
        ...
        *,
        ...
        result = await self._get_request(game_name + '/', headers=headers, params=params, cookies=cookies)
    ...
    async def get_referral_link(self) -> str:
        ...
        result = await self._get_request('referral/', headers=headers, cookies=cookies)
    ...
    async def get_referals(
        ...
        result = await self._get_request('referral/', headers=headers, params=params, cookies=cookies)
        html = bs4.BeautifulSoup(result['contents'], 'lxml')
