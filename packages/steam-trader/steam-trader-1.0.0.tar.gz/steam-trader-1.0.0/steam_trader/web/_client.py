...
class WebClient(WebClientObject):
    ...
    def __enter__(self) -> Self:
        self._httpx_client = httpx.Client(proxy=self.proxy, **self._kwargs)
        return self
    ...
    def get_main_page(
        ...
        *,
        ...
        result = self._get_request(game_name + '/', headers=headers, params=params, cookies=cookies)
    ...
    def get_item_info(
        ...
        result = self._get_request(str(correct_url.url), headers=headers, params=params, cookies=cookies)
    ...
    def get_referral_link(self) -> str:
        ...
        result = self._get_request('referral/', headers=headers, cookies=cookies)
    ...
    def get_referals(
        ...
        result = self._get_request('referral/', headers=headers, params=params, cookies=cookies)
        html = bs4.BeautifulSoup(result['contents'], 'lxml')
    ...
    @log
    def get_history_page(self, gameid: int, category: Literal['last', 'day_most', 'all_time_most'] = 'last') -> Sequence[HistoryItem]:
        ...
        page = self._get_request(url, de_json=False)
