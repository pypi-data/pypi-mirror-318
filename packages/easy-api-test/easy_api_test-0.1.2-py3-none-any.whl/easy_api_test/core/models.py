...
import re
from typing import Any, Mapping, Self, Sequence, Type, get_type_hints, Union, get_origin, get_args, TypeVar, overload
    ...
    def __init_value(cls_, value: Any):
        if cls_ is None:
            if isinstance(value, dict):
                ...
                return value
        print(f'cls:{cls_}, value:{value}, is_union:{get_origin(cls_) is Union}')
        if cls_ is dict:
            cls_ = Model
        try:
