...
from sync_client.api import make_request
from utilis.constants import validate_uuid_id, validate_request_body
...
class MediaResource:
    ...
    def get_all_media(self, params=None):
        """Fetch all medias."""
        try:
            return make_request(
                method="GET", 
    ...
    def get_by_mediaId(self, media_id):
        ...
        validate_uuid_id(media_id)  # Validate media ID
        try:
            return make_request(
                method="GET", 
