...
class AccountReady(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["jfrog_tenant_details", b"jfrog_tenant_details", "preferences", b"preferences"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["account_id", b"account_id", "account_name", b"account_name", "default_environment_id", b"default_environment_id", "environments_by_id", b"environments_by_id", "jfrog_tenant_details", b"jfrog_tenant_details", "preferences", b"preferences", "tier", b"tier", "type", b"type"]) -> None: ...
