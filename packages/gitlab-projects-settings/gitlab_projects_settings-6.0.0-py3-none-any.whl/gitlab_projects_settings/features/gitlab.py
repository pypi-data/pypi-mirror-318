...
class GitLabFeature:
    ...
    def group_set_roles_create_projects(self, criteria: str, level: str) -> None:
    ...
    def group_set_roles_create_subgroups(self, criteria: str, level: str) -> None:
    ...
    def project_set_issues_board(
        ...
        for list_json in lists:
            ...
            except (GitlabGetError, IndexError):
