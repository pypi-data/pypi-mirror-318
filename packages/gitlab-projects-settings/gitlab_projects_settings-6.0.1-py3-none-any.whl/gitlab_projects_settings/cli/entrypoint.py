...
class Entrypoint:
    ...
    # Group, pylint: disable=too-many-locals
    @staticmethod
    def group(
        options: Namespace,
        gitlab: GitLabFeature,
        ...
        if options.set_roles_create_projects:
            gitlab.group_set_roles_create_projects(criteria,
                                                   options.set_roles_create_projects)
            print(f'{Colors.BOLD}   - Set roles allowed to create projects: '
                  f'{Colors.CYAN}{options.set_roles_create_projects}'
                  f'{Colors.RESET}')
            Platform.flush()

        # Set group roles create subgroups
        if options.set_roles_create_subgroups:
            gitlab.group_set_roles_create_subgroups(criteria,
                                                    options.set_roles_create_subgroups)
            print(f'{Colors.BOLD}   - Set roles allowed to create subgroups: '
                  f'{Colors.CYAN}{options.set_roles_create_subgroups}'
                  f'{Colors.RESET}')
            Platform.flush()
    ...
    def project(
        ...
        if options.set_merge_squash is not None:
            ...
            print(f'{Colors.BOLD}   - Set merge squash: '
                  f'{Colors.CYAN}{options.set_merge_squash}'
                  f'{Colors.RESET}')
            Platform.flush()
        ...
        if options.set_merge_pipelines is not None:
            ...
            print(f'{Colors.BOLD}   - Set merge pipelines: '
                  f'{Colors.CYAN}{str(options.set_merge_pipelines).lower()}'
                  f'{Colors.RESET}')
            Platform.flush()
        ...
        if options.set_merge_skipped is not None:
            ...
            print(f'{Colors.BOLD}   - Set merge skipped: '
                  f'{Colors.CYAN}{str(options.set_merge_skipped).lower()}'
                  f'{Colors.RESET}')
            Platform.flush()
        ...
        if options.set_merge_resolved is not None:
            ...
            print(f'{Colors.BOLD}   - Set merge method: '
                  f'{Colors.CYAN}{str(options.set_merge_resolved).lower()}'
                  f'{Colors.RESET}')
            Platform.flush()
