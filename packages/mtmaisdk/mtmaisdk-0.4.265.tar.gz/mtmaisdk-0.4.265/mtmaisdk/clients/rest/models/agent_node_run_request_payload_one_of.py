...
from mtmaisdk.clients.rest.models.agent_node_run_request_payload_one_of_action import AgentNodeRunRequestPayloadOneOfAction
...
class AgentNodeRunRequestPayloadOneOf(BaseModel):
    ...
    action: Optional[AgentNodeRunRequestPayloadOneOfAction] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "action": AgentNodeRunRequestPayloadOneOfAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
