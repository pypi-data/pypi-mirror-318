...
def initialize_db():
    ...
    if block_count == 0:
        # Define the genesis block with a transaction initializing the network
        genesis_block_data = json.dumps([
            {
                "sender": "System - This allocation is for the house wallet. Used for our mining/blockchain gambling game",
                "recipient": "1E8bZc5wVior9ZrmBySJwYwL6obRj4zUyz",
                "amount": 10000  # Initial balance for the genesis wallet
            }
        ])
        ...
        conn.commit()
        print("Genesis block with transaction created.")
