import hashlib
from sallmon_core.services.db import save_message
...
from sallmon_core.services.mempool import mempool
from sallmon_core.services.utxos import validate_transaction  # Placeholder for transaction validation
...
async def process_message(message: dict):
    ...
    # Handle "join-network"
        ...
        from sallmon_core.services.peers import add_peer
        if add_peer(peer_ip):
