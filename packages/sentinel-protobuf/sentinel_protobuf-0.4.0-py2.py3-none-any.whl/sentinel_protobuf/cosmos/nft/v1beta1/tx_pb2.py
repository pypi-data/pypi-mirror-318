...
if (_descriptor._USE_C_DESCRIPTORS == False):
    ...
    _MSGSEND.fields_by_name['sender']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _MSGSEND.fields_by_name['receiver']._options = None
    _MSGSEND.fields_by_name['receiver']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
