...
if (_descriptor._USE_C_DESCRIPTORS == False):
    google_dot_protobuf_dot_descriptor__pb2.MethodOptions.RegisterExtension(method_added_in)
    google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(implements_interface)
    google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(message_added_in)
    ...
    google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(field_added_in)
    ...
    google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(file_added_in)
