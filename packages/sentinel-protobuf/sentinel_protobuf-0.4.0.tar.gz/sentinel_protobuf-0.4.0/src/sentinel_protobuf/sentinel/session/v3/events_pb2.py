...
if (_descriptor._USE_C_DESCRIPTORS == False):
    ...
    _EVENTUPDATEDETAILS.fields_by_name['id']._serialized_options = b'\xe2\xde\x1f\x02ID'
    _EVENTUPDATEDETAILS.fields_by_name['duration']._options = None
    _EVENTUPDATEDETAILS.fields_by_name['duration']._serialized_options = b'\xc8\xde\x1f\x00\x98\xdf\x1f\x01'
    _EVENTUPDATESTATUS.fields_by_name['id']._options = None
    _EVENTUPDATESTATUS.fields_by_name['id']._serialized_options = b'\xe2\xde\x1f\x02ID'
    _EVENTPAY._serialized_start = 143
    _EVENTPAY._serialized_end = 257
    _EVENTREFUND._serialized_start = 259
    _EVENTREFUND._serialized_end = 329
    _EVENTUPDATEDETAILS._serialized_start = 332
    _EVENTUPDATEDETAILS._serialized_end = 516
    _EVENTUPDATESTATUS._serialized_start = 519
    _EVENTUPDATESTATUS._serialized_end = 663
