...
if (_descriptor._USE_C_DESCRIPTORS == False):
    ...
    _EVENTCREATE.fields_by_name['remote_url']._options = None
    _EVENTCREATE.fields_by_name['remote_url']._serialized_options = b'\xe2\xde\x1f\tRemoteURL'
    ...
    _EVENTCREATE._serialized_end = 223
    _EVENTPAY._serialized_start = 225
    _EVENTPAY._serialized_end = 339
    _EVENTREFUND._serialized_start = 341
    _EVENTREFUND._serialized_end = 411
    _EVENTUPDATEDETAILS._serialized_start = 413
    _EVENTUPDATEDETAILS._serialized_end = 538
    _EVENTUPDATESTATUS._serialized_start = 540
    _EVENTUPDATESTATUS._serialized_end = 624
    _EVENTCREATESESSION._serialized_start = 627
    _EVENTCREATESESSION._serialized_end = 767
