...
if (_descriptor._USE_C_DESCRIPTORS == False):
    ...
    DESCRIPTOR._serialized_options = b'ZMgithub.com/cosmos/ibc-go/v7/modules/apps/27-interchain-accounts/genesis/types'
    ...
    _ACTIVECHANNEL.fields_by_name['is_middleware_enabled']._serialized_options = b'\xf2\xde\x1f\x1cyaml:"is_middleware_enabled"'
    ...
    _CONTROLLERGENESISSTATE._serialized_start = 560
    _CONTROLLERGENESISSTATE._serialized_end = 946
    _HOSTGENESISSTATE._serialized_start = 949
    _HOSTGENESISSTATE._serialized_end = 1322
    _ACTIVECHANNEL._serialized_start = 1325
    _ACTIVECHANNEL._serialized_end = 1534
    _REGISTEREDINTERCHAINACCOUNT._serialized_start = 1537
    _REGISTEREDINTERCHAINACCOUNT._serialized_end = 1705
