...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MSGCREATEPLANREQUEST']._serialized_start = 167
    _globals['_MSGCREATEPLANREQUEST']._serialized_end = 302
    _globals['_MSGLINKNODEREQUEST']._serialized_start = 304
    _globals['_MSGLINKNODEREQUEST']._serialized_end = 380
    _globals['_MSGUNLINKNODEREQUEST']._serialized_start = 382
    _globals['_MSGUNLINKNODEREQUEST']._serialized_end = 460
    _globals['_MSGUPDATEPLANSTATUSREQUEST']._serialized_start = 462
    _globals['_MSGUPDATEPLANSTATUSREQUEST']._serialized_end = 567
    _globals['_MSGSTARTSESSIONREQUEST']._serialized_start = 570
    _globals['_MSGSTARTSESSIONREQUEST']._serialized_end = 734
    _globals['_MSGCREATEPLANRESPONSE']._serialized_start = 736
    _globals['_MSGCREATEPLANRESPONSE']._serialized_end = 779
    _globals['_MSGLINKNODERESPONSE']._serialized_start = 781
    _globals['_MSGLINKNODERESPONSE']._serialized_end = 802
    _globals['_MSGUNLINKNODERESPONSE']._serialized_start = 804
    _globals['_MSGUNLINKNODERESPONSE']._serialized_end = 827
    _globals['_MSGUPDATEPLANSTATUSRESPONSE']._serialized_start = 829
    _globals['_MSGUPDATEPLANSTATUSRESPONSE']._serialized_end = 858
    _globals['_MSGSTARTSESSIONRESPONSE']._serialized_start = 860
    _globals['_MSGSTARTSESSIONRESPONSE']._serialized_end = 905
    _globals['_MSGSERVICE']._serialized_start = 908
    _globals['_MSGSERVICE']._serialized_end = 1428