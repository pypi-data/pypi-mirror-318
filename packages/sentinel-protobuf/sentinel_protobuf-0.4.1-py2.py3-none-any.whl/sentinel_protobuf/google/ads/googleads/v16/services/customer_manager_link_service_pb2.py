...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/services/customer_manager_link_service.proto'
)
...
from google.ads.googleads.v16.resources import customer_manager_link_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_resources_dot_customer__manager__link__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.services.customer_manager_link_service_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n%com.google.ads.googleads.v16.servicesB\037CustomerManagerLinkServiceProtoP\001ZIgoogle.golang.org/genproto/googleapis/ads/googleads/v16/services;services\242\002\003GAA\252\002!Google.Ads.GoogleAds.V16.Services\312\002!Google\\Ads\\GoogleAds\\V16\\Services\352\002%Google::Ads::GoogleAds::V16::Services'
  _globals['_MUTATECUSTOMERMANAGERLINKREQUEST'].fields_by_name['customer_id']._loaded_options = None
  _globals['_MUTATECUSTOMERMANAGERLINKREQUEST'].fields_by_name['customer_id']._serialized_options = b'\340A\002'
  _globals['_MUTATECUSTOMERMANAGERLINKREQUEST'].fields_by_name['operations']._loaded_options = None
  _globals['_MUTATECUSTOMERMANAGERLINKREQUEST'].fields_by_name['operations']._serialized_options = b'\340A\002'
  _globals['_MOVEMANAGERLINKREQUEST'].fields_by_name['customer_id']._loaded_options = None
  _globals['_MOVEMANAGERLINKREQUEST'].fields_by_name['customer_id']._serialized_options = b'\340A\002'
  _globals['_MOVEMANAGERLINKREQUEST'].fields_by_name['previous_customer_manager_link']._loaded_options = None
  _globals['_MOVEMANAGERLINKREQUEST'].fields_by_name['previous_customer_manager_link']._serialized_options = b'\340A\002'
  _globals['_MOVEMANAGERLINKREQUEST'].fields_by_name['new_manager']._loaded_options = None
  _globals['_MOVEMANAGERLINKREQUEST'].fields_by_name['new_manager']._serialized_options = b'\340A\002'
  _globals['_MOVEMANAGERLINKRESPONSE'].fields_by_name['resource_name']._loaded_options = None
  _globals['_MOVEMANAGERLINKRESPONSE'].fields_by_name['resource_name']._serialized_options = b'\372A.\n,googleads.googleapis.com/CustomerManagerLink'
  _globals['_MUTATECUSTOMERMANAGERLINKRESULT'].fields_by_name['resource_name']._loaded_options = None
  _globals['_MUTATECUSTOMERMANAGERLINKRESULT'].fields_by_name['resource_name']._serialized_options = b'\372A.\n,googleads.googleapis.com/CustomerManagerLink'
  _globals['_CUSTOMERMANAGERLINKSERVICE']._loaded_options = None
  _globals['_CUSTOMERMANAGERLINKSERVICE']._serialized_options = b'\312A\030googleads.googleapis.com\322A\'https://www.googleapis.com/auth/adwords'
  _globals['_CUSTOMERMANAGERLINKSERVICE'].methods_by_name['MutateCustomerManagerLink']._loaded_options = None
  _globals['_CUSTOMERMANAGERLINKSERVICE'].methods_by_name['MutateCustomerManagerLink']._serialized_options = b'\332A\026customer_id,operations\202\323\344\223\002?\":/v16/customers/{customer_id=*}/customerManagerLinks:mutate:\001*'
  _globals['_CUSTOMERMANAGERLINKSERVICE'].methods_by_name['MoveManagerLink']._loaded_options = None
  _globals['_CUSTOMERMANAGERLINKSERVICE'].methods_by_name['MoveManagerLink']._serialized_options = b'\332A6customer_id,previous_customer_manager_link,new_manager\202\323\344\223\002H\"C/v16/customers/{customer_id=*}/customerManagerLinks:moveManagerLink:\001*'
