...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/common/offline_user_data.proto'
)
...
from google.ads.googleads.v16.enums import user_identifier_source_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_enums_dot_user__identifier__source__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.common.offline_user_data_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n#com.google.ads.googleads.v16.commonB\024OfflineUserDataProtoP\001ZEgoogle.golang.org/genproto/googleapis/ads/googleads/v16/common;common\242\002\003GAA\252\002\037Google.Ads.GoogleAds.V16.Common\312\002\037Google\\Ads\\GoogleAds\\V16\\Common\352\002#Google::Ads::GoogleAds::V16::Common'
  _globals['_USERATTRIBUTE'].fields_by_name['lifecycle_stage']._loaded_options = None
  _globals['_USERATTRIBUTE'].fields_by_name['lifecycle_stage']._serialized_options = b'\340A\001'
  _globals['_USERATTRIBUTE'].fields_by_name['first_purchase_date_time']._loaded_options = None
  _globals['_USERATTRIBUTE'].fields_by_name['first_purchase_date_time']._serialized_options = b'\340A\001'
  _globals['_USERATTRIBUTE'].fields_by_name['event_attribute']._loaded_options = None
  _globals['_USERATTRIBUTE'].fields_by_name['event_attribute']._serialized_options = b'\340A\001'
  _globals['_EVENTATTRIBUTE'].fields_by_name['event']._loaded_options = None
  _globals['_EVENTATTRIBUTE'].fields_by_name['event']._serialized_options = b'\340A\002'
  _globals['_EVENTATTRIBUTE'].fields_by_name['event_date_time']._loaded_options = None
  _globals['_EVENTATTRIBUTE'].fields_by_name['event_date_time']._serialized_options = b'\340A\002'
  _globals['_EVENTATTRIBUTE'].fields_by_name['item_attribute']._loaded_options = None
  _globals['_EVENTATTRIBUTE'].fields_by_name['item_attribute']._serialized_options = b'\340A\002'
  _globals['_EVENTITEMATTRIBUTE'].fields_by_name['item_id']._loaded_options = None
  _globals['_EVENTITEMATTRIBUTE'].fields_by_name['item_id']._serialized_options = b'\340A\001'
