...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/resources/asset.proto'
)
...
from google.ads.googleads.v16.common import asset_types_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_common_dot_asset__types__pb2
...
from google.ads.googleads.v16.enums import asset_source_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_enums_dot_asset__source__pb2
from google.ads.googleads.v16.enums import asset_type_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_enums_dot_asset__type__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.resources.asset_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n&com.google.ads.googleads.v16.resourcesB\nAssetProtoP\001ZKgoogle.golang.org/genproto/googleapis/ads/googleads/v16/resources;resources\242\002\003GAA\252\002\"Google.Ads.GoogleAds.V16.Resources\312\002\"Google\\Ads\\GoogleAds\\V16\\Resources\352\002&Google::Ads::GoogleAds::V16::Resources'
  _globals['_ASSET'].fields_by_name['resource_name']._loaded_options = None
  _globals['_ASSET'].fields_by_name['resource_name']._serialized_options = b'\340A\005\372A \n\036googleads.googleapis.com/Asset'
  _globals['_ASSET'].fields_by_name['id']._loaded_options = None
  _globals['_ASSET'].fields_by_name['id']._serialized_options = b'\340A\003'
  _globals['_ASSET'].fields_by_name['type']._loaded_options = None
  _globals['_ASSET'].fields_by_name['type']._serialized_options = b'\340A\003'
  _globals['_ASSET'].fields_by_name['source']._loaded_options = None
  _globals['_ASSET'].fields_by_name['source']._serialized_options = b'\340A\003'
  _globals['_ASSET'].fields_by_name['policy_summary']._loaded_options = None
  _globals['_ASSET'].fields_by_name['policy_summary']._serialized_options = b'\340A\003'
  _globals['_ASSET'].fields_by_name['field_type_policy_summaries']._loaded_options = None
  _globals['_ASSET'].fields_by_name['field_type_policy_summaries']._serialized_options = b'\340A\003'
  _globals['_ASSET'].fields_by_name['youtube_video_asset']._loaded_options = None
  _globals['_ASSET'].fields_by_name['youtube_video_asset']._serialized_options = b'\340A\005'
  _globals['_ASSET'].fields_by_name['media_bundle_asset']._loaded_options = None
  _globals['_ASSET'].fields_by_name['media_bundle_asset']._serialized_options = b'\340A\005'
  _globals['_ASSET'].fields_by_name['image_asset']._loaded_options = None
  _globals['_ASSET'].fields_by_name['image_asset']._serialized_options = b'\340A\003'
  _globals['_ASSET'].fields_by_name['text_asset']._loaded_options = None
  _globals['_ASSET'].fields_by_name['text_asset']._serialized_options = b'\340A\005'
  _globals['_ASSET'].fields_by_name['call_to_action_asset']._loaded_options = None
  _globals['_ASSET'].fields_by_name['call_to_action_asset']._serialized_options = b'\340A\005'
  _globals['_ASSET'].fields_by_name['discovery_carousel_card_asset']._loaded_options = None
  _globals['_ASSET'].fields_by_name['discovery_carousel_card_asset']._serialized_options = b'\340A\005'
  _globals['_ASSET'].fields_by_name['location_asset']._loaded_options = None
  _globals['_ASSET'].fields_by_name['location_asset']._serialized_options = b'\340A\003'
  _globals['_ASSET'].fields_by_name['hotel_property_asset']._loaded_options = None
  _globals['_ASSET'].fields_by_name['hotel_property_asset']._serialized_options = b'\340A\005'
  _globals['_ASSET']._loaded_options = None
  _globals['_ASSET']._serialized_options = b'\352AK\n\036googleads.googleapis.com/Asset\022)customers/{customer_id}/assets/{asset_id}'
  _globals['_ASSETFIELDTYPEPOLICYSUMMARY'].fields_by_name['asset_field_type']._loaded_options = None
  _globals['_ASSETFIELDTYPEPOLICYSUMMARY'].fields_by_name['asset_field_type']._serialized_options = b'\340A\003'
  _globals['_ASSETFIELDTYPEPOLICYSUMMARY'].fields_by_name['asset_source']._loaded_options = None
  _globals['_ASSETFIELDTYPEPOLICYSUMMARY'].fields_by_name['asset_source']._serialized_options = b'\340A\003'
  _globals['_ASSETFIELDTYPEPOLICYSUMMARY'].fields_by_name['policy_summary_info']._loaded_options = None
  _globals['_ASSETFIELDTYPEPOLICYSUMMARY'].fields_by_name['policy_summary_info']._serialized_options = b'\340A\003'
  _globals['_ASSETPOLICYSUMMARY'].fields_by_name['policy_topic_entries']._loaded_options = None
  _globals['_ASSETPOLICYSUMMARY'].fields_by_name['policy_topic_entries']._serialized_options = b'\340A\003'
  _globals['_ASSETPOLICYSUMMARY'].fields_by_name['review_status']._loaded_options = None
  _globals['_ASSETPOLICYSUMMARY'].fields_by_name['review_status']._serialized_options = b'\340A\003'
  _globals['_ASSETPOLICYSUMMARY'].fields_by_name['approval_status']._loaded_options = None
  _globals['_ASSETPOLICYSUMMARY'].fields_by_name['approval_status']._serialized_options = b'\340A\003'
  _globals['_ASSET']._serialized_start=575
  _globals['_ASSET']._serialized_end=3627
  _globals['_ASSETFIELDTYPEPOLICYSUMMARY']._serialized_start=3630
  _globals['_ASSETFIELDTYPEPOLICYSUMMARY']._serialized_end=4012
  _globals['_ASSETPOLICYSUMMARY']._serialized_start=4015
  _globals['_ASSETPOLICYSUMMARY']._serialized_end=4333
