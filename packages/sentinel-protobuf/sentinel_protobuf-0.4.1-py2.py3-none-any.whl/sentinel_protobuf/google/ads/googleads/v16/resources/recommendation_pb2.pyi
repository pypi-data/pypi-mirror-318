...
from google.ads.googleads.v16.enums import ad_strength_pb2 as _ad_strength_pb2
from google.ads.googleads.v16.enums import app_bidding_goal_pb2 as _app_bidding_goal_pb2
...
from google.ads.googleads.v16.enums import shopping_add_products_to_campaign_recommendation_enum_pb2 as _shopping_add_products_to_campaign_recommendation_enum_pb2
from google.ads.googleads.v16.enums import target_cpa_opt_in_recommendation_goal_pb2 as _target_cpa_opt_in_recommendation_goal_pb2
...
class Recommendation(_message.Message):
    ...
    class ImprovePerformanceMaxAdStrengthRecommendation(_message.Message):
        __slots__ = ("asset_group",)
        ASSET_GROUP_FIELD_NUMBER: _ClassVar[int]
        asset_group: str
        def __init__(self, asset_group: _Optional[str] = ...) -> None: ...
