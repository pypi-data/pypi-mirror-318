...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/resources/batch_job.proto'
)
...
from google.ads.googleads.v16.enums import batch_job_status_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_enums_dot_batch__job__status__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.resources.batch_job_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n&com.google.ads.googleads.v16.resourcesB\rBatchJobProtoP\001ZKgoogle.golang.org/genproto/googleapis/ads/googleads/v16/resources;resources\242\002\003GAA\252\002\"Google.Ads.GoogleAds.V16.Resources\312\002\"Google\\Ads\\GoogleAds\\V16\\Resources\352\002&Google::Ads::GoogleAds::V16::Resources'
  _globals['_BATCHJOB_BATCHJOBMETADATA'].fields_by_name['creation_date_time']._loaded_options = None
  _globals['_BATCHJOB_BATCHJOBMETADATA'].fields_by_name['creation_date_time']._serialized_options = b'\340A\003'
  _globals['_BATCHJOB_BATCHJOBMETADATA'].fields_by_name['start_date_time']._loaded_options = None
  _globals['_BATCHJOB_BATCHJOBMETADATA'].fields_by_name['start_date_time']._serialized_options = b'\340A\003'
  _globals['_BATCHJOB_BATCHJOBMETADATA'].fields_by_name['completion_date_time']._loaded_options = None
  _globals['_BATCHJOB_BATCHJOBMETADATA'].fields_by_name['completion_date_time']._serialized_options = b'\340A\003'
  _globals['_BATCHJOB_BATCHJOBMETADATA'].fields_by_name['estimated_completion_ratio']._loaded_options = None
  _globals['_BATCHJOB_BATCHJOBMETADATA'].fields_by_name['estimated_completion_ratio']._serialized_options = b'\340A\003'
  _globals['_BATCHJOB_BATCHJOBMETADATA'].fields_by_name['operation_count']._loaded_options = None
  _globals['_BATCHJOB_BATCHJOBMETADATA'].fields_by_name['operation_count']._serialized_options = b'\340A\003'
  _globals['_BATCHJOB_BATCHJOBMETADATA'].fields_by_name['executed_operation_count']._loaded_options = None
  _globals['_BATCHJOB_BATCHJOBMETADATA'].fields_by_name['executed_operation_count']._serialized_options = b'\340A\003'
  _globals['_BATCHJOB_BATCHJOBMETADATA'].fields_by_name['execution_limit_seconds']._loaded_options = None
  _globals['_BATCHJOB_BATCHJOBMETADATA'].fields_by_name['execution_limit_seconds']._serialized_options = b'\340A\005'
  _globals['_BATCHJOB'].fields_by_name['resource_name']._loaded_options = None
  _globals['_BATCHJOB'].fields_by_name['resource_name']._serialized_options = b'\340A\005\372A#\n!googleads.googleapis.com/BatchJob'
  _globals['_BATCHJOB'].fields_by_name['id']._loaded_options = None
  _globals['_BATCHJOB'].fields_by_name['id']._serialized_options = b'\340A\003'
  _globals['_BATCHJOB'].fields_by_name['next_add_sequence_token']._loaded_options = None
  _globals['_BATCHJOB'].fields_by_name['next_add_sequence_token']._serialized_options = b'\340A\003'
  _globals['_BATCHJOB'].fields_by_name['metadata']._loaded_options = None
  _globals['_BATCHJOB'].fields_by_name['metadata']._serialized_options = b'\340A\003'
  _globals['_BATCHJOB'].fields_by_name['status']._loaded_options = None
  _globals['_BATCHJOB'].fields_by_name['status']._serialized_options = b'\340A\003'
  _globals['_BATCHJOB'].fields_by_name['long_running_operation']._loaded_options = None
  _globals['_BATCHJOB'].fields_by_name['long_running_operation']._serialized_options = b'\340A\003'
  _globals['_BATCHJOB']._loaded_options = None
  _globals['_BATCHJOB']._serialized_options = b'\352AU\n!googleads.googleapis.com/BatchJob\0220customers/{customer_id}/batchJobs/{batch_job_id}'
