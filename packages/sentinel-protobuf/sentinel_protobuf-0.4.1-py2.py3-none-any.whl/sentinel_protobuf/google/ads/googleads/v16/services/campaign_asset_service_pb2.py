...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/services/campaign_asset_service.proto'
)
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.services.campaign_asset_service_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n%com.google.ads.googleads.v16.servicesB\031CampaignAssetServiceProtoP\001ZIgoogle.golang.org/genproto/googleapis/ads/googleads/v16/services;services\242\002\003GAA\252\002!Google.Ads.GoogleAds.V16.Services\312\002!Google\\Ads\\GoogleAds\\V16\\Services\352\002%Google::Ads::GoogleAds::V16::Services'
  _globals['_MUTATECAMPAIGNASSETSREQUEST'].fields_by_name['customer_id']._loaded_options = None
  _globals['_MUTATECAMPAIGNASSETSREQUEST'].fields_by_name['customer_id']._serialized_options = b'\340A\002'
  _globals['_MUTATECAMPAIGNASSETSREQUEST'].fields_by_name['operations']._loaded_options = None
  _globals['_MUTATECAMPAIGNASSETSREQUEST'].fields_by_name['operations']._serialized_options = b'\340A\002'
  _globals['_CAMPAIGNASSETOPERATION'].fields_by_name['remove']._loaded_options = None
  _globals['_CAMPAIGNASSETOPERATION'].fields_by_name['remove']._serialized_options = b'\372A(\n&googleads.googleapis.com/CampaignAsset'
  _globals['_MUTATECAMPAIGNASSETRESULT'].fields_by_name['resource_name']._loaded_options = None
  _globals['_MUTATECAMPAIGNASSETRESULT'].fields_by_name['resource_name']._serialized_options = b'\372A(\n&googleads.googleapis.com/CampaignAsset'
  _globals['_CAMPAIGNASSETSERVICE']._loaded_options = None
  _globals['_CAMPAIGNASSETSERVICE']._serialized_options = b'\312A\030googleads.googleapis.com\322A\'https://www.googleapis.com/auth/adwords'
  _globals['_CAMPAIGNASSETSERVICE'].methods_by_name['MutateCampaignAssets']._loaded_options = None
  _globals['_CAMPAIGNASSETSERVICE'].methods_by_name['MutateCampaignAssets']._serialized_options = b'\332A\026customer_id,operations\202\323\344\223\0029\"4/v16/customers/{customer_id=*}/campaignAssets:mutate:\001*'
