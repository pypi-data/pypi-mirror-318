...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/resources/campaign_criterion.proto'
)
...
from google.ads.googleads.v16.enums import campaign_criterion_status_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_enums_dot_campaign__criterion__status__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.resources.campaign_criterion_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n&com.google.ads.googleads.v16.resourcesB\026CampaignCriterionProtoP\001ZKgoogle.golang.org/genproto/googleapis/ads/googleads/v16/resources;resources\242\002\003GAA\252\002\"Google.Ads.GoogleAds.V16.Resources\312\002\"Google\\Ads\\GoogleAds\\V16\\Resources\352\002&Google::Ads::GoogleAds::V16::Resources'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['resource_name']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['resource_name']._serialized_options = b'\340A\005\372A,\n*googleads.googleapis.com/CampaignCriterion'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['campaign']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['campaign']._serialized_options = b'\340A\005\372A#\n!googleads.googleapis.com/Campaign'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['criterion_id']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['criterion_id']._serialized_options = b'\340A\003'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['display_name']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['display_name']._serialized_options = b'\340A\003'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['negative']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['negative']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['type']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['type']._serialized_options = b'\340A\003'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['keyword']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['keyword']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['placement']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['placement']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['mobile_app_category']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['mobile_app_category']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['mobile_application']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['mobile_application']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['location']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['location']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['device']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['device']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['ad_schedule']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['ad_schedule']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['age_range']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['age_range']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['gender']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['gender']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['income_range']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['income_range']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['parental_status']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['parental_status']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['user_list']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['user_list']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['youtube_video']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['youtube_video']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['youtube_channel']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['youtube_channel']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['proximity']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['proximity']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['topic']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['topic']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['listing_scope']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['listing_scope']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['language']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['language']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['ip_block']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['ip_block']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['content_label']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['content_label']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['carrier']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['carrier']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['user_interest']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['user_interest']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['webpage']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['webpage']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['operating_system_version']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['operating_system_version']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['mobile_device']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['mobile_device']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['location_group']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['location_group']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['custom_affinity']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['custom_affinity']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['custom_audience']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['custom_audience']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['combined_audience']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['combined_audience']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['keyword_theme']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['keyword_theme']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['local_service_id']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['local_service_id']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION'].fields_by_name['brand_list']._loaded_options = None
  _globals['_CAMPAIGNCRITERION'].fields_by_name['brand_list']._serialized_options = b'\340A\005'
  _globals['_CAMPAIGNCRITERION']._loaded_options = None
  _globals['_CAMPAIGNCRITERION']._serialized_options = b'\352As\n*googleads.googleapis.com/CampaignCriterion\022Ecustomers/{customer_id}/campaignCriteria/{campaign_id}~{criterion_id}'
