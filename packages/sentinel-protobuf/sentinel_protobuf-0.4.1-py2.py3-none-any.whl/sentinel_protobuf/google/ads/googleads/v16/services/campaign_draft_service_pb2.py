...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/services/campaign_draft_service.proto'
)
...
from google.ads.googleads.v16.resources import campaign_draft_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_resources_dot_campaign__draft__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.services.campaign_draft_service_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n%com.google.ads.googleads.v16.servicesB\031CampaignDraftServiceProtoP\001ZIgoogle.golang.org/genproto/googleapis/ads/googleads/v16/services;services\242\002\003GAA\252\002!Google.Ads.GoogleAds.V16.Services\312\002!Google\\Ads\\GoogleAds\\V16\\Services\352\002%Google::Ads::GoogleAds::V16::Services'
  _globals['_MUTATECAMPAIGNDRAFTSREQUEST'].fields_by_name['customer_id']._loaded_options = None
  _globals['_MUTATECAMPAIGNDRAFTSREQUEST'].fields_by_name['customer_id']._serialized_options = b'\340A\002'
  _globals['_MUTATECAMPAIGNDRAFTSREQUEST'].fields_by_name['operations']._loaded_options = None
  _globals['_MUTATECAMPAIGNDRAFTSREQUEST'].fields_by_name['operations']._serialized_options = b'\340A\002'
  _globals['_PROMOTECAMPAIGNDRAFTREQUEST'].fields_by_name['campaign_draft']._loaded_options = None
  _globals['_PROMOTECAMPAIGNDRAFTREQUEST'].fields_by_name['campaign_draft']._serialized_options = b'\340A\002\372A(\n&googleads.googleapis.com/CampaignDraft'
  _globals['_CAMPAIGNDRAFTOPERATION'].fields_by_name['remove']._loaded_options = None
  _globals['_CAMPAIGNDRAFTOPERATION'].fields_by_name['remove']._serialized_options = b'\372A(\n&googleads.googleapis.com/CampaignDraft'
  _globals['_MUTATECAMPAIGNDRAFTRESULT'].fields_by_name['resource_name']._loaded_options = None
  _globals['_MUTATECAMPAIGNDRAFTRESULT'].fields_by_name['resource_name']._serialized_options = b'\372A(\n&googleads.googleapis.com/CampaignDraft'
  _globals['_LISTCAMPAIGNDRAFTASYNCERRORSREQUEST'].fields_by_name['resource_name']._loaded_options = None
  _globals['_LISTCAMPAIGNDRAFTASYNCERRORSREQUEST'].fields_by_name['resource_name']._serialized_options = b'\340A\002\372A(\n&googleads.googleapis.com/CampaignDraft'
  _globals['_CAMPAIGNDRAFTSERVICE']._loaded_options = None
  _globals['_CAMPAIGNDRAFTSERVICE']._serialized_options = b'\312A\030googleads.googleapis.com\322A\'https://www.googleapis.com/auth/adwords'
  _globals['_CAMPAIGNDRAFTSERVICE'].methods_by_name['MutateCampaignDrafts']._loaded_options = None
  _globals['_CAMPAIGNDRAFTSERVICE'].methods_by_name['MutateCampaignDrafts']._serialized_options = b'\332A\026customer_id,operations\202\323\344\223\0029\"4/v16/customers/{customer_id=*}/campaignDrafts:mutate:\001*'
  _globals['_CAMPAIGNDRAFTSERVICE'].methods_by_name['PromoteCampaignDraft']._loaded_options = None
  _globals['_CAMPAIGNDRAFTSERVICE'].methods_by_name['PromoteCampaignDraft']._serialized_options = b'\312A.\n\025google.protobuf.Empty\022\025google.protobuf.Empty\332A\016campaign_draft\202\323\344\223\002?\":/v16/{campaign_draft=customers/*/campaignDrafts/*}:promote:\001*'
  _globals['_CAMPAIGNDRAFTSERVICE'].methods_by_name['ListCampaignDraftAsyncErrors']._loaded_options = None
  _globals['_CAMPAIGNDRAFTSERVICE'].methods_by_name['ListCampaignDraftAsyncErrors']._serialized_options = b'\332A\rresource_name\202\323\344\223\002C\022A/v16/{resource_name=customers/*/campaignDrafts/*}:listAsyncErrors'
