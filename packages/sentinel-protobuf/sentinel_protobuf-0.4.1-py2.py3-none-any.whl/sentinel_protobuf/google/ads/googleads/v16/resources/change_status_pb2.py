...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/resources/change_status.proto'
)
...
from google.ads.googleads.v16.enums import change_status_operation_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_enums_dot_change__status__operation__pb2
from google.ads.googleads.v16.enums import change_status_resource_type_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_enums_dot_change__status__resource__type__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.resources.change_status_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n&com.google.ads.googleads.v16.resourcesB\021ChangeStatusProtoP\001ZKgoogle.golang.org/genproto/googleapis/ads/googleads/v16/resources;resources\242\002\003GAA\252\002\"Google.Ads.GoogleAds.V16.Resources\312\002\"Google\\Ads\\GoogleAds\\V16\\Resources\352\002&Google::Ads::GoogleAds::V16::Resources'
  _globals['_CHANGESTATUS'].fields_by_name['resource_name']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['resource_name']._serialized_options = b'\340A\003\372A\'\n%googleads.googleapis.com/ChangeStatus'
  _globals['_CHANGESTATUS'].fields_by_name['last_change_date_time']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['last_change_date_time']._serialized_options = b'\340A\003'
  _globals['_CHANGESTATUS'].fields_by_name['resource_type']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['resource_type']._serialized_options = b'\340A\003'
  _globals['_CHANGESTATUS'].fields_by_name['campaign']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['campaign']._serialized_options = b'\340A\003\372A#\n!googleads.googleapis.com/Campaign'
  _globals['_CHANGESTATUS'].fields_by_name['ad_group']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['ad_group']._serialized_options = b'\340A\003\372A\"\n googleads.googleapis.com/AdGroup'
  _globals['_CHANGESTATUS'].fields_by_name['resource_status']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['resource_status']._serialized_options = b'\340A\003'
  _globals['_CHANGESTATUS'].fields_by_name['ad_group_ad']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['ad_group_ad']._serialized_options = b'\340A\003\372A$\n\"googleads.googleapis.com/AdGroupAd'
  _globals['_CHANGESTATUS'].fields_by_name['ad_group_criterion']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['ad_group_criterion']._serialized_options = b'\340A\003\372A+\n)googleads.googleapis.com/AdGroupCriterion'
  _globals['_CHANGESTATUS'].fields_by_name['campaign_criterion']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['campaign_criterion']._serialized_options = b'\340A\003\372A,\n*googleads.googleapis.com/CampaignCriterion'
  _globals['_CHANGESTATUS'].fields_by_name['feed']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['feed']._serialized_options = b'\340A\003\372A\037\n\035googleads.googleapis.com/Feed'
  _globals['_CHANGESTATUS'].fields_by_name['feed_item']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['feed_item']._serialized_options = b'\340A\003\372A#\n!googleads.googleapis.com/FeedItem'
  _globals['_CHANGESTATUS'].fields_by_name['ad_group_feed']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['ad_group_feed']._serialized_options = b'\340A\003\372A&\n$googleads.googleapis.com/AdGroupFeed'
  _globals['_CHANGESTATUS'].fields_by_name['campaign_feed']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['campaign_feed']._serialized_options = b'\340A\003\372A\'\n%googleads.googleapis.com/CampaignFeed'
  _globals['_CHANGESTATUS'].fields_by_name['ad_group_bid_modifier']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['ad_group_bid_modifier']._serialized_options = b'\340A\003\372A-\n+googleads.googleapis.com/AdGroupBidModifier'
  _globals['_CHANGESTATUS'].fields_by_name['shared_set']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['shared_set']._serialized_options = b'\340A\003\372A$\n\"googleads.googleapis.com/SharedSet'
  _globals['_CHANGESTATUS'].fields_by_name['campaign_shared_set']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['campaign_shared_set']._serialized_options = b'\340A\003\372A,\n*googleads.googleapis.com/CampaignSharedSet'
  _globals['_CHANGESTATUS'].fields_by_name['asset']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['asset']._serialized_options = b'\340A\003\372A \n\036googleads.googleapis.com/Asset'
  _globals['_CHANGESTATUS'].fields_by_name['customer_asset']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['customer_asset']._serialized_options = b'\340A\003\372A(\n&googleads.googleapis.com/CustomerAsset'
  _globals['_CHANGESTATUS'].fields_by_name['campaign_asset']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['campaign_asset']._serialized_options = b'\340A\003\372A(\n&googleads.googleapis.com/CampaignAsset'
  _globals['_CHANGESTATUS'].fields_by_name['ad_group_asset']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['ad_group_asset']._serialized_options = b'\340A\003\372A\'\n%googleads.googleapis.com/AdGroupAsset'
  _globals['_CHANGESTATUS'].fields_by_name['combined_audience']._loaded_options = None
  _globals['_CHANGESTATUS'].fields_by_name['combined_audience']._serialized_options = b'\340A\003\372A+\n)googleads.googleapis.com/CombinedAudience'
  _globals['_CHANGESTATUS']._loaded_options = None
  _globals['_CHANGESTATUS']._serialized_options = b'\352A`\n%googleads.googleapis.com/ChangeStatus\0227customers/{customer_id}/changeStatus/{change_status_id}'
  _globals['_CHANGESTATUS']._serialized_start=283
  _globals['_CHANGESTATUS']._serialized_end=2160
