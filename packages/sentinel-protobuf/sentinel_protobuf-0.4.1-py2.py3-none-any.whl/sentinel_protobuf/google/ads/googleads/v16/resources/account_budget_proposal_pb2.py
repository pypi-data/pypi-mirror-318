...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/resources/account_budget_proposal.proto'
)
...
from google.ads.googleads.v16.enums import account_budget_proposal_status_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_enums_dot_account__budget__proposal__status__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.resources.account_budget_proposal_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n&com.google.ads.googleads.v16.resourcesB\032AccountBudgetProposalProtoP\001ZKgoogle.golang.org/genproto/googleapis/ads/googleads/v16/resources;resources\242\002\003GAA\252\002\"Google.Ads.GoogleAds.V16.Resources\312\002\"Google\\Ads\\GoogleAds\\V16\\Resources\352\002&Google::Ads::GoogleAds::V16::Resources'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['resource_name']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['resource_name']._serialized_options = b'\340A\005\372A0\n.googleads.googleapis.com/AccountBudgetProposal'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['id']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['id']._serialized_options = b'\340A\003'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['billing_setup']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['billing_setup']._serialized_options = b'\340A\005\372A\'\n%googleads.googleapis.com/BillingSetup'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['account_budget']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['account_budget']._serialized_options = b'\340A\005\372A(\n&googleads.googleapis.com/AccountBudget'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposal_type']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposal_type']._serialized_options = b'\340A\005'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['status']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['status']._serialized_options = b'\340A\003'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposed_name']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposed_name']._serialized_options = b'\340A\005'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['approved_start_date_time']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['approved_start_date_time']._serialized_options = b'\340A\003'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposed_purchase_order_number']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposed_purchase_order_number']._serialized_options = b'\340A\005'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposed_notes']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposed_notes']._serialized_options = b'\340A\005'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['creation_date_time']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['creation_date_time']._serialized_options = b'\340A\003'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['approval_date_time']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['approval_date_time']._serialized_options = b'\340A\003'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposed_start_date_time']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposed_start_date_time']._serialized_options = b'\340A\005'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposed_start_time_type']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposed_start_time_type']._serialized_options = b'\340A\005'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposed_end_date_time']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposed_end_date_time']._serialized_options = b'\340A\005'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposed_end_time_type']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposed_end_time_type']._serialized_options = b'\340A\005'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['approved_end_date_time']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['approved_end_date_time']._serialized_options = b'\340A\003'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['approved_end_time_type']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['approved_end_time_type']._serialized_options = b'\340A\003'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposed_spending_limit_micros']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposed_spending_limit_micros']._serialized_options = b'\340A\005'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposed_spending_limit_type']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['proposed_spending_limit_type']._serialized_options = b'\340A\005'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['approved_spending_limit_micros']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['approved_spending_limit_micros']._serialized_options = b'\340A\003'
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['approved_spending_limit_type']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL'].fields_by_name['approved_spending_limit_type']._serialized_options = b'\340A\003'
  _globals['_ACCOUNTBUDGETPROPOSAL']._loaded_options = None
  _globals['_ACCOUNTBUDGETPROPOSAL']._serialized_options = b'\352A}\n.googleads.googleapis.com/AccountBudgetProposal\022Kcustomers/{customer_id}/accountBudgetProposals/{account_budget_proposal_id}'
