...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/resources/billing_setup.proto'
)
...
from google.ads.googleads.v16.enums import billing_setup_status_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_enums_dot_billing__setup__status__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.resources.billing_setup_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n&com.google.ads.googleads.v16.resourcesB\021BillingSetupProtoP\001ZKgoogle.golang.org/genproto/googleapis/ads/googleads/v16/resources;resources\242\002\003GAA\252\002\"Google.Ads.GoogleAds.V16.Resources\312\002\"Google\\Ads\\GoogleAds\\V16\\Resources\352\002&Google::Ads::GoogleAds::V16::Resources'
  _globals['_BILLINGSETUP_PAYMENTSACCOUNTINFO'].fields_by_name['payments_account_id']._loaded_options = None
  _globals['_BILLINGSETUP_PAYMENTSACCOUNTINFO'].fields_by_name['payments_account_id']._serialized_options = b'\340A\003'
  _globals['_BILLINGSETUP_PAYMENTSACCOUNTINFO'].fields_by_name['payments_account_name']._loaded_options = None
  _globals['_BILLINGSETUP_PAYMENTSACCOUNTINFO'].fields_by_name['payments_account_name']._serialized_options = b'\340A\005'
  _globals['_BILLINGSETUP_PAYMENTSACCOUNTINFO'].fields_by_name['payments_profile_id']._loaded_options = None
  _globals['_BILLINGSETUP_PAYMENTSACCOUNTINFO'].fields_by_name['payments_profile_id']._serialized_options = b'\340A\005'
  _globals['_BILLINGSETUP_PAYMENTSACCOUNTINFO'].fields_by_name['payments_profile_name']._loaded_options = None
  _globals['_BILLINGSETUP_PAYMENTSACCOUNTINFO'].fields_by_name['payments_profile_name']._serialized_options = b'\340A\003'
  _globals['_BILLINGSETUP_PAYMENTSACCOUNTINFO'].fields_by_name['secondary_payments_profile_id']._loaded_options = None
  _globals['_BILLINGSETUP_PAYMENTSACCOUNTINFO'].fields_by_name['secondary_payments_profile_id']._serialized_options = b'\340A\003'
  _globals['_BILLINGSETUP'].fields_by_name['resource_name']._loaded_options = None
  _globals['_BILLINGSETUP'].fields_by_name['resource_name']._serialized_options = b'\340A\005\372A\'\n%googleads.googleapis.com/BillingSetup'
  _globals['_BILLINGSETUP'].fields_by_name['id']._loaded_options = None
  _globals['_BILLINGSETUP'].fields_by_name['id']._serialized_options = b'\340A\003'
  _globals['_BILLINGSETUP'].fields_by_name['status']._loaded_options = None
  _globals['_BILLINGSETUP'].fields_by_name['status']._serialized_options = b'\340A\003'
  _globals['_BILLINGSETUP'].fields_by_name['payments_account']._loaded_options = None
  _globals['_BILLINGSETUP'].fields_by_name['payments_account']._serialized_options = b'\340A\005\372A*\n(googleads.googleapis.com/PaymentsAccount'
  _globals['_BILLINGSETUP'].fields_by_name['payments_account_info']._loaded_options = None
  _globals['_BILLINGSETUP'].fields_by_name['payments_account_info']._serialized_options = b'\340A\005'
  _globals['_BILLINGSETUP'].fields_by_name['start_date_time']._loaded_options = None
  _globals['_BILLINGSETUP'].fields_by_name['start_date_time']._serialized_options = b'\340A\005'
  _globals['_BILLINGSETUP'].fields_by_name['start_time_type']._loaded_options = None
  _globals['_BILLINGSETUP'].fields_by_name['start_time_type']._serialized_options = b'\340A\005'
  _globals['_BILLINGSETUP'].fields_by_name['end_date_time']._loaded_options = None
  _globals['_BILLINGSETUP'].fields_by_name['end_date_time']._serialized_options = b'\340A\003'
  _globals['_BILLINGSETUP'].fields_by_name['end_time_type']._loaded_options = None
  _globals['_BILLINGSETUP'].fields_by_name['end_time_type']._serialized_options = b'\340A\003'
  _globals['_BILLINGSETUP']._loaded_options = None
  _globals['_BILLINGSETUP']._serialized_options = b'\352Aa\n%googleads.googleapis.com/BillingSetup\0228customers/{customer_id}/billingSetups/{billing_setup_id}'
