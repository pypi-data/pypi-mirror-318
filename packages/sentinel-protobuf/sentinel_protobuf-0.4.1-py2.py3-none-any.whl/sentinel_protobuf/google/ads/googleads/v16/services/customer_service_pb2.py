...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/services/customer_service.proto'
)
...
from google.ads.googleads.v16.resources import customer_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_resources_dot_customer__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.services.customer_service_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n%com.google.ads.googleads.v16.servicesB\024CustomerServiceProtoP\001ZIgoogle.golang.org/genproto/googleapis/ads/googleads/v16/services;services\242\002\003GAA\252\002!Google.Ads.GoogleAds.V16.Services\312\002!Google\\Ads\\GoogleAds\\V16\\Services\352\002%Google::Ads::GoogleAds::V16::Services'
  _globals['_MUTATECUSTOMERREQUEST'].fields_by_name['customer_id']._loaded_options = None
  _globals['_MUTATECUSTOMERREQUEST'].fields_by_name['customer_id']._serialized_options = b'\340A\002'
  _globals['_MUTATECUSTOMERREQUEST'].fields_by_name['operation']._loaded_options = None
  _globals['_MUTATECUSTOMERREQUEST'].fields_by_name['operation']._serialized_options = b'\340A\002'
  _globals['_CREATECUSTOMERCLIENTREQUEST'].fields_by_name['customer_id']._loaded_options = None
  _globals['_CREATECUSTOMERCLIENTREQUEST'].fields_by_name['customer_id']._serialized_options = b'\340A\002'
  _globals['_CREATECUSTOMERCLIENTREQUEST'].fields_by_name['customer_client']._loaded_options = None
  _globals['_CREATECUSTOMERCLIENTREQUEST'].fields_by_name['customer_client']._serialized_options = b'\340A\002'
  _globals['_CREATECUSTOMERCLIENTRESPONSE'].fields_by_name['resource_name']._loaded_options = None
  _globals['_CREATECUSTOMERCLIENTRESPONSE'].fields_by_name['resource_name']._serialized_options = b'\372A#\n!googleads.googleapis.com/Customer'
  _globals['_MUTATECUSTOMERRESULT'].fields_by_name['resource_name']._loaded_options = None
  _globals['_MUTATECUSTOMERRESULT'].fields_by_name['resource_name']._serialized_options = b'\372A#\n!googleads.googleapis.com/Customer'
  _globals['_CUSTOMERSERVICE']._loaded_options = None
  _globals['_CUSTOMERSERVICE']._serialized_options = b'\312A\030googleads.googleapis.com\322A\'https://www.googleapis.com/auth/adwords'
  _globals['_CUSTOMERSERVICE'].methods_by_name['MutateCustomer']._loaded_options = None
  _globals['_CUSTOMERSERVICE'].methods_by_name['MutateCustomer']._serialized_options = b'\332A\025customer_id,operation\202\323\344\223\002*\"%/v16/customers/{customer_id=*}:mutate:\001*'
  _globals['_CUSTOMERSERVICE'].methods_by_name['ListAccessibleCustomers']._loaded_options = None
  _globals['_CUSTOMERSERVICE'].methods_by_name['ListAccessibleCustomers']._serialized_options = b'\202\323\344\223\002(\022&/v16/customers:listAccessibleCustomers'
  _globals['_CUSTOMERSERVICE'].methods_by_name['CreateCustomerClient']._loaded_options = None
  _globals['_CUSTOMERSERVICE'].methods_by_name['CreateCustomerClient']._serialized_options = b'\332A\033customer_id,customer_client\202\323\344\223\0028\"3/v16/customers/{customer_id=*}:createCustomerClient:\001*'
