...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/resources/payments_account.proto'
)
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.resources.payments_account_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n&com.google.ads.googleads.v16.resourcesB\024PaymentsAccountProtoP\001ZKgoogle.golang.org/genproto/googleapis/ads/googleads/v16/resources;resources\242\002\003GAA\252\002\"Google.Ads.GoogleAds.V16.Resources\312\002\"Google\\Ads\\GoogleAds\\V16\\Resources\352\002&Google::Ads::GoogleAds::V16::Resources'
  _globals['_PAYMENTSACCOUNT'].fields_by_name['resource_name']._loaded_options = None
  _globals['_PAYMENTSACCOUNT'].fields_by_name['resource_name']._serialized_options = b'\340A\003\372A*\n(googleads.googleapis.com/PaymentsAccount'
  _globals['_PAYMENTSACCOUNT'].fields_by_name['payments_account_id']._loaded_options = None
  _globals['_PAYMENTSACCOUNT'].fields_by_name['payments_account_id']._serialized_options = b'\340A\003'
  _globals['_PAYMENTSACCOUNT'].fields_by_name['name']._loaded_options = None
  _globals['_PAYMENTSACCOUNT'].fields_by_name['name']._serialized_options = b'\340A\003'
  _globals['_PAYMENTSACCOUNT'].fields_by_name['currency_code']._loaded_options = None
  _globals['_PAYMENTSACCOUNT'].fields_by_name['currency_code']._serialized_options = b'\340A\003'
  _globals['_PAYMENTSACCOUNT'].fields_by_name['payments_profile_id']._loaded_options = None
  _globals['_PAYMENTSACCOUNT'].fields_by_name['payments_profile_id']._serialized_options = b'\340A\003'
  _globals['_PAYMENTSACCOUNT'].fields_by_name['secondary_payments_profile_id']._loaded_options = None
  _globals['_PAYMENTSACCOUNT'].fields_by_name['secondary_payments_profile_id']._serialized_options = b'\340A\003'
  _globals['_PAYMENTSACCOUNT'].fields_by_name['paying_manager_customer']._loaded_options = None
  _globals['_PAYMENTSACCOUNT'].fields_by_name['paying_manager_customer']._serialized_options = b'\340A\003\372A#\n!googleads.googleapis.com/Customer'
  _globals['_PAYMENTSACCOUNT']._loaded_options = None
  _globals['_PAYMENTSACCOUNT']._serialized_options = b'\352Aj\n(googleads.googleapis.com/PaymentsAccount\022>customers/{customer_id}/paymentsAccounts/{payments_account_id}'
