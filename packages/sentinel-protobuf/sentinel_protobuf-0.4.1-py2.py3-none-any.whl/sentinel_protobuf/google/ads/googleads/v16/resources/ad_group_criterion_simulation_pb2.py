...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/resources/ad_group_criterion_simulation.proto'
)
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.resources.ad_group_criterion_simulation_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n&com.google.ads.googleads.v16.resourcesB\037AdGroupCriterionSimulationProtoP\001ZKgoogle.golang.org/genproto/googleapis/ads/googleads/v16/resources;resources\242\002\003GAA\252\002\"Google.Ads.GoogleAds.V16.Resources\312\002\"Google\\Ads\\GoogleAds\\V16\\Resources\352\002&Google::Ads::GoogleAds::V16::Resources'
  _globals['_ADGROUPCRITERIONSIMULATION'].fields_by_name['resource_name']._loaded_options = None
  _globals['_ADGROUPCRITERIONSIMULATION'].fields_by_name['resource_name']._serialized_options = b'\340A\003\372A5\n3googleads.googleapis.com/AdGroupCriterionSimulation'
  _globals['_ADGROUPCRITERIONSIMULATION'].fields_by_name['ad_group_id']._loaded_options = None
  _globals['_ADGROUPCRITERIONSIMULATION'].fields_by_name['ad_group_id']._serialized_options = b'\340A\003'
  _globals['_ADGROUPCRITERIONSIMULATION'].fields_by_name['criterion_id']._loaded_options = None
  _globals['_ADGROUPCRITERIONSIMULATION'].fields_by_name['criterion_id']._serialized_options = b'\340A\003'
  _globals['_ADGROUPCRITERIONSIMULATION'].fields_by_name['type']._loaded_options = None
  _globals['_ADGROUPCRITERIONSIMULATION'].fields_by_name['type']._serialized_options = b'\340A\003'
  _globals['_ADGROUPCRITERIONSIMULATION'].fields_by_name['modification_method']._loaded_options = None
  _globals['_ADGROUPCRITERIONSIMULATION'].fields_by_name['modification_method']._serialized_options = b'\340A\003'
  _globals['_ADGROUPCRITERIONSIMULATION'].fields_by_name['start_date']._loaded_options = None
  _globals['_ADGROUPCRITERIONSIMULATION'].fields_by_name['start_date']._serialized_options = b'\340A\003'
  _globals['_ADGROUPCRITERIONSIMULATION'].fields_by_name['end_date']._loaded_options = None
  _globals['_ADGROUPCRITERIONSIMULATION'].fields_by_name['end_date']._serialized_options = b'\340A\003'
  _globals['_ADGROUPCRITERIONSIMULATION'].fields_by_name['cpc_bid_point_list']._loaded_options = None
  _globals['_ADGROUPCRITERIONSIMULATION'].fields_by_name['cpc_bid_point_list']._serialized_options = b'\340A\003'
  _globals['_ADGROUPCRITERIONSIMULATION'].fields_by_name['percent_cpc_bid_point_list']._loaded_options = None
  _globals['_ADGROUPCRITERIONSIMULATION'].fields_by_name['percent_cpc_bid_point_list']._serialized_options = b'\340A\003'
  _globals['_ADGROUPCRITERIONSIMULATION']._loaded_options = None
  _globals['_ADGROUPCRITERIONSIMULATION']._serialized_options = b'\352A\275\001\n3googleads.googleapis.com/AdGroupCriterionSimulation\022\205\001customers/{customer_id}/adGroupCriterionSimulations/{ad_group_id}~{criterion_id}~{type}~{modification_method}~{start_date}~{end_date}'
