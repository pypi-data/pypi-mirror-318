...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/services/smart_campaign_suggest_service.proto'
)
...
from google.ads.googleads.v16.common import ad_type_infos_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_common_dot_ad__type__infos__pb2
...
from google.ads.googleads.v16.resources import keyword_theme_constant_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_resources_dot_keyword__theme__constant__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.services.smart_campaign_suggest_service_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n%com.google.ads.googleads.v16.servicesB SmartCampaignSuggestServiceProtoP\001ZIgoogle.golang.org/genproto/googleapis/ads/googleads/v16/services;services\242\002\003GAA\252\002!Google.Ads.GoogleAds.V16.Services\312\002!Google\\Ads\\GoogleAds\\V16\\Services\352\002%Google::Ads::GoogleAds::V16::Services'
  _globals['_SUGGESTSMARTCAMPAIGNBUDGETOPTIONSREQUEST'].fields_by_name['customer_id']._loaded_options = None
  _globals['_SUGGESTSMARTCAMPAIGNBUDGETOPTIONSREQUEST'].fields_by_name['customer_id']._serialized_options = b'\340A\002'
  _globals['_SUGGESTSMARTCAMPAIGNBUDGETOPTIONSREQUEST'].fields_by_name['campaign']._loaded_options = None
  _globals['_SUGGESTSMARTCAMPAIGNBUDGETOPTIONSREQUEST'].fields_by_name['campaign']._serialized_options = b'\340A\002\372A#\n!googleads.googleapis.com/Campaign'
  _globals['_SUGGESTSMARTCAMPAIGNBUDGETOPTIONSREQUEST'].fields_by_name['suggestion_info']._loaded_options = None
  _globals['_SUGGESTSMARTCAMPAIGNBUDGETOPTIONSREQUEST'].fields_by_name['suggestion_info']._serialized_options = b'\340A\002'
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO_LOCATIONLIST'].fields_by_name['locations']._loaded_options = None
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO_LOCATIONLIST'].fields_by_name['locations']._serialized_options = b'\340A\002'
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO_BUSINESSCONTEXT'].fields_by_name['business_name']._loaded_options = None
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO_BUSINESSCONTEXT'].fields_by_name['business_name']._serialized_options = b'\340A\001'
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO'].fields_by_name['final_url']._loaded_options = None
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO'].fields_by_name['final_url']._serialized_options = b'\340A\001'
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO'].fields_by_name['language_code']._loaded_options = None
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO'].fields_by_name['language_code']._serialized_options = b'\340A\001'
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO'].fields_by_name['ad_schedules']._loaded_options = None
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO'].fields_by_name['ad_schedules']._serialized_options = b'\340A\001'
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO'].fields_by_name['keyword_themes']._loaded_options = None
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO'].fields_by_name['keyword_themes']._serialized_options = b'\340A\001'
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO'].fields_by_name['business_context']._loaded_options = None
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO'].fields_by_name['business_context']._serialized_options = b'\340A\001'
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO'].fields_by_name['business_profile_location']._loaded_options = None
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO'].fields_by_name['business_profile_location']._serialized_options = b'\340A\001'
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO'].fields_by_name['location_list']._loaded_options = None
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO'].fields_by_name['location_list']._serialized_options = b'\340A\001'
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO'].fields_by_name['proximity']._loaded_options = None
  _globals['_SMARTCAMPAIGNSUGGESTIONINFO'].fields_by_name['proximity']._serialized_options = b'\340A\001'
  _globals['_SUGGESTSMARTCAMPAIGNBUDGETOPTIONSRESPONSE'].fields_by_name['low']._loaded_options = None
  _globals['_SUGGESTSMARTCAMPAIGNBUDGETOPTIONSRESPONSE'].fields_by_name['low']._serialized_options = b'\340A\001'
  _globals['_SUGGESTSMARTCAMPAIGNBUDGETOPTIONSRESPONSE'].fields_by_name['recommended']._loaded_options = None
  _globals['_SUGGESTSMARTCAMPAIGNBUDGETOPTIONSRESPONSE'].fields_by_name['recommended']._serialized_options = b'\340A\001'
  _globals['_SUGGESTSMARTCAMPAIGNBUDGETOPTIONSRESPONSE'].fields_by_name['high']._loaded_options = None
  _globals['_SUGGESTSMARTCAMPAIGNBUDGETOPTIONSRESPONSE'].fields_by_name['high']._serialized_options = b'\340A\001'
  _globals['_SUGGESTSMARTCAMPAIGNADREQUEST'].fields_by_name['customer_id']._loaded_options = None
  _globals['_SUGGESTSMARTCAMPAIGNADREQUEST'].fields_by_name['customer_id']._serialized_options = b'\340A\002'
  _globals['_SUGGESTSMARTCAMPAIGNADREQUEST'].fields_by_name['suggestion_info']._loaded_options = None
  _globals['_SUGGESTSMARTCAMPAIGNADREQUEST'].fields_by_name['suggestion_info']._serialized_options = b'\340A\002'
  _globals['_SUGGESTSMARTCAMPAIGNADRESPONSE'].fields_by_name['ad_info']._loaded_options = None
  _globals['_SUGGESTSMARTCAMPAIGNADRESPONSE'].fields_by_name['ad_info']._serialized_options = b'\340A\001'
  _globals['_SUGGESTKEYWORDTHEMESREQUEST'].fields_by_name['customer_id']._loaded_options = None
  _globals['_SUGGESTKEYWORDTHEMESREQUEST'].fields_by_name['customer_id']._serialized_options = b'\340A\002'
  _globals['_SUGGESTKEYWORDTHEMESREQUEST'].fields_by_name['suggestion_info']._loaded_options = None
  _globals['_SUGGESTKEYWORDTHEMESREQUEST'].fields_by_name['suggestion_info']._serialized_options = b'\340A\002'
  _globals['_SMARTCAMPAIGNSUGGESTSERVICE']._loaded_options = None
  _globals['_SMARTCAMPAIGNSUGGESTSERVICE']._serialized_options = b'\312A\030googleads.googleapis.com\322A\'https://www.googleapis.com/auth/adwords'
  _globals['_SMARTCAMPAIGNSUGGESTSERVICE'].methods_by_name['SuggestSmartCampaignBudgetOptions']._loaded_options = None
  _globals['_SMARTCAMPAIGNSUGGESTSERVICE'].methods_by_name['SuggestSmartCampaignBudgetOptions']._serialized_options = b'\202\323\344\223\002E\"@/v16/customers/{customer_id=*}:suggestSmartCampaignBudgetOptions:\001*'
  _globals['_SMARTCAMPAIGNSUGGESTSERVICE'].methods_by_name['SuggestSmartCampaignAd']._loaded_options = None
  _globals['_SMARTCAMPAIGNSUGGESTSERVICE'].methods_by_name['SuggestSmartCampaignAd']._serialized_options = b'\202\323\344\223\002:\"5/v16/customers/{customer_id=*}:suggestSmartCampaignAd:\001*'
  _globals['_SMARTCAMPAIGNSUGGESTSERVICE'].methods_by_name['SuggestKeywordThemes']._loaded_options = None
  _globals['_SMARTCAMPAIGNSUGGESTSERVICE'].methods_by_name['SuggestKeywordThemes']._serialized_options = b'\202\323\344\223\0028\"3/v16/customers/{customer_id=*}:suggestKeywordThemes:\001*'
  ...
  _globals['_SMARTCAMPAIGNSUGGESTSERVICE']._serialized_end=3552
