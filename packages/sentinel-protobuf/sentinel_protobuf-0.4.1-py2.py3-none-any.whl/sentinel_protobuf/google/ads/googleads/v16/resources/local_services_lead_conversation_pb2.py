...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/resources/local_services_lead_conversation.proto'
)
...
from google.ads.googleads.v16.enums import local_services_conversation_type_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_enums_dot_local__services__conversation__type__pb2
from google.ads.googleads.v16.enums import local_services_participant_type_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_enums_dot_local__services__participant__type__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.resources.local_services_lead_conversation_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n&com.google.ads.googleads.v16.resourcesB\"LocalServicesLeadConversationProtoP\001ZKgoogle.golang.org/genproto/googleapis/ads/googleads/v16/resources;resources\242\002\003GAA\252\002\"Google.Ads.GoogleAds.V16.Resources\312\002\"Google\\Ads\\GoogleAds\\V16\\Resources\352\002&Google::Ads::GoogleAds::V16::Resources'
  _globals['_LOCALSERVICESLEADCONVERSATION'].fields_by_name['resource_name']._loaded_options = None
  _globals['_LOCALSERVICESLEADCONVERSATION'].fields_by_name['resource_name']._serialized_options = b'\340A\003\372A8\n6googleads.googleapis.com/LocalServicesLeadConversation'
  _globals['_LOCALSERVICESLEADCONVERSATION'].fields_by_name['id']._loaded_options = None
  _globals['_LOCALSERVICESLEADCONVERSATION'].fields_by_name['id']._serialized_options = b'\340A\003'
  _globals['_LOCALSERVICESLEADCONVERSATION'].fields_by_name['conversation_channel']._loaded_options = None
  _globals['_LOCALSERVICESLEADCONVERSATION'].fields_by_name['conversation_channel']._serialized_options = b'\340A\003'
  _globals['_LOCALSERVICESLEADCONVERSATION'].fields_by_name['participant_type']._loaded_options = None
  _globals['_LOCALSERVICESLEADCONVERSATION'].fields_by_name['participant_type']._serialized_options = b'\340A\003'
  _globals['_LOCALSERVICESLEADCONVERSATION'].fields_by_name['lead']._loaded_options = None
  _globals['_LOCALSERVICESLEADCONVERSATION'].fields_by_name['lead']._serialized_options = b'\340A\003\372A,\n*googleads.googleapis.com/LocalServicesLead'
  _globals['_LOCALSERVICESLEADCONVERSATION'].fields_by_name['event_date_time']._loaded_options = None
  _globals['_LOCALSERVICESLEADCONVERSATION'].fields_by_name['event_date_time']._serialized_options = b'\340A\003'
  _globals['_LOCALSERVICESLEADCONVERSATION'].fields_by_name['phone_call_details']._loaded_options = None
  _globals['_LOCALSERVICESLEADCONVERSATION'].fields_by_name['phone_call_details']._serialized_options = b'\340A\003'
  _globals['_LOCALSERVICESLEADCONVERSATION'].fields_by_name['message_details']._loaded_options = None
  _globals['_LOCALSERVICESLEADCONVERSATION'].fields_by_name['message_details']._serialized_options = b'\340A\003'
  _globals['_LOCALSERVICESLEADCONVERSATION']._loaded_options = None
  _globals['_LOCALSERVICESLEADCONVERSATION']._serialized_options = b'\352A\226\001\n6googleads.googleapis.com/LocalServicesLeadConversation\022\\customers/{customer_id}/localServicesLeadConversations/{local_services_lead_conversation_id}'
  _globals['_PHONECALLDETAILS'].fields_by_name['call_duration_millis']._loaded_options = None
  _globals['_PHONECALLDETAILS'].fields_by_name['call_duration_millis']._serialized_options = b'\340A\003'
  _globals['_PHONECALLDETAILS'].fields_by_name['call_recording_url']._loaded_options = None
  _globals['_PHONECALLDETAILS'].fields_by_name['call_recording_url']._serialized_options = b'\340A\003'
  _globals['_MESSAGEDETAILS'].fields_by_name['text']._loaded_options = None
  _globals['_MESSAGEDETAILS'].fields_by_name['text']._serialized_options = b'\340A\003'
  _globals['_MESSAGEDETAILS'].fields_by_name['attachment_urls']._loaded_options = None
  _globals['_MESSAGEDETAILS'].fields_by_name['attachment_urls']._serialized_options = b'\340A\003'
