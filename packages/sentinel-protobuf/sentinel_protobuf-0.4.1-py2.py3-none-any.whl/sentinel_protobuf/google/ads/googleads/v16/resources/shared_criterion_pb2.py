...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/resources/shared_criterion.proto'
)
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.resources.shared_criterion_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n&com.google.ads.googleads.v16.resourcesB\024SharedCriterionProtoP\001ZKgoogle.golang.org/genproto/googleapis/ads/googleads/v16/resources;resources\242\002\003GAA\252\002\"Google.Ads.GoogleAds.V16.Resources\312\002\"Google\\Ads\\GoogleAds\\V16\\Resources\352\002&Google::Ads::GoogleAds::V16::Resources'
  _globals['_SHAREDCRITERION'].fields_by_name['resource_name']._loaded_options = None
  _globals['_SHAREDCRITERION'].fields_by_name['resource_name']._serialized_options = b'\340A\005\372A*\n(googleads.googleapis.com/SharedCriterion'
  _globals['_SHAREDCRITERION'].fields_by_name['shared_set']._loaded_options = None
  _globals['_SHAREDCRITERION'].fields_by_name['shared_set']._serialized_options = b'\340A\005\372A$\n\"googleads.googleapis.com/SharedSet'
  _globals['_SHAREDCRITERION'].fields_by_name['criterion_id']._loaded_options = None
  _globals['_SHAREDCRITERION'].fields_by_name['criterion_id']._serialized_options = b'\340A\003'
  _globals['_SHAREDCRITERION'].fields_by_name['type']._loaded_options = None
  _globals['_SHAREDCRITERION'].fields_by_name['type']._serialized_options = b'\340A\003'
  _globals['_SHAREDCRITERION'].fields_by_name['keyword']._loaded_options = None
  _globals['_SHAREDCRITERION'].fields_by_name['keyword']._serialized_options = b'\340A\005'
  _globals['_SHAREDCRITERION'].fields_by_name['youtube_video']._loaded_options = None
  _globals['_SHAREDCRITERION'].fields_by_name['youtube_video']._serialized_options = b'\340A\005'
  _globals['_SHAREDCRITERION'].fields_by_name['youtube_channel']._loaded_options = None
  _globals['_SHAREDCRITERION'].fields_by_name['youtube_channel']._serialized_options = b'\340A\005'
  _globals['_SHAREDCRITERION'].fields_by_name['placement']._loaded_options = None
  _globals['_SHAREDCRITERION'].fields_by_name['placement']._serialized_options = b'\340A\005'
  _globals['_SHAREDCRITERION'].fields_by_name['mobile_app_category']._loaded_options = None
  _globals['_SHAREDCRITERION'].fields_by_name['mobile_app_category']._serialized_options = b'\340A\005'
  _globals['_SHAREDCRITERION'].fields_by_name['mobile_application']._loaded_options = None
  _globals['_SHAREDCRITERION'].fields_by_name['mobile_application']._serialized_options = b'\340A\005'
  _globals['_SHAREDCRITERION'].fields_by_name['brand']._loaded_options = None
  _globals['_SHAREDCRITERION'].fields_by_name['brand']._serialized_options = b'\340A\005'
  _globals['_SHAREDCRITERION']._loaded_options = None
  _globals['_SHAREDCRITERION']._serialized_options = b'\352Aq\n(googleads.googleapis.com/SharedCriterion\022Ecustomers/{customer_id}/sharedCriteria/{shared_set_id}~{criterion_id}'
