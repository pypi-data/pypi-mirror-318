...
class GenerationConfig(_message.Message):
    __slots__ = ("candidate_count", "stop_sequences", "max_output_tokens", "temperature", "top_p", "top_k", "presence_penalty", "frequency_penalty", "response_logprobs", "logprobs")
...
class Candidate(_message.Message):
    __slots__ = ("index", "content", "finish_reason", "safety_ratings", "citation_metadata", "token_count", "grounding_metadata", "avg_logprobs", "logprobs_result")
