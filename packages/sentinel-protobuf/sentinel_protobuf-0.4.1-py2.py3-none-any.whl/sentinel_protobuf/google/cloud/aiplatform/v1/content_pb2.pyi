...
class Part(_message.Message):
    __slots__ = ("text", "inline_data", "file_data", "function_call", "function_response", "video_metadata")
    ...
    def __init__(self, text: _Optional[str] = ..., inline_data: _Optional[_Union[Blob, _Mapping]] = ..., file_data: _Optional[_Union[FileData, _Mapping]] = ..., function_call: _Optional[_Union[_tool_pb2.FunctionCall, _Mapping]] = ..., function_response: _Optional[_Union[_tool_pb2.FunctionResponse, _Mapping]] = ..., video_metadata: _Optional[_Union[VideoMetadata, _Mapping]] = ...) -> None: ...
...
class GenerationConfig(_message.Message):
    __slots__ = ("temperature", "top_p", "top_k", "candidate_count", "max_output_tokens", "stop_sequences", "response_logprobs", "logprobs", "presence_penalty", "frequency_penalty", "seed", "response_mime_type", "response_schema", "routing_config")
    ...
    def __init__(self, temperature: _Optional[float] = ..., top_p: _Optional[float] = ..., top_k: _Optional[float] = ..., candidate_count: _Optional[int] = ..., max_output_tokens: _Optional[int] = ..., stop_sequences: _Optional[_Iterable[str]] = ..., response_logprobs: bool = ..., logprobs: _Optional[int] = ..., presence_penalty: _Optional[float] = ..., frequency_penalty: _Optional[float] = ..., seed: _Optional[int] = ..., response_mime_type: _Optional[str] = ..., response_schema: _Optional[_Union[_openapi_pb2.Schema, _Mapping]] = ..., routing_config: _Optional[_Union[GenerationConfig.RoutingConfig, _Mapping]] = ...) -> None: ...
...
class Candidate(_message.Message):
    __slots__ = ("index", "content", "score", "avg_logprobs", "logprobs_result", "finish_reason", "safety_ratings", "finish_message", "citation_metadata", "grounding_metadata")
...
class GroundingMetadata(_message.Message):
    __slots__ = ("web_search_queries", "search_entry_point", "grounding_chunks", "grounding_supports", "retrieval_metadata")
