...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 28, 1, '', 'sentinel/lease/v1/lease.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_LEASE'].fields_by_name['inactive_at']._loaded_options = None
    _globals['_LEASE'].fields_by_name['inactive_at']._serialized_options = b'\xc8\xde\x1f\x00\x90\xdf\x1f\x01'
    _globals['_LEASE'].fields_by_name['payout_at']._loaded_options = None
    _globals['_LEASE'].fields_by_name['payout_at']._serialized_options = b'\xc8\xde\x1f\x00\x90\xdf\x1f\x01'
    _globals['_LEASE']._serialized_start = 172
    _globals['_LEASE']._serialized_end = 509