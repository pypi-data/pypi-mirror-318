...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MSGENDLEASEREQUEST']._serialized_end = 191
    _globals['_MSGRENEWLEASEREQUEST']._serialized_start = 193
    _globals['_MSGRENEWLEASEREQUEST']._serialized_end = 279
    _globals['_MSGSTARTLEASEREQUEST']._serialized_start = 282
    _globals['_MSGSTARTLEASEREQUEST']._serialized_end = 439
    _globals['_MSGUPDATELEASEREQUEST']._serialized_start = 441
    _globals['_MSGUPDATELEASEREQUEST']._serialized_end = 567
    _globals['_MSGUPDATEPARAMSREQUEST']._serialized_start = 569
    _globals['_MSGUPDATEPARAMSREQUEST']._serialized_end = 656
    _globals['_MSGENDLEASERESPONSE']._serialized_start = 658
    _globals['_MSGENDLEASERESPONSE']._serialized_end = 679
    _globals['_MSGRENEWLEASERESPONSE']._serialized_start = 681
    _globals['_MSGRENEWLEASERESPONSE']._serialized_end = 704
    _globals['_MSGSTARTLEASERESPONSE']._serialized_start = 706
    _globals['_MSGSTARTLEASERESPONSE']._serialized_end = 749
    _globals['_MSGUPDATELEASERESPONSE']._serialized_start = 751
    _globals['_MSGUPDATELEASERESPONSE']._serialized_end = 775
    _globals['_MSGUPDATEPARAMSRESPONSE']._serialized_start = 777
    _globals['_MSGUPDATEPARAMSRESPONSE']._serialized_end = 802
    _globals['_MSGSERVICE']._serialized_start = 805
    _globals['_MSGSERVICE']._serialized_end = 1320