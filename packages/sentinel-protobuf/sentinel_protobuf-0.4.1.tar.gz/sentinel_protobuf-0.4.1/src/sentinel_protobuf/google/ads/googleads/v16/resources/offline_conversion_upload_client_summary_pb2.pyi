from google.ads.googleads.v16.enums import offline_conversion_diagnostic_status_enum_pb2 as _offline_conversion_diagnostic_status_enum_pb2
from google.ads.googleads.v16.enums import offline_event_upload_client_enum_pb2 as _offline_event_upload_client_enum_pb2
...
class OfflineConversionUploadClientSummary(_message.Message):
    __slots__ = ('resource_name', 'client', 'status', 'total_event_count', 'successful_event_count', 'success_rate', 'last_upload_date_time', 'daily_summaries', 'job_summaries', 'alerts')
...
class OfflineConversionSummary(_message.Message):
    ...
    def __init__(self, successful_count: _Optional[int]=..., failed_count: _Optional[int]=..., job_id: _Optional[int]=..., upload_date: _Optional[str]=...) -> None:
        ...
