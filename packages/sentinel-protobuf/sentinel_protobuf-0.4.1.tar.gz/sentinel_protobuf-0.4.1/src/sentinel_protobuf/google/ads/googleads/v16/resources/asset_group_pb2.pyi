...
from google.ads.googleads.v16.enums import asset_group_primary_status_pb2 as _asset_group_primary_status_pb2
from google.ads.googleads.v16.enums import asset_group_primary_status_reason_pb2 as _asset_group_primary_status_reason_pb2
from google.ads.googleads.v16.enums import asset_group_status_pb2 as _asset_group_status_pb2
...
class AssetGroup(_message.Message):
    __slots__ = ('resource_name', 'id', 'campaign', 'name', 'final_urls', 'final_mobile_urls', 'status', 'primary_status', 'primary_status_reasons', 'path1', 'path2', 'ad_strength')
