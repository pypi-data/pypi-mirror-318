...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/resources/accessible_bidding_strategy.proto'
)
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.resources.accessible_bidding_strategy_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n&com.google.ads.googleads.v16.resourcesB\036AccessibleBiddingStrategyProtoP\001ZKgoogle.golang.org/genproto/googleapis/ads/googleads/v16/resources;resources\242\002\003GAA\252\002\"Google.Ads.GoogleAds.V16.Resources\312\002\"Google\\Ads\\GoogleAds\\V16\\Resources\352\002&Google::Ads::GoogleAds::V16::Resources'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY_MAXIMIZECONVERSIONVALUE'].fields_by_name['target_roas']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY_MAXIMIZECONVERSIONVALUE'].fields_by_name['target_roas']._serialized_options = b'\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY_MAXIMIZECONVERSIONS'].fields_by_name['target_cpa_micros']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY_MAXIMIZECONVERSIONS'].fields_by_name['target_cpa_micros']._serialized_options = b'\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY_TARGETCPA'].fields_by_name['target_cpa_micros']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY_TARGETCPA'].fields_by_name['target_cpa_micros']._serialized_options = b'\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY_TARGETIMPRESSIONSHARE'].fields_by_name['location']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY_TARGETIMPRESSIONSHARE'].fields_by_name['location']._serialized_options = b'\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY_TARGETIMPRESSIONSHARE'].fields_by_name['cpc_bid_ceiling_micros']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY_TARGETIMPRESSIONSHARE'].fields_by_name['cpc_bid_ceiling_micros']._serialized_options = b'\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY_TARGETROAS'].fields_by_name['target_roas']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY_TARGETROAS'].fields_by_name['target_roas']._serialized_options = b'\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY_TARGETSPEND'].fields_by_name['target_spend_micros']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY_TARGETSPEND'].fields_by_name['target_spend_micros']._serialized_options = b'\030\001\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY_TARGETSPEND'].fields_by_name['cpc_bid_ceiling_micros']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY_TARGETSPEND'].fields_by_name['cpc_bid_ceiling_micros']._serialized_options = b'\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['resource_name']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['resource_name']._serialized_options = b'\340A\003\372A4\n2googleads.googleapis.com/AccessibleBiddingStrategy'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['id']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['id']._serialized_options = b'\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['name']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['name']._serialized_options = b'\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['type']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['type']._serialized_options = b'\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['owner_customer_id']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['owner_customer_id']._serialized_options = b'\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['owner_descriptive_name']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['owner_descriptive_name']._serialized_options = b'\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['maximize_conversion_value']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['maximize_conversion_value']._serialized_options = b'\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['maximize_conversions']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['maximize_conversions']._serialized_options = b'\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['target_cpa']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['target_cpa']._serialized_options = b'\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['target_impression_share']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['target_impression_share']._serialized_options = b'\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['target_roas']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['target_roas']._serialized_options = b'\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['target_spend']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY'].fields_by_name['target_spend']._serialized_options = b'\340A\003'
  _globals['_ACCESSIBLEBIDDINGSTRATEGY']._loaded_options = None
  _globals['_ACCESSIBLEBIDDINGSTRATEGY']._serialized_options = b'\352A\177\n2googleads.googleapis.com/AccessibleBiddingStrategy\022Icustomers/{customer_id}/accessibleBiddingStrategies/{bidding_strategy_id}'
