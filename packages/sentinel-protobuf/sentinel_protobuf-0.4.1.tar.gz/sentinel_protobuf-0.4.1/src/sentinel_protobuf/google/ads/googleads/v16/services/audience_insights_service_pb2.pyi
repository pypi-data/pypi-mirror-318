...
from google.ads.googleads.v16.enums import audience_insights_dimension_pb2 as _audience_insights_dimension_pb2
...
class ListAudienceInsightsAttributesRequest(_message.Message):
    __slots__ = ("customer_id", "dimensions", "query_text", "customer_insights_group", "location_country_filters")
    CUSTOMER_ID_FIELD_NUMBER: _ClassVar[int]
    DIMENSIONS_FIELD_NUMBER: _ClassVar[int]
...
class AudienceInsightsAttributeMetadata(_message.Message):
    __slots__ = ("dimension", "attribute", "display_name", "display_info", "youtube_channel_metadata", "dynamic_attribute_metadata", "location_attribute_metadata")
    ...
    def __init__(self, dimension: _Optional[_Union[_audience_insights_dimension_pb2.AudienceInsightsDimensionEnum.AudienceInsightsDimension, str]] = ..., attribute: _Optional[_Union[AudienceInsightsAttribute, _Mapping]] = ..., display_name: _Optional[str] = ..., display_info: _Optional[str] = ..., youtube_channel_metadata: _Optional[_Union[YouTubeChannelAttributeMetadata, _Mapping]] = ..., dynamic_attribute_metadata: _Optional[_Union[DynamicLineupAttributeMetadata, _Mapping]] = ..., location_attribute_metadata: _Optional[_Union[LocationAttributeMetadata, _Mapping]] = ...) -> None: ...
