...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/services/bidding_strategy_service.proto'
)
...
from google.ads.googleads.v16.resources import bidding_strategy_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_resources_dot_bidding__strategy__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.services.bidding_strategy_service_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n%com.google.ads.googleads.v16.servicesB\033BiddingStrategyServiceProtoP\001ZIgoogle.golang.org/genproto/googleapis/ads/googleads/v16/services;services\242\002\003GAA\252\002!Google.Ads.GoogleAds.V16.Services\312\002!Google\\Ads\\GoogleAds\\V16\\Services\352\002%Google::Ads::GoogleAds::V16::Services'
  _globals['_MUTATEBIDDINGSTRATEGIESREQUEST'].fields_by_name['customer_id']._loaded_options = None
  _globals['_MUTATEBIDDINGSTRATEGIESREQUEST'].fields_by_name['customer_id']._serialized_options = b'\340A\002'
  _globals['_MUTATEBIDDINGSTRATEGIESREQUEST'].fields_by_name['operations']._loaded_options = None
  _globals['_MUTATEBIDDINGSTRATEGIESREQUEST'].fields_by_name['operations']._serialized_options = b'\340A\002'
  _globals['_BIDDINGSTRATEGYOPERATION'].fields_by_name['remove']._loaded_options = None
  _globals['_BIDDINGSTRATEGYOPERATION'].fields_by_name['remove']._serialized_options = b'\372A*\n(googleads.googleapis.com/BiddingStrategy'
  _globals['_MUTATEBIDDINGSTRATEGYRESULT'].fields_by_name['resource_name']._loaded_options = None
  _globals['_MUTATEBIDDINGSTRATEGYRESULT'].fields_by_name['resource_name']._serialized_options = b'\372A*\n(googleads.googleapis.com/BiddingStrategy'
  _globals['_BIDDINGSTRATEGYSERVICE']._loaded_options = None
  _globals['_BIDDINGSTRATEGYSERVICE']._serialized_options = b'\312A\030googleads.googleapis.com\322A\'https://www.googleapis.com/auth/adwords'
  _globals['_BIDDINGSTRATEGYSERVICE'].methods_by_name['MutateBiddingStrategies']._loaded_options = None
  _globals['_BIDDINGSTRATEGYSERVICE'].methods_by_name['MutateBiddingStrategies']._serialized_options = b'\332A\026customer_id,operations\202\323\344\223\002<\"7/v16/customers/{customer_id=*}/biddingStrategies:mutate:\001*'
