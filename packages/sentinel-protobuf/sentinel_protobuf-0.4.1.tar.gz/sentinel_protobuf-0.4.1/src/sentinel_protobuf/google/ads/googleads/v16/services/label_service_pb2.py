...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/services/label_service.proto'
)
...
from google.ads.googleads.v16.resources import label_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_resources_dot_label__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.services.label_service_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n%com.google.ads.googleads.v16.servicesB\021LabelServiceProtoP\001ZIgoogle.golang.org/genproto/googleapis/ads/googleads/v16/services;services\242\002\003GAA\252\002!Google.Ads.GoogleAds.V16.Services\312\002!Google\\Ads\\GoogleAds\\V16\\Services\352\002%Google::Ads::GoogleAds::V16::Services'
  _globals['_MUTATELABELSREQUEST'].fields_by_name['customer_id']._loaded_options = None
  _globals['_MUTATELABELSREQUEST'].fields_by_name['customer_id']._serialized_options = b'\340A\002'
  _globals['_MUTATELABELSREQUEST'].fields_by_name['operations']._loaded_options = None
  _globals['_MUTATELABELSREQUEST'].fields_by_name['operations']._serialized_options = b'\340A\002'
  _globals['_LABELOPERATION'].fields_by_name['remove']._loaded_options = None
  _globals['_LABELOPERATION'].fields_by_name['remove']._serialized_options = b'\372A \n\036googleads.googleapis.com/Label'
  _globals['_MUTATELABELRESULT'].fields_by_name['resource_name']._loaded_options = None
  _globals['_MUTATELABELRESULT'].fields_by_name['resource_name']._serialized_options = b'\372A \n\036googleads.googleapis.com/Label'
  _globals['_LABELSERVICE']._loaded_options = None
  _globals['_LABELSERVICE']._serialized_options = b'\312A\030googleads.googleapis.com\322A\'https://www.googleapis.com/auth/adwords'
  _globals['_LABELSERVICE'].methods_by_name['MutateLabels']._loaded_options = None
  _globals['_LABELSERVICE'].methods_by_name['MutateLabels']._serialized_options = b'\332A\026customer_id,operations\202\323\344\223\0021\",/v16/customers/{customer_id=*}/labels:mutate:\001*'
