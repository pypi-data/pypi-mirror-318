...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/resources/customer_asset.proto'
)
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.resources.customer_asset_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n&com.google.ads.googleads.v16.resourcesB\022CustomerAssetProtoP\001ZKgoogle.golang.org/genproto/googleapis/ads/googleads/v16/resources;resources\242\002\003GAA\252\002\"Google.Ads.GoogleAds.V16.Resources\312\002\"Google\\Ads\\GoogleAds\\V16\\Resources\352\002&Google::Ads::GoogleAds::V16::Resources'
  _globals['_CUSTOMERASSET'].fields_by_name['resource_name']._loaded_options = None
  _globals['_CUSTOMERASSET'].fields_by_name['resource_name']._serialized_options = b'\340A\005\372A(\n&googleads.googleapis.com/CustomerAsset'
  _globals['_CUSTOMERASSET'].fields_by_name['asset']._loaded_options = None
  _globals['_CUSTOMERASSET'].fields_by_name['asset']._serialized_options = b'\340A\002\340A\005\372A \n\036googleads.googleapis.com/Asset'
  _globals['_CUSTOMERASSET'].fields_by_name['field_type']._loaded_options = None
  _globals['_CUSTOMERASSET'].fields_by_name['field_type']._serialized_options = b'\340A\002\340A\005'
  _globals['_CUSTOMERASSET'].fields_by_name['source']._loaded_options = None
  _globals['_CUSTOMERASSET'].fields_by_name['source']._serialized_options = b'\340A\003'
  _globals['_CUSTOMERASSET'].fields_by_name['primary_status']._loaded_options = None
  _globals['_CUSTOMERASSET'].fields_by_name['primary_status']._serialized_options = b'\340A\003'
  _globals['_CUSTOMERASSET'].fields_by_name['primary_status_details']._loaded_options = None
  _globals['_CUSTOMERASSET'].fields_by_name['primary_status_details']._serialized_options = b'\340A\003'
  _globals['_CUSTOMERASSET'].fields_by_name['primary_status_reasons']._loaded_options = None
  _globals['_CUSTOMERASSET'].fields_by_name['primary_status_reasons']._serialized_options = b'\340A\003'
  _globals['_CUSTOMERASSET']._loaded_options = None
  _globals['_CUSTOMERASSET']._serialized_options = b'\352Ah\n&googleads.googleapis.com/CustomerAsset\022>customers/{customer_id}/customerAssets/{asset_id}~{field_type}'
