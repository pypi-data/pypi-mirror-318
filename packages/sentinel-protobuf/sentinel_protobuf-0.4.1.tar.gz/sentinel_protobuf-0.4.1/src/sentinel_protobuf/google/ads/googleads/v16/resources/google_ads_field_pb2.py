...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v16/resources/google_ads_field.proto'
)
...
from google.ads.googleads.v16.enums import google_ads_field_category_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_enums_dot_google__ads__field__category__pb2
from google.ads.googleads.v16.enums import google_ads_field_data_type_pb2 as google_dot_ads_dot_googleads_dot_v16_dot_enums_dot_google__ads__field__data__type__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v16.resources.google_ads_field_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n&com.google.ads.googleads.v16.resourcesB\023GoogleAdsFieldProtoP\001ZKgoogle.golang.org/genproto/googleapis/ads/googleads/v16/resources;resources\242\002\003GAA\252\002\"Google.Ads.GoogleAds.V16.Resources\312\002\"Google\\Ads\\GoogleAds\\V16\\Resources\352\002&Google::Ads::GoogleAds::V16::Resources'
  _globals['_GOOGLEADSFIELD'].fields_by_name['resource_name']._loaded_options = None
  _globals['_GOOGLEADSFIELD'].fields_by_name['resource_name']._serialized_options = b'\340A\003\372A)\n\'googleads.googleapis.com/GoogleAdsField'
  _globals['_GOOGLEADSFIELD'].fields_by_name['name']._loaded_options = None
  _globals['_GOOGLEADSFIELD'].fields_by_name['name']._serialized_options = b'\340A\003'
  _globals['_GOOGLEADSFIELD'].fields_by_name['category']._loaded_options = None
  _globals['_GOOGLEADSFIELD'].fields_by_name['category']._serialized_options = b'\340A\003'
  _globals['_GOOGLEADSFIELD'].fields_by_name['selectable']._loaded_options = None
  _globals['_GOOGLEADSFIELD'].fields_by_name['selectable']._serialized_options = b'\340A\003'
  _globals['_GOOGLEADSFIELD'].fields_by_name['filterable']._loaded_options = None
  _globals['_GOOGLEADSFIELD'].fields_by_name['filterable']._serialized_options = b'\340A\003'
  _globals['_GOOGLEADSFIELD'].fields_by_name['sortable']._loaded_options = None
  _globals['_GOOGLEADSFIELD'].fields_by_name['sortable']._serialized_options = b'\340A\003'
  _globals['_GOOGLEADSFIELD'].fields_by_name['selectable_with']._loaded_options = None
  _globals['_GOOGLEADSFIELD'].fields_by_name['selectable_with']._serialized_options = b'\340A\003'
  _globals['_GOOGLEADSFIELD'].fields_by_name['attribute_resources']._loaded_options = None
  _globals['_GOOGLEADSFIELD'].fields_by_name['attribute_resources']._serialized_options = b'\340A\003'
  _globals['_GOOGLEADSFIELD'].fields_by_name['metrics']._loaded_options = None
  _globals['_GOOGLEADSFIELD'].fields_by_name['metrics']._serialized_options = b'\340A\003'
  _globals['_GOOGLEADSFIELD'].fields_by_name['segments']._loaded_options = None
  _globals['_GOOGLEADSFIELD'].fields_by_name['segments']._serialized_options = b'\340A\003'
  _globals['_GOOGLEADSFIELD'].fields_by_name['enum_values']._loaded_options = None
  _globals['_GOOGLEADSFIELD'].fields_by_name['enum_values']._serialized_options = b'\340A\003'
  _globals['_GOOGLEADSFIELD'].fields_by_name['data_type']._loaded_options = None
  _globals['_GOOGLEADSFIELD'].fields_by_name['data_type']._serialized_options = b'\340A\003'
  _globals['_GOOGLEADSFIELD'].fields_by_name['type_url']._loaded_options = None
  _globals['_GOOGLEADSFIELD'].fields_by_name['type_url']._serialized_options = b'\340A\003'
  _globals['_GOOGLEADSFIELD'].fields_by_name['is_repeated']._loaded_options = None
  _globals['_GOOGLEADSFIELD'].fields_by_name['is_repeated']._serialized_options = b'\340A\003'
  _globals['_GOOGLEADSFIELD']._loaded_options = None
  _globals['_GOOGLEADSFIELD']._serialized_options = b'\352AM\n\'googleads.googleapis.com/GoogleAdsField\022\"googleAdsFields/{google_ads_field}'
