...
class RestoreDatabaseRequest(_message.Message):
    ...
    def __init__(self, parent: _Optional[str]=..., database_id: _Optional[str]=..., backup: _Optional[str]=..., encryption_config: _Optional[_Union[_database_pb2.Database.EncryptionConfig, _Mapping]]=...) -> None:
        ...