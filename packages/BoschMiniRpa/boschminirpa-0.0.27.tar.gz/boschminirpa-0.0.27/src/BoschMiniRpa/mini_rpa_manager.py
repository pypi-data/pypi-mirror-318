...
class MiniRpaManager(MiniRpaFunction):
    def __init__(self, user_name: str, user_password: str, server_name: str, share_name: str, port: int, from_period: str, to_period: str, report_save_path: str,
                 report_process_folder_path: str, report_period_type: str, process_cache_data: dict, process_number: int, process_dict: dict, delivery_dict: dict,
    ...
    def prepare_download_file_name(self, sap_operation_dict):
    ...
    def start_bot(self):
        ...
        if self.download_data:
            ...
            for process_step_dict in self.sap_operation_list:
                ...
                self.prepare_download_file_name(sap_operation_dict)
        ...
        if self.process_data:
            ...
            from_column_name = self.process_dict['from_column_name']
            ...
            update_column_name = self.process_dict['update_column_name']
            ...
            elif function_name == 'copy_excel_files':
