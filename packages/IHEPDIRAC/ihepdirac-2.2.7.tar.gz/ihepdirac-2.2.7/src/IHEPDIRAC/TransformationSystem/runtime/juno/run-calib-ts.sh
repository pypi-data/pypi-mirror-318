...
inputfile=$(ls *elecsim*.root)
num2=${inputfile##*-}
seed=${num2%.*}
echo "Run command: python $TUTORIALROOT/share/tut_elec2calib.py --evtmax $evtmax --input $inputfile --output calib-$seed.root $extraArgs"
time python $TUTORIALROOT/share/tut_elec2calib.py --evtmax $evtmax --input $inputfile --output calib-$seed.root $extraArgs
