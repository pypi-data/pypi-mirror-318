...
class DrawableInstance:
    ...
    @property
    def TRANSFORM(self) -> aspose.cad.fileformats.glb.transforms.IGeometryTransform:
        '''Represents WHERE to draw the :py:attr:`aspose.cad.fileformats.glb.runtime.DrawableInstance.TEMPLATE`.'''
        ...
