...
class IGeometryInstancing:
    ...
    @property
    def world_transforms(self) -> List[aspose.cad.fileformats.glb.transforms.RigidTransform]:
        ...
...
class IGeometryTransform:
    ...
    def visible(self) -> bool:
        '''Gets a value indicating whether the current :py:class:`aspose.cad.fileformats.glb.transforms.IGeometryTransform` will render visible geometry.'''
        ...
...
class IMaterialTransform:
    
    ...

class InstancingTransform(RigidTransform):
    
    def update(self, morph_weights : Any, use_absolute_morph_targets : bool) -> None:
        ...
    
    def update_instances(self) -> List[aspose.cad.fileformats.glb.transforms.RigidTransform]:
        ...
    
    @staticmethod
    def evaluate(xform : aspose.cad.fileformats.glb.transforms.IGeometryTransform) -> Iterable[aspose.cad.fileformats.glb.transforms.IGeometryTransform]:
        ...
    ...
    @property
    def absolute_morph_targets(self) -> bool:
        ...
    
    @classmethod
    @property
    def COMPLEMENT_INDEX(cls) -> int:
        ...
...
class MorphTransform(IMaterialTransform):
...
class RigidTransform(MorphTransform):
...
class SkinnedTransform(MorphTransform):
    
    def update(self, morph_weights : Any, use_absolute_morph_targets : bool) -> None:
        ...
    
    @staticmethod
    def calculate_inverse_binding(mesh_world_transform : aspose.cad.fileformats.glb.transforms.Matrix4x4Double, joint_world_transform : aspose.cad.fileformats.glb.transforms.Matrix4x4Double) -> aspose.cad.fileformats.glb.transforms.Matrix4x4Double:
        ...
