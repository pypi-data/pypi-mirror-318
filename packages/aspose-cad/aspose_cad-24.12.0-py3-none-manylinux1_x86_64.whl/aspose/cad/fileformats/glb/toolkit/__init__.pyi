...
class Toolkit:
    ...
    @overload
    @staticmethod
    def with_vertex_accessors(primitive : aspose.cad.fileformats.glb.MeshPrimitive, vertices : List[aspose.cad.fileformats.glb.geometry.vertextypes.VertexPosition]) -> aspose.cad.fileformats.glb.MeshPrimitive:
        ...
    
    @overload
    @staticmethod
    def with_vertex_accessors(primitive : aspose.cad.fileformats.glb.MeshPrimitive, vertices : List[aspose.cad.fileformats.glb.geometry.vertextypes.VertexPositionNormal]) -> aspose.cad.fileformats.glb.MeshPrimitive:
        ...
    ...
    @staticmethod
    def get_vertex_columns(primitive : aspose.cad.fileformats.glb.MeshPrimitive) -> aspose.cad.fileformats.glb.geometry.VertexBufferColumns:
        ...
