...
class CloudIgniteAuthSDK:
    def __init__(self, api_key):
        self.base_url = "https://api.cloudignite.in"
    ...
    def add_user(self, project_id, email, password):
        """
        Add a new user to the project.
        """
        url = f"{self.base_url}/auth/api/v1/add_user"
        payload = {
    ...
    def login_user(self, project_id, email, password):
        """
        Login an existing user.
        """
        url = f"{self.base_url}/auth/api/v1/login"
        payload = {
            "projectId": project_id,
            "email": email,
            "password": password
    ...
    def list_users(self, project_id):
        ...
        """
        url = f"{self.base_url}/auth/api/v1/user_list"
