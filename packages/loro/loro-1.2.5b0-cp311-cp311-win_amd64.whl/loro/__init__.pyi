...
class LoroDoc:
    ...
    def export_json_updates(self, start_vv:VersionVector, end_vv:VersionVector) -> str:
        r"""
    ...
    def get_by_path(self, path:typing.Sequence[Index]) -> typing.Optional[ValueOrContainer]:
        r"""
    ...
    def get_path_to_container(self, id:ContainerID) -> typing.Optional[list[tuple[ContainerID, Index]]]:
        r"""
