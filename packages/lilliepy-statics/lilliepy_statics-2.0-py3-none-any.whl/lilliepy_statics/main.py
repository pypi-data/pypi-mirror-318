...
def use_Media(media_file, alt_text=""):
    """
    ReactPy component to handle image media files and return a relative path.
    ...
    relative_path = media_path.relative_to(_pathway.parent)
    
    return html.img({"src": f"/{relative_path}", "alt": alt_text})