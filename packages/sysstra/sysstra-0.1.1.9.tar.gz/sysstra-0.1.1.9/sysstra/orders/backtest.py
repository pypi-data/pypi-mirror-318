...
def place_bt_order(rdb_cursor, order_candle, option_type, strike_price, position_type, quantity, transaction_type, order_type, orders_list, exit_type=None, quantity_left=0, params=None, market_type="cash", trade_type=None, trigger_price=None, lot_size=25, user_id=None, strategy_id=None, request_id=None, exchange="NSE", option_params=None):
    ...
    try:
        ...
        if trigger_price:
            ...
            #     order_dict["trigger_price"] = order_candle["open"]
            # else:
            #     order_dict["trigger_price"] = order_candle["close"]
        ...
        print("***** bt_order : {}".format(order_dict))
