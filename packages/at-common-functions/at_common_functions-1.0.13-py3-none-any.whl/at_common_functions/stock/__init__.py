...
from at_common_functions.stock.impls.financial import list as _list_financials
from at_common_functions.stock.impls.financial import calc_metrics as _calc_financial_metrics
...
@export
async def calc_financial_metrics(*, symbol: str) -> dict:
    return await _calc_financial_metrics(symbol=symbol)
