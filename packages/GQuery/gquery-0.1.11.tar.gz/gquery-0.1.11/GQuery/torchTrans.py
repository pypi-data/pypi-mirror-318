...
class Transformer(torch.nn.Module):
    ...
    def fit(self,inputs,inputsType,mask0,outputs,outputsType,mask1,labels,opt,batch_size=32):
        ...
        for i in range(0,inputs.shape[0],batch_size):
            ...
            opt.zero_grad()
            output = self.predict_(inputs[i:i+batch_size],inputsType[i:i+batch_size],mask0[i:i+batch_size],outputs[i:i+batch_size],outputsType[i:i+batch_size],mask1[i:i+batch_size])
