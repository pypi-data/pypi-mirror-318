...
class Client(BaseHTTPClient):
    ...
    async def _request_user_by_username(self, username: str) -> Union[User, None]:
    ...
    async def request_user_by_username(self, username: str) -> Union[User, Account, None]:
        """
    ...
    async def _request_users_by_ids(
            self, user_ids: Iterable[Union[str, int]]
    ) -> dict[int: Union[User, Account]]:
    ...
    async def request_user_by_id(self, user_id: Union[str, int]) -> Union[User, Account, None]:
        """
    ...
    async def _follow_action(self, action: str, user_id: Union[str, int]) -> bool:
    ...
    async def follow(self, user_id: Union[str, int]) -> bool:
        return await self._follow_action("create", user_id)

    async def unfollow(self, user_id: Union[str, int]) -> bool:
    ...
    async def _repost(self, tweet_id: Union[str, int]) -> Tweet:
    ...
    async def delete_tweet(self, tweet_id: Union[str, int]) -> bool:
    ...
    async def pin_tweet(self, tweet_id: Union[str, int]) -> bool:
    ...
    async def _tweet(
            ...
            *,
            ...
            tweet_id_to_reply: Union[str, int] = None,
    ...
    async def vote(
            self, tweet_id: Union[str, int], card_id: Union[str, int], choice_number: int
    ) -> dict:
        """
    ...
    async def _request_tweet(self, tweet_id: Union[str, int]) -> Tweet:
    ...
    async def _request_tweets(
            self, user_id: Union[str, int], count: int = 20, cursor: str = None
    ) -> list[Tweet]:
    ...
    async def request_tweet(self, tweet_id: Union[str, int]) -> Tweet:
        return await self._request_tweet(tweet_id)

    async def request_tweets(
            self, user_id: Union[str, int] = None, count: int = 20, cursor: str = None
    ) -> list[Tweet]:
        if not user_id:
            if not self.account.id:
                await self.update_account_info()
    ...
    async def _update_profile_image(
            self, type: Literal["banner", "image"], media_id: Union[str, int]
    ) -> str:
        """
        :return: Image URL
        """
    ...
    async def update_profile_avatar(self, media_id: Union[str, int]) -> str:
        """
        :return: Image URL
        """
        return await self._update_profile_image("image", media_id)

    async def update_profile_banner(self, media_id: Union[str, int]) -> str:
        """
        :return: Image URL
        """
    ...
    async def send_message(self, user_id: Union[str, int], text: str) -> dict:
        """
        :return: Event data
        """
    ...
    async def send_message_to_conversation(
            self, conversation_id: Union[str, int], text: str
    ) -> dict:
        """
