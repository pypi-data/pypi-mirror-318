    ...
    while attempt < max_attempts:
        ...
        if instance["status"] == "RUNNING" and instance.get("ip"):
            ...
            try:
                ...
                # Now that we have SSH access, download the binary
                try:
                    remote_path = '/home/ubuntu/.thunder/libthunder.so'
                    
                    # Combine all commands into a single shell script that executes atomically
                    commands = [
                        ...
                        # Add verification that file exists and has correct permissions
                    ...
                    logger.info(f"Binary transfer completed. Output: {output}")
