...
1.  [32m|(A \circleright C)| = < {□}, ∅ >[0m  [32m(True in b.c)[0m
      [37m|A| = < {a}, {b.c} >[0m  [33m(False in b.c)[0m
      [36m|A|-alternatives to b.c = {a}[0m
        [37m|C| = < {a}, {b.c, c} >[0m  [33m(True in a)[0m

INTERPRETED CONCLUSION:

2.  [31m|((A \wedge B) \circleright C)| = < ∅, {□} >[0m  [31m(False in b.c)[0m
      [37m|(A \wedge B)| = < {a.b.c}, {a, a.b.c, b.c} >[0m  [33m(False in b.c)[0m
        [37m|A| = < {a}, {b.c} >[0m  [33m(False in b.c)[0m
        [37m|B| = < {b.c}, {a} >[0m  [33m(True in b.c)[0m
      [36m|(A \wedge B)|-alternatives to b.c = ∅[0m

Z3 run time: 0.0084 seconds
...
Z3 run time: 0.0094 seconds

Total run time: 11.8988 seconds

Run time: 0.0094 seconds
...
Z3 run time: 0.0086 seconds

Total run time: 4.7602 seconds
...
1.USE COLORS: False
  |(A \circleright C)| = < {□}, ∅ >  (True in b.c)
USE COLORS: False
      |A| = < {a}, {b.c} >  (False in b.c)
      [36m|A|-alternatives to b.c = {a}[0m
USE COLORS: False
        |C| = < {a}, {b.c, c} >  (True in a)
...
2.USE COLORS: False
  |((A \wedge B) \circleright C)| = < ∅, {□} >  (False in b.c)
USE COLORS: False
      |(A \wedge B)| = < {a.b.c}, {a, a.b.c, b.c} >  (False in b.c)
USE COLORS: False
        |A| = < {a}, {b.c} >  (False in b.c)
USE COLORS: False
        |B| = < {b.c}, {a} >  (True in b.c)
...
Z3 run time: 0.0083 seconds

Total run time: 2.7498 seconds

Run time: 0.0083 seconds
