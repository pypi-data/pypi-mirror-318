...
class Script(BaseDict, BaseSDK):
    ...
    def inner_fetch_multi(self, user_input: Any, variant: str, workspace: str = Undefined) -> list:
        """
        Fetches a list of entities based on user input, variant, and workspace.
    ...
    def fetch_multi(self, user_input: Any, variant: str, workspace: str = Undefined) -> list:
        """
        Fetches an entity based on user input, variant, and workspace.
        ...
        entity_list: list = self.inner_fetch_multi(user_input, variant, workspace)
