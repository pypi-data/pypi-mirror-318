...
REPO_URL="https://hasnainkk07:$GITHUB_TOKEN@github.com/hasnainkk07/hasnainkk-docs.git"
...
git config --local user.name "hasnainkk07"
git config --local user.email "hasnaindilshad13@gmail.com"
git add --all
