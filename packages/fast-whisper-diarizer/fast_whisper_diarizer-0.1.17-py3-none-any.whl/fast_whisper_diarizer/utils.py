...
def check_audio_for_speech(audio_file_path):
    ...
    # Debugging: Print the structure of vad_output
    print("VAD Output:", vad_output)

    # Adjust logic to handle vad_output correctly
    speech_detected = any(segment.get('label') == 'speech' for segment in vad_output)
