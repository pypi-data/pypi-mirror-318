...
If you use this directory in `path_deploy() <pywebio3.platform.path_deploy>`, you can access the PyWebIO application in
``b.py`` by using URL ``http://<host>:<port>/A/b``. And if the files have been modified after run
`path_deploy() <pywebio3.platform.path_deploy>`, you can use ``reload`` URL parameter to reload application in the file:
``http://<host>:<port>/A/b?reload``

You can also use the command ``pywebio3-path-deploy`` to start a server just like using
`path_deploy() <pywebio3.platform.path_deploy>`. For more information, refer ``pywebio3-path-deploy --help``

.. autofunction:: pywebio3.platform.path_deploy
.. autofunction:: pywebio3.platform.path_deploy_http
...
.. autofunction:: pywebio3.platform.tornado.start_server
.. autofunction:: pywebio3.platform.tornado.webio_handler

HTTP
'''''''''''''

.. autofunction:: pywebio3.platform.tornado_http.start_server
.. autofunction:: pywebio3.platform.tornado_http.webio_handler
...
.. autofunction:: pywebio3.platform.flask.webio_view
.. autofunction:: pywebio3.platform.flask.wsgi_app
.. autofunction:: pywebio3.platform.flask.start_server
...
.. autofunction:: pywebio3.platform.django.webio_view
.. autofunction:: pywebio3.platform.django.wsgi_app
.. autofunction:: pywebio3.platform.django.start_server
...
.. autofunction:: pywebio3.platform.aiohttp.webio_handler
.. autofunction:: pywebio3.platform.aiohttp.start_server
...
.. autofunction:: pywebio3.platform.fastapi.webio_routes
.. autofunction:: pywebio3.platform.fastapi.asgi_app
.. autofunction:: pywebio3.platform.fastapi.start_server

Other
--------------
.. autofunction:: pywebio3.config
.. autofunction:: pywebio3.platform.run_event_loop
...
try:
    from . import flask  # enable `pywebio3.platform.flask.xxx` expression without `import pywebio3.platform.flask`
except Exception:
    pass
