...
from chalk.features.resolver import (
    ...
    StateDescriptor,
    StreamResolver,
    parse_extract_function_object_captured_globals,
)
...
class ToProtoConverter:
        ...
        *,
        ...
        if definition is None and not should_skip_source_code_parsing():
            try:
                ...
                pass
        if captured_globals is None and not should_skip_source_code_parsing():
            try:
                captured_globals = parse_extract_function_object_captured_globals(fn)
            except:
                pass
    ...
    def create_captured_global(
        ...
        elif isinstance(captured_global, FunctionCapturedGlobalBuiltin):  # pyright: ignore[reportUnnecessaryIsInstance]
            return pb.FunctionReferenceCapturedGlobal(
