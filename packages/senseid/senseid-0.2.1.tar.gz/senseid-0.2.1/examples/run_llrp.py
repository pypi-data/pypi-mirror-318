...
connection_info = scanner.wait_for_reader_of_type(SupportedSenseidReader.SPEEDWAY_LLRP, timeout_s=5)

if connection_info is None:
    print('No reader found')
    exit()

connection_info.driver = SupportedSenseidReader.SPEEDWAY_LLRP
