...
def build_EA_model_ham(all_neigh_idx_sc, J_mean=0., J_std=1., random_type='Gaussian', p_positive=0.5, ham_kws={}):
...
if __name__ == '__main__':
    ...
    ham = build_EA_model_ham(all_neigh_idx_sc, random_type='bimodal', p_positive=0.8, ham_kws=ham_kws)

    # Example of building a Gaussian-random EA model with zero mean and unity variance
    ham = build_EA_model_ham(all_neigh_idx_sc, J_mean, J_std, random_type='Gaussian', ham_kws=ham_kws)
