...
def test_wavefunction_computation():
    ...
    test_output_sfsp_CS_matrix_2 = wn.psi_n_single_fock_single_position(2, 10.0)
    assert isinstance(test_output_sfsp_CS_matrix_2, float)

    test_output_sfsp_61 = wn.psi_n_single_fock_single_position(61, 10.0)
    assert isinstance(test_output_sfsp_61, float)

    test_output_sfsp_2 = wn.psi_n_single_fock_single_position(2, 10.0, CS_matrix = False)
    assert isinstance(test_output_sfsp_2, float)

    test_output_sfsp_61 = wn.psi_n_single_fock_single_position(61, 10.0, CS_matrix = False)
    assert isinstance(test_output_sfsp_61, float)
    ...
    assert isinstance(test_output_sfsp_c_CS_matrix_2, complex)
    ...
    test_output_sfsp_c_2 = wn.psi_n_single_fock_single_position_complex(2, 10.0 + 0.0j, CS_matrix = False)
    assert isinstance(test_output_sfsp_c_2, complex)

    test_output_sfsp_c_61 = wn.psi_n_single_fock_single_position_complex(61, 10.0 + 0.0j, CS_matrix = False)
    assert isinstance(test_output_sfsp_c_61, complex)
