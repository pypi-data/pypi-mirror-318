...
# python src/devocli/dummy.py omni.postbuild --json '{"executeMethod":"UnitySDKPostBuildProcessor.Run","sdk_params":"official-pc-10001","sdk_hosts": "osp-api-dev.omneegames.com", "sdk_token": "TRSbYcRYZWFWbdWHKNb6VQSuM8tJ45GkLXnkD6aM","quit":null,"batchmode":null,"projectPath":".","buildWindows64Player":"Build\\OmniPCUnity.exe","logFile":"Build/build.log","scenes":"Assets/Scenes/Launcher.unity"}'
