...
class UserStarGift(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        msg_id (``int`` ``32-bit``, *optional*):
            Only visible to the receiver of the gift, contains the ID of the messageService with the messageActionStarGift in the chat with from_id.

        convert_stars (``int`` ``64-bit``, *optional*):
            The receiver of this gift may convert it to this many Telegram Stars, instead of displaying it on their profile page.convert_stars will be equal to the buying price of the gift only if the gift was bought using recently bought Telegram Stars, otherwise it will be less than stars.
    ...
    __slots__: list[str] = ["date", "gift", "name_hidden", "unsaved", "refunded", "can_upgrade", "from_id", "message", "msg_id", "convert_stars", "upgrade_stars", "can_export_at", "transfer_stars"]

    ID = 0x325835e1
    QUALNAME = "types.UserStarGift"

    def __init__(self, *, date: int, gift: "raw.base.StarGift", name_hidden: Optional[bool] = None, unsaved: Optional[bool] = None, refunded: Optional[bool] = None, can_upgrade: Optional[bool] = None, from_id: Optional[int] = None, message: "raw.base.TextWithEntities" = None, msg_id: Optional[int] = None, convert_stars: Optional[int] = None, upgrade_stars: Optional[int] = None, can_export_at: Optional[int] = None, transfer_stars: Optional[int] = None) -> None:
        self.date = date  # int
    ...
    def read(b: BytesIO, *args: Any) -> "UserStarGift":
        ...
        return UserStarGift(date=date, gift=gift, name_hidden=name_hidden, unsaved=unsaved, refunded=refunded, can_upgrade=can_upgrade, from_id=from_id, message=message, msg_id=msg_id, convert_stars=convert_stars, upgrade_stars=upgrade_stars, can_export_at=can_export_at, transfer_stars=transfer_stars)
