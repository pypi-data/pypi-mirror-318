...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\7\r\b\17\t\21\n\23\13\3\2\4\6\2\62;C\\aac|\5\2\13\f\17")
        ...
        buf.write("\2\2\2%&\3\2\2\2&$\3\2\2\2&\'\3\2\2\2\'\22\3\2\2\2(*\t")
...
class logicLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "LPAREN", "RPAREN", "OR", "OR2", "XOR", "NOT", "AND", "INPUT", 
            "WHITESPACE" ]

    ruleNames = [ "LPAREN", "RPAREN", "OR", "OR2", "XOR", "NOT", "AND", 
                  "INPUT", "WHITESPACE" ]
