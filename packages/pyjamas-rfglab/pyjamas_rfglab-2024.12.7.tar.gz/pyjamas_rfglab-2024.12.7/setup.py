...
setuptools.setup(
    ...
    install_requires=["ipywidgets>=8.0.4",
                      ...
                      "shapely>=2.0.1",
                      "tensorflow==2.18.0",  # CPU versions above 2.13 will only work in processors with AVX instructions. This seems to be a problem running PyJAMAS under Windows in Parallel.
                     ],
