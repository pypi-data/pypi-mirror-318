...
"""
sagemaker-mlflow-skinny plugin installation.
"""
import os
...
setup(
    ...
    install_requires=["boto3>=1.34", "mlflow-skinny>=2.13.2", "pandas"],
    extras_require={"test": test_requirements, "test_prerelease": test_prerelease_requirements},
    python_requires=">= 3.8",
    entry_points={
        "mlflow.tracking_store": "arn=sagemaker_mlflow_skinny.mlflow_sagemaker_store:MlflowSageMakerStore",
        "mlflow.request_auth_provider": "arn=sagemaker_mlflow_skinny.auth_provider:AuthProvider",
        "mlflow.request_header_provider": "arn=sagemaker_mlflow_skinny.mlflow_sagemaker_request_header_provider:MlflowSageMakerRequestHeaderProvider",
        "mlflow.model_registry_store": "arn=sagemaker_mlflow_skinny.mlflow_sagemaker_registry_store:MlflowSageMakerRegistryStore"
    },
    version=read_version(),
    description="Skinny Version of AWS Plugin for MLflow with SageMaker",
