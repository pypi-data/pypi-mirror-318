...
# TODO: add ref to https://github.com/ClarkFieseln/audiocat/blob/main/audiocat_clark/audiocat.png
...
setup(
    ...
    data_files=[
        ...
        ('audiocat', ['audiocat_clark/killaudiocat.sh', 'audiocat_clark/mmack.sh', 'audiocat_clark/mmdata.sh', 'audiocat_clark/mmrx.sh', 'audiocat_clark/mmshellout.sh', 'audiocat_clark/mmtx.sh', 'audiocat_clark/mmtxfile.sh']),
