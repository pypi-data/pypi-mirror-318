...
class CustomAPITarget(PromptChatTarget):
    ...
    # API_URL = "https://webcha.azurewebsites.net/api/webcha_cognitive_azurefunc"

    def __init__(self, api_url: str, *, memory: MemoryInterface = None) -> None:
    ...
    async def send_prompt_async(self, *, prompt_request: PromptRequestResponse) -> PromptRequestResponse:
        ...
        payload = {
            "name": prompt_request.request_pieces[0].original_value
        }
