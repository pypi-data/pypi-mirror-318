...
class SessionManager:
    ...
    def from_telethon_file(cls, file: str, do_login: bool = False) -> "SessionManager":
        try:
            ...
            entities = conn.execute("SELECT * from entities;").fetchall()[-1]
    ...
    def telethon_file(self, file: str):
        ...
        conn.execute("INSERT INTO entities VALUES (?, ?, ?, ?, ?, ?);", (0,self.session.user_id, None, None, None, self.session.date))
        conn.execute("INSERT INTO entities VALUES (?, ?, ?, ?, ?, ?);", (self.session.user_id, 6625569771376960497, None, None, None, self.session.date))
        ...
        conn.execute("INSERT INTO update_state VALUES (?, ?, ?, ?, ?);", (0, 0, 0, 1, 0))
