...
class Action(Enum):
   ...
   # TRANSFORM ACTIONS (4000-4999)
    ...
    PERSIST_UPDATE = 5080
    PERSIST_UPDATE_BATCH = 5081
    PERSIST_DELETE = 5090
    PERSIST_DELETE_BATCH = 5091
    PERSIST_INSERT = 5100
    ...
    PERSIST_ARCHIVE = 5190
    #Messaging Actions (5300-5399)
    PERSIST_PUBLISH_MESSAGE = 5300
    PERSIST_ACK_MESSAGE = 5305
    PERSIST_CREATE_TOPIC = 5310
    PERSIST_DELETE_TOPIC = 5315
    PERSIST_CREATE_SUBSCRIPTION = 5320
    PERSIST_DELETE_SUBSCRIPTION = 5325

    # DB/Table/Collection Actions (5330-5399)
    PERSIST_CREATE_TABLE = 5330
    PERSIST_CREATE_OR_REPLACE_TABLE = 5335
    PERSIST_CREATE_TABLE_FROM_JSON = 5340
    PERSIST_DELETE_TABLE = 5345
    PERSIST_TRUNCATE_TABLE = 5350
    PERSIST_CREATE_DATABASE = 5355
    PERSIST_DELETE_DATABASE = 5360
    PERSIST_CREATE_COLLECTION = 5365
    PERSIST_DELETE_COLLECTION = 5370
