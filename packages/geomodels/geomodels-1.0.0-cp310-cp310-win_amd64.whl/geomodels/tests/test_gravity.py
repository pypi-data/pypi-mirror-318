...
from geomodels import GravityModel, get_default_data_path
...
class ComputationTestCase(unittest.TestCase):
    ...
    # $ echo 27.988055555555555 86.92555555555556 8820 | \
    # Gravity -n egm96 -p 13 -G
    # -0.0002103214548 0.0008380880427 -9.7665319359240
    # $ echo 27.988055555555555 86.92555555555556 8820 | \
    # Gravity -n egm96 -p 13 -D
    # -21.0321454784042 89.7584990506496 -199.4330543962868
    # echo 27.988055555555555 86.92555555555556 | \
    # Gravity -n egm96 -p 13 -H
    # -28.743736628353
    # $ echo 27.988055555555555 86.92555555555556 8820 | \
    # Gravity -n egm96 -p 13 -A
