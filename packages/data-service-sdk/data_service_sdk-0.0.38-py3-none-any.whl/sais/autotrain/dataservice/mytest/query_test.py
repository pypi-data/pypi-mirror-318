...
query_related = QueryStationRelatedHandler(endpoint="http://localhost:10115", auth_provider=EnvVarCredentialsProvider())
# result = query_related.execute_query_area(QueryAreaRequest(
#     type=0,  # 0: wind, 1: solar
#     provinces=['Guangdong'],
#     start_time='2022-01-31 16:00:00',
...
#
# query_related = query_related.execute_query_station(QueryStationRequest(
#     ids=["1001"],
#     # provinces=["Hainan"],
#     page=1,
#     page_size=100,
...
#     ndays=4,
#     hours=24,
#     coords=[{"req_lat": 21.86055600, "req_lon": 112.44555600}],
#     vars=[
#               "d2m",
#               "t2m",
#               "hcc",
