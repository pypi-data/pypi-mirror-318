...
# --------------- USER COMMANDS ---------------
    def generate_response(self, user_input, max_length=2000, throttle_delay=0, model=None, print_user=True, save_response=True, create_checkpoint=False, images: list[str]=None):
        """
