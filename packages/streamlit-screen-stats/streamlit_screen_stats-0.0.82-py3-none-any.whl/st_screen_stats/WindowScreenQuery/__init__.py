...
class WindowQuerySize:
    ...
    def mediaQuery(self, mediaMatchQ:str=None, on_change=None, default=None, args=None, kwargs=None, key=None, interval=0.1):
        """
        ...
        _st_window_query_size(mediaMatchQ=mediaMatchQ, on_change=on_change, args=args, kwargs=kwargs, key=key, default=default)
...
class WindowQueryHelper:
    ...
    def maximum_window_size(self, max_width:int=None, key="max_width_window", on_change=None, args=None, kwargs=None, default=None, interval=0.1):
    ...
    def window_range_width(self, min_width:int=None, max_width:int=None, key="max_width_window", on_change=None, args=None, kwargs=None, default=None, interval=0.1):
