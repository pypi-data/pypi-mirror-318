...
class ScreenData:
    ...
    def __init__(self, setTimeout:Union[int,float]=1000) -> None:
        """
            - setTimeout: amount of time for component to wait before sending traffic/data in ms default is 1000ms (1 sec).
        """
        self.setTimeout = setTimeout         
        
    def st_screen_data(self, on_change=None, args=None, kwargs=None, default=None, key="screen_stats"): 
        """
        ...
        component_value = _st_screen_data(setTime=self.setTimeout, key=key, on_change=on_change, args=args, kwargs=kwargs, default=default) 
