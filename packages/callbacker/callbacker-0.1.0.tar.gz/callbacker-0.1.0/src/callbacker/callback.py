...
from callbacker.signal import Signal
...
class SelfEventWrapper(EventWrapper):
    ...
    async def aio_send(self, *args, **kwargs) -> None:
        return await super().aio_send(self._owner, *args, **kwargs)

    def send(self, *args, **kwargs) -> None:
        return super().send(self._owner, *args, **kwargs)
