...
class AddressAdmin(admin.ModelAdmin):
    list_display = ("formatted", "address_line_1", "locality", "latitude", "longitude")
    search_fields = ("formatted", "address_line_1", "locality__name", "locality__state__name", "locality__state__country__name")
