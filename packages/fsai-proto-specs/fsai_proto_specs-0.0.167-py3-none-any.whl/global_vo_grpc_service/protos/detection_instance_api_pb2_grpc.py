...
class DetectionInstanceApiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateDetectionInstanceInBulk = channel.unary_unary(
                '/DetectionInstanceApi/UpdateDetectionInstanceInBulk',
                request_serializer=global__vo__grpc__service_dot_protos_dot_detection__instance__api__pb2.UpdateDetectionInstanceInBulkRequest.SerializeToString,
                response_deserializer=global__vo__grpc__service_dot_protos_dot_detection__instance__api__pb2.UpdateDetectionInstanceInBulkResponse.FromString,
                )
...
class DetectionInstanceApiServicer(object):
    ...
    def UpdateDetectionInstanceInBulk(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_DetectionInstanceApiServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateDetectionInstanceInBulk': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateDetectionInstanceInBulk,
                    request_deserializer=global__vo__grpc__service_dot_protos_dot_detection__instance__api__pb2.UpdateDetectionInstanceInBulkRequest.FromString,
                    response_serializer=global__vo__grpc__service_dot_protos_dot_detection__instance__api__pb2.UpdateDetectionInstanceInBulkResponse.SerializeToString,
            ),
...
class DetectionInstanceApi(object):
    ...
    @staticmethod
    def UpdateDetectionInstanceInBulk(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/DetectionInstanceApi/UpdateDetectionInstanceInBulk',
            global__vo__grpc__service_dot_protos_dot_detection__instance__api__pb2.UpdateDetectionInstanceInBulkRequest.SerializeToString,
            global__vo__grpc__service_dot_protos_dot_detection__instance__api__pb2.UpdateDetectionInstanceInBulkResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
