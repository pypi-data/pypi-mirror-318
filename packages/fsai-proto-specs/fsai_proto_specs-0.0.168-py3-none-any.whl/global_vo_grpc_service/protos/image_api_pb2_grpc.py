...
class ImageApiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.FindImageByName = channel.unary_unary(
                '/ImageApi/FindImageByName',
                request_serializer=global__vo__grpc__service_dot_protos_dot_image__api__pb2.FindImageByNameRequest.SerializeToString,
                response_deserializer=global__vo__grpc__service_dot_protos_dot_image__api__pb2.FindImageByNameResponse.FromString,
                )
...
def add_ImageApiServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'FindImageByName': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=global__vo__grpc__service_dot_protos_dot_image__api__pb2.FindImageByNameRequest.FromString,
                    response_serializer=global__vo__grpc__service_dot_protos_dot_image__api__pb2.FindImageByNameResponse.SerializeToString,
            ),
...
class ImageApi(object):
    ...
    def FindImageByName(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ImageApi/FindImageByName',
            global__vo__grpc__service_dot_protos_dot_image__api__pb2.FindImageByNameRequest.SerializeToString,
            global__vo__grpc__service_dot_protos_dot_image__api__pb2.FindImageByNameResponse.FromString,
