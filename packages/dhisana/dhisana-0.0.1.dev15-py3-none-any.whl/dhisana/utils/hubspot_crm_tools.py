...
def get_hubspot_access_token(tool_config):
    config_map = {
        item["name"]: item["value"]
        for item in (tool_config.get("configuration", []) if tool_config else [])
        if item
    }
    HUBSPOT_ACCESS_TOKEN = config_map.get("apiKey")
    if not HUBSPOT_ACCESS_TOKEN:
        raise ValueError("HubSpot access token not found in tool_config")
...
@assistant_tool
async def fetch_hubspot_lead_info(first_name: str = None, last_name: str = None, email: str = None, linkedin_url: str = None, phone_number: str = None, hubspot_id: str = None, tool_config=None):
    """
...
@assistant_tool
async def fetch_hubspot_contact_info(hubspot_id: str = None, email: str = None, tool_config=None):
    """
...
@assistant_tool
async def fetch_companies_in_crm(num: int = 250, list_name: str = None, tool_config=None):
    """
...
@assistant_tool
async def fetch_last_n_activities(email: str, num_events: int, tool_config=None):
    """
...
@assistant_tool
async def fetch_hubspot_list_records(list_id: str, max_entries_to_read: int = 2500, tool_config=None) -> List[Dict]:
    """
...
@assistant_tool
async def update_hubspot_contact_properties(contact_id: str, properties: dict, tool_config=None):
    """
...
@assistant_tool
async def update_hubspot_lead_properties(lead_id: str, properties: dict, tool_config=None):
    """
...
@assistant_tool
async def fetch_hubspot_company_info(company_id: str = None, name: str = None, domain: str = None, tool_config=None):
    """
...
@assistant_tool
async def update_hubspot_company_info(company_id: str = None, domain: str = None, city: str = None, state: str = None, number_of_employees: int = None, description: str = None, linkedin_company_page: str = None, annual_revenue: float = None, industry: str = None, tool_config=None):
    """
...
@assistant_tool
async def create_hubspot_note_for_customer(customer_id: str = None, email: str = None, note: str = None, tool_config=None):
    """
...
@assistant_tool
async def get_last_n_notes_for_customer(customer_id: str = None, email: str = None, n: int = 5, tool_config=None):
    """
...
async def fetch_hubspot_list_by_name(list_name: str, list_type: str = 'contacts', tool_config=None):
    """
...
@assistant_tool
async def list_all_crm_lists(payload=None, tool_config=None, list_type="contacts"):
    """
