...
async def get_company_info_from_builtwith_by_name(company_name: str):
    """
...
async def is_tech_used_in_company(
    company_domain: Optional[str] = None, company_name: Optional[str] = None, keyword: Optional[str] = None
) -> bool:
