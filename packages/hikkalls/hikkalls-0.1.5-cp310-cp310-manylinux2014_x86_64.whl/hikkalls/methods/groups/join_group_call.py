...
class JoinGroupCall(Scaffold):
    async def join_group_call(
        ...
        Parameters:
            ...
            stream (:obj:`~hikkalls.types.InputStream()`):
                Input Streams descriptor, can be used also
                :obj:`~hikkalls.types.AudioPiped()`,
                :obj:`~hikkalls.types.AudioImagePiped()`,
                :obj:`~hikkalls.types.AudioVideoPiped()` or
                :obj:`~hikkalls.types.VideoPiped()`
            ...
            stream_type (:obj:`~hikkalls.StreamType`, **optional**)
                The type of Stream
