...
"""
    "Get_ForwardDataList"
    "Get_ForwardSlopeDataList"
    "Get_BackwardDataList"
    "Get_BackwardSlopeDataList"
    Bu metodlar identify edilmis olup call edilebilirdir
    Ancak;
    Get_Commands() metodu call edildiğinde bu metodlar print edilmiyor.

    Set_Gamma fonksiyonu 2 kez identify edilmistir
