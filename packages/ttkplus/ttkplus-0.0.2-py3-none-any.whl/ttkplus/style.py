...
from ttkplus.themes.standard import STANDARD_THEMES
from ttkplus.publisher import Publisher, Channel
from ttkplus import utility as util
...
try:
    ...
    from ttkplus.themes.user import USER_THEMES
...
class Style(ttk.Style):
    ...
    ttkplus, this class is implemented as a singleton. Subclassing
    ...
    def _load_themes(self):
        """Load all ttkplus defined themes"""
...
class StyleBuilderTTK:
    ...
    def create_floodgauge_style(self, colorname=DEFAULT):
        """Create a ttk style for the ttkplus.widgets.Floodgauge
    ...
    def create_calendar_style(self, colorname=DEFAULT):
        ...
        ttkplus.dialogs.DatePickerPopup widget.
    ...
    def create_meter_label_style(self, colorname=DEFAULT):
        ...
        ttkplus.widgets.Meter widget. This style also stores some
...
class Bootstyle:
    ...
    def setup_ttkbootstap_api():
        """Setup ttkplus for use with tkinter and ttk. This method
        is called when ttkplus is imported to perform all of the
        necessary method overrides that implement the bootstyle api."""
        from ttkplus.widgets import TTK_WIDGETS
        from ttkplus.widgets import TK_WIDGETS
