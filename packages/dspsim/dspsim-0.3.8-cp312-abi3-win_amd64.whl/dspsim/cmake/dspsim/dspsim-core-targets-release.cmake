...
set_target_properties(dspsim::dspsim-core PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/dspsim/lib/dspsim-core.lib"
  )

list(APPEND _cmake_import_check_targets dspsim::dspsim-core )
list(APPEND _cmake_import_check_files_for_dspsim::dspsim-core "${_IMPORT_PREFIX}/dspsim/lib/dspsim-core.lib" )
