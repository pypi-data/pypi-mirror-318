...
PROJECT_KEYWORDS = 'git git-development-cli-tools'
PROJECT_LICENSE = 'Apache License 2.0'
PROJECT_MODULE = 'git_development_cli_tools'
PROJECT_NAME = 'git-development-cli-tools'
PROJECT_NAMESPACE = 'RadianDevCore/tools'
PROJECT_PACKAGE = 'git-development-cli-tools'
PROJECT_SCRIPTS = [
    'git-development-cli-tools = git_development_cli_tools.cli.main:main',
]
