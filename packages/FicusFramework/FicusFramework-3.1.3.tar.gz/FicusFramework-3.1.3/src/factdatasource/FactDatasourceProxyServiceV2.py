...
class FactDatasourceProxyV2(object):

    @abstractmethod
    def fd(self, site: str, project_code: str, fd_code: str):
        """
        返回fd对象
        :param site:
        :param project_code:
    ...
    @abstractmethod
    def size(self, site: str, project_code: str, fd_code: str):
        """
        返回数据总长度
        :param site:
        :param project_code:
    ...
    @abstractmethod
    def is_empty(self, site: str, project_code: str, fd_code: str):
        """
        返回是否存在数据
        :param site:
        :param project_code:
    ...
    @abstractmethod
    def collect(self, site: str, project_code: str, fd_code: str, offset: int, size: int, only_model_field: bool):
        """
        返回指定条数的数据
        :param site:
        :param project_code:
    ...
    @abstractmethod
    def collect_conditions(self, site: str, project_code: str, fd_code: str, offset: int, size: int,
                           condition_groups: list, only_model_field: bool):
        """
        返回指定查询条件的数据
        :param site:
        :param project_code:
    ...
    @abstractmethod
    def query(self, site: str, project_code: str, fd_code: str, query: str, parameters: dict):
        """
        使用查询语句查询数据
        :param site:
        :param project_code:
    ...
    @abstractmethod
    def query_data(self, site: str, project_code: str, fd_code: str, query: str, parameters: dict):
        """
        使用查询语句查询数据
        :param site:
        :param project_code:
    ...
    @abstractmethod
    def inserts(self, site: str, project_code: str, fd_code: str, result_list: list) -> list:
        """
    ...
    @abstractmethod
    def updates(self, site: str, project_code: str, fd_code: str, result_list: list) -> list:
        """
    ...
    @abstractmethod
    def save_or_updates(self, site: str, project_code: str, fd_code: str, result_list: list) -> list:
        """
    ...
    @abstractmethod
    def delete_all(self, site: str, project_code: str, fd_code: str):
        """
        清空数据
        :param site:
        :param project_code:
    ...
    @abstractmethod
    def delete(self, site: str, project_code: str, fd_code: str, query: str):
        """
    ...
    @abstractmethod
    def delete_conditions(self, site: str, project_code: str, fd_code: str, condition_groups: list):
        """
        根据删除条件,构造删除语句
        :param site:
        :param project_code:
...
class DistributedFactDatasourceProxyV2(FactDatasourceProxyV2, Singleton):
    """
    本地直接使用FD操作数据库的方式
    """
    ...
    def fd(self, site: str, project_code: str, fd_code: str):
        ...
        :return: FactDatasource
        """
        return self._get_fd_context(site, project_code, fd_code).fd()
    ...
    def size(self, site: str, project_code: str, fd_code: str):
        ...
        :return: 数据条数:long
        """
        fd_context = self._get_fd_context(site, project_code, fd_code)
    ...
    def collect(self, site: str, project_code: str, fd_code: str, offset: int, size: int,
                only_model_field: bool = False):
        """
        返回指定条数的数据
        :param site:
        :param project_code:
    ...
    def query(self, site: str, project_code: str, fd_code: str, query: str, parameters: dict):
        """
        被废弃,请使用 query_data,否则可能会遇到query-SQL超长的错误
        使用查询语句查询数据
        :param site:
        :param project_code:
        :param fd_code:
    ...
    def query_data(self, site: str, project_code: str, fd_code: str, query: str, parameters: dict):
        ...
        :return:
        """
        self.query(site, project_code, fd_code, query, parameters)
    ...
    def exists_fds(self, site: str, project_code: str, fd_codes: list) -> bool:
        ...
        return fd_service.exists_fds(site, project_code, fd_codes)

    def _get_fd_context(self, site: str, project_code: str, fd_code: str):
        fd_context: FactDatasourceContext = FactDatasourceContextHolder.instance().get_fact_datasource(site,
                                                                                                       project_code,
                                                                                                       fd_code)
        return fd_context
...
class CentralizedFactDatasourceProxyV2(FactDatasourceProxyV2, Singleton):
    """
    ...
    def size(self, site: str, project_code: str, fd_code: str):
        ...
        try:
            r = do_service(f"/remote/fd-service-v2/{site}/{project_code}/{fd_code}/size")
    ...
    def is_empty(self, site: str, project_code: str, fd_code: str):
        ...
        try:
            r = do_service(f"/remote/fd-service-v2/{site}/{project_code}/{fd_code}/empty")
    ...
    def collect(self, site: str, project_code: str, fd_code: str, offset: int, size: int,
        ...
        try:
            r = do_service(f"/remote/fd-service-v2/{site}/{project_code}/{fd_code}/all",
    ...
    def collect_conditions(self, site: str, project_code: str, fd_code: str, offset: int, size: int,
        ...
        try:
            r = do_service(f"/remote/fd-service-v2/{site}/{project_code}/{fd_code}/conditions", method="post",
    ...
    def query(self, site: str, project_code: str, fd_code: str, query: str, parameters: dict):
        """
        被废弃,请使用 query_data, 否则可能会遇到query-sql超长的问题
        对数据集进行查询
        :param site:
        :param project_code:
        :param fd_code: fd的唯一code
        ...
        try:
            r = do_service(f"/remote/fd-service-v2/{site}/{project_code}/{fd_code}/query", method="post",
                           data=parameters,
                           params={'query': query})
    ...
    def query_data(self, site: str, project_code: str, fd_code: str, query: str, parameters: dict):
        ...
        try:
            r = do_service(f"/remote/fd-service-v2/{site}/{project_code}/{fd_code}/queryData", method="post",
                           data=dict(query_parameter))
    ...
    def inserts(self, site: str, project_code: str, fd_code: str, result_list: list) -> list:
        ...
        try:
            r = do_service(f"/remote/fd-service-v2/{site}/{project_code}/{fd_code}", method="post", data=request,
                           return_type="json")
            if r is not None:
                if isinstance(r, list):
                    return [Munch(x) for x in r]
    ...
    def updates(self, site: str, project_code: str, fd_code: str, result_list: list) -> list:
        ...
        try:
            r = do_service(f"/remote/fd-service-v2/{site}/{project_code}/{fd_code}", method="put", data=request,
                           return_type="json")
            if r is not None:
                if isinstance(r, list):
                    return [Munch(x) for x in r]
    ...
    def save_or_updates(self, site: str, project_code: str, fd_code: str, result_list: list) -> list:
        ...
        try:
            r = do_service(f"/remote/fd-service-v2/{site}/{project_code}/{fd_code}/upsert", method="post", data=request,
                           return_type="json")
            if r is not None:
                if isinstance(r, list):
                    return [Munch(x) for x in r]
    ...
    def delete_all(self, site: str, project_code: str, fd_code: str):
        ...
        try:
            r = do_service(f"/remote/fd-service-v2/{site}/{project_code}/{fd_code}", method="delete",
                           return_type="None")
        except requests.exceptions.HTTPError as e:
            if e.response.status_code == 500:
                # 说明服务器端报错了
    ...
    def delete(self, site: str, project_code: str, fd_code: str, query: str):
        ...
        try:
            r = do_service(f"/remote/fd-service-v2/{site}/{project_code}/{fd_code}/query", method="delete",
                           params={'query': query},
                           return_type="None")
        except requests.exceptions.HTTPError as e:
            if e.response.status_code == 500:
    ...
    def delete_conditions(self, site: str, project_code: str, fd_code: str, condition_groups: list):
        ...
        try:
            r = do_service(f"/remote/fd-service-v2/{site}/{project_code}/{fd_code}/conditions", method="delete",
                           data=condition_groups,
                           return_type="None")
        except requests.exceptions.HTTPError as e:
            if e.response.status_code == 500:
    ...
    def exists_fds(self, site: str, project_code: str, fds):
        """
        判断fd是否存在
        :param site:
        :param project_code:
        ...
        try:
            r = do_service(f"/remote/fd-service-v2/{site}/{project_code}/exists", method="post", data=fds)
            if r is not None:
                return r
            else:
                return False
...
class FactDatasourceProxyFactoryV2(Singleton):
    __instance = None

    def get_fd_client_proxy(self, mode: bool = None) -> FactDatasourceProxyV2:
        if self.__instance:
        ...
        if mode:
            ...
            # 获取本地操作实例
            self.__instance = DistributedFactDatasourceProxyV2.instance()
        else:
            log.info("服务启动,使用中心模式FD服务")
            self.__instance = CentralizedFactDatasourceProxyV2.instance()
        return self.__instance


def fd_client_proxy() -> FactDatasourceProxyV2:
    return FactDatasourceProxyFactoryV2.instance().get_fd_client_proxy()
