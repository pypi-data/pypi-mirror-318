...
class TestProfiles:
    ...
    def test_method_create(self, client: Evrim) -> None:
        profile = client.prod.bulk.collections.profiles.create(
            collection_id=0,
            profile_ids=[0],
        )
    ...
    def test_raw_response_create(self, client: Evrim) -> None:
        response = client.prod.bulk.collections.profiles.with_raw_response.create(
            collection_id=0,
            profile_ids=[0],
        )
    ...
    def test_streaming_response_create(self, client: Evrim) -> None:
        with client.prod.bulk.collections.profiles.with_streaming_response.create(
            collection_id=0,
            profile_ids=[0],
        ) as response:
...
class TestAsyncProfiles:
    ...
    async def test_method_create(self, async_client: AsyncEvrim) -> None:
        profile = await async_client.prod.bulk.collections.profiles.create(
            collection_id=0,
            profile_ids=[0],
        )
        assert_matches_type(BulkProfilesToCollection, profile, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncEvrim) -> None:
        response = await async_client.prod.bulk.collections.profiles.with_raw_response.create(
            collection_id=0,
            profile_ids=[0],
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncEvrim) -> None:
        async with async_client.prod.bulk.collections.profiles.with_streaming_response.create(
            collection_id=0,
            profile_ids=[0],
        ) as response:
            assert not response.is_closed
