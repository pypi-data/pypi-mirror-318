...
from ..types import prompt_template_save_params, prompt_template_create_params
...
class PromptTemplatesResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            "/prod/v0/prompt-template/",
            body=maybe_transform({"prompt": prompt}, prompt_template_create_params.PromptTemplateCreateParams),
    ...
    def save(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"template": template}, prompt_template_save_params.PromptTemplateSaveParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
        ...
        *,
        ...
        return await self._post(
            ...
            body=await async_maybe_transform(
                {"prompt": prompt}, prompt_template_create_params.PromptTemplateCreateParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def save(
        ...
        *,
        ...
        return await self._post(
            "/prod/v0/prompt-template/save",
            body=await async_maybe_transform(
                {"template": template}, prompt_template_save_params.PromptTemplateSaveParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
