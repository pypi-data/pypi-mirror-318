...
class ProdResourceWithRawResponse:
    ...
    def blank(self) -> BlankResourceWithRawResponse:
        return BlankResourceWithRawResponse(self._prod.blank)

    @cached_property
    def bulk(self) -> BulkResourceWithRawResponse:
        return BulkResourceWithRawResponse(self._prod.bulk)

    @cached_property
    def prompt_templates(self) -> PromptTemplatesResourceWithRawResponse:
        return PromptTemplatesResourceWithRawResponse(self._prod.prompt_templates)
...
class AsyncProdResourceWithRawResponse:
    ...
    def blank(self) -> AsyncBlankResourceWithRawResponse:
        return AsyncBlankResourceWithRawResponse(self._prod.blank)

    @cached_property
    def bulk(self) -> AsyncBulkResourceWithRawResponse:
        return AsyncBulkResourceWithRawResponse(self._prod.bulk)

    @cached_property
    def prompt_templates(self) -> AsyncPromptTemplatesResourceWithRawResponse:
        return AsyncPromptTemplatesResourceWithRawResponse(self._prod.prompt_templates)
...
class ProdResourceWithStreamingResponse:
    ...
    def blank(self) -> BlankResourceWithStreamingResponse:
        return BlankResourceWithStreamingResponse(self._prod.blank)

    @cached_property
    def bulk(self) -> BulkResourceWithStreamingResponse:
        return BulkResourceWithStreamingResponse(self._prod.bulk)

    @cached_property
    def prompt_templates(self) -> PromptTemplatesResourceWithStreamingResponse:
        return PromptTemplatesResourceWithStreamingResponse(self._prod.prompt_templates)
...
class AsyncProdResourceWithStreamingResponse:
    ...
    def blank(self) -> AsyncBlankResourceWithStreamingResponse:
        return AsyncBlankResourceWithStreamingResponse(self._prod.blank)

    @cached_property
    def bulk(self) -> AsyncBulkResourceWithStreamingResponse:
        return AsyncBulkResourceWithStreamingResponse(self._prod.bulk)

    @cached_property
    def prompt_templates(self) -> AsyncPromptTemplatesResourceWithStreamingResponse:
        return AsyncPromptTemplatesResourceWithStreamingResponse(self._prod.prompt_templates)
