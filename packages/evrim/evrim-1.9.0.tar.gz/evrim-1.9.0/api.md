...
```python
from evrim.types.prod import Template
```

Methods:

- <code title="post /prod/v0/prompt-template/save/">client.prod.prompt_templates.<a href="./src/evrim/resources/prod/prompt_templates.py">save</a>(\*\*<a href="src/evrim/types/prod/prompt_template_save_params.py">params</a>) -> <a href="./src/evrim/types/template.py">Template</a></code>
...
```python
from evrim.types import PromptTemplateCreateResponse
```

Methods:

- <code title="post /prod/v0/prompt-template/">client.prompt_templates.<a href="./src/evrim/resources/prompt_templates.py">create</a>(\*\*<a href="src/evrim/types/prompt_template_create_params.py">params</a>) -> <a href="./src/evrim/types/prompt_template_create_response.py">PromptTemplateCreateResponse</a></code>
