...
class TestCreatedFields:
    ...
    def test_method_create(self, client: Evrim) -> None:
        created_field = client.prod.bulk.created_fields.create(
            create_fields=[
                {
    ...
    def test_raw_response_create(self, client: Evrim) -> None:
        response = client.prod.bulk.created_fields.with_raw_response.create(
            create_fields=[
                {
                    "description": "description",
                    "name": "name",
    ...
    def test_streaming_response_create(self, client: Evrim) -> None:
        with client.prod.bulk.created_fields.with_streaming_response.create(
            create_fields=[
                {
                    "description": "description",
                    "name": "name",
    ...
    def test_method_retrieve(self, client: Evrim) -> None:
        created_field = client.prod.bulk.created_fields.retrieve(
            0,
        )
        assert_matches_type(BulkCreatedField, created_field, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: Evrim) -> None:
        response = client.prod.bulk.created_fields.with_raw_response.retrieve(
            0,
        )
    ...
    def test_streaming_response_retrieve(self, client: Evrim) -> None:
        with client.prod.bulk.created_fields.with_streaming_response.retrieve(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_list(self, client: Evrim) -> None:
        created_field = client.prod.bulk.created_fields.list()
    ...
    def test_raw_response_list(self, client: Evrim) -> None:
        response = client.prod.bulk.created_fields.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Evrim) -> None:
        with client.prod.bulk.created_fields.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncCreatedFields:
    ...
    async def test_method_create(self, async_client: AsyncEvrim) -> None:
        created_field = await async_client.prod.bulk.created_fields.create(
            create_fields=[
                {
                    "description": "description",
                    "name": "name",
    ...
    async def test_raw_response_create(self, async_client: AsyncEvrim) -> None:
        response = await async_client.prod.bulk.created_fields.with_raw_response.create(
            create_fields=[
                {
                    "description": "description",
                    "name": "name",
    ...
    async def test_streaming_response_create(self, async_client: AsyncEvrim) -> None:
        async with async_client.prod.bulk.created_fields.with_streaming_response.create(
            create_fields=[
                {
                    "description": "description",
                    "name": "name",
    ...
    async def test_method_retrieve(self, async_client: AsyncEvrim) -> None:
        created_field = await async_client.prod.bulk.created_fields.retrieve(
            0,
        )
        assert_matches_type(BulkCreatedField, created_field, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncEvrim) -> None:
        response = await async_client.prod.bulk.created_fields.with_raw_response.retrieve(
            0,
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncEvrim) -> None:
        async with async_client.prod.bulk.created_fields.with_streaming_response.retrieve(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list(self, async_client: AsyncEvrim) -> None:
        created_field = await async_client.prod.bulk.created_fields.list()
        assert_matches_type(CreatedFieldListResponse, created_field, path=["response"])

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncEvrim) -> None:
        response = await async_client.prod.bulk.created_fields.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncEvrim) -> None:
        async with async_client.prod.bulk.created_fields.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
