...
class TestProfiles:
    ...
    def test_method_create(self, client: Evrim) -> None:
        profile = client.prod.bulk.templates.profiles.create(
    ...
    def test_raw_response_create(self, client: Evrim) -> None:
        response = client.prod.bulk.templates.profiles.with_raw_response.create(
            specifications=["string"],
            template_id=0,
        )
    ...
    def test_streaming_response_create(self, client: Evrim) -> None:
        with client.prod.bulk.templates.profiles.with_streaming_response.create(
            specifications=["string"],
            template_id=0,
        ) as response:
    ...
    def test_method_retrieve(self, client: Evrim) -> None:
        profile = client.prod.bulk.templates.profiles.retrieve(
            0,
        )
        assert_matches_type(BulkJob, profile, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: Evrim) -> None:
        response = client.prod.bulk.templates.profiles.with_raw_response.retrieve(
            0,
        )
    ...
    def test_streaming_response_retrieve(self, client: Evrim) -> None:
        with client.prod.bulk.templates.profiles.with_streaming_response.retrieve(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_list(self, client: Evrim) -> None:
        profile = client.prod.bulk.templates.profiles.list()
        assert_matches_type(ProfileListResponse, profile, path=["response"])

    @parametrize
    def test_raw_response_list(self, client: Evrim) -> None:
        response = client.prod.bulk.templates.profiles.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Evrim) -> None:
        with client.prod.bulk.templates.profiles.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncProfiles:
    ...
    async def test_method_create(self, async_client: AsyncEvrim) -> None:
        profile = await async_client.prod.bulk.templates.profiles.create(
            specifications=["string"],
            template_id=0,
        )
        assert_matches_type(BulkJob, profile, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncEvrim) -> None:
        response = await async_client.prod.bulk.templates.profiles.with_raw_response.create(
            specifications=["string"],
            template_id=0,
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncEvrim) -> None:
        async with async_client.prod.bulk.templates.profiles.with_streaming_response.create(
            specifications=["string"],
            template_id=0,
        ) as response:
            assert not response.is_closed
    ...
    async def test_method_retrieve(self, async_client: AsyncEvrim) -> None:
        profile = await async_client.prod.bulk.templates.profiles.retrieve(
            0,
        )
        assert_matches_type(BulkJob, profile, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncEvrim) -> None:
        response = await async_client.prod.bulk.templates.profiles.with_raw_response.retrieve(
            0,
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncEvrim) -> None:
        async with async_client.prod.bulk.templates.profiles.with_streaming_response.retrieve(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list(self, async_client: AsyncEvrim) -> None:
        profile = await async_client.prod.bulk.templates.profiles.list()
        assert_matches_type(ProfileListResponse, profile, path=["response"])

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncEvrim) -> None:
        response = await async_client.prod.bulk.templates.profiles.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncEvrim) -> None:
        async with async_client.prod.bulk.templates.profiles.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
