...
class Ui_PresetDockRando(object):
    ...
    def retranslateUi(self, PresetDockRando):
        ...
        self.two_sided_door_search_label.setText(QCoreApplication.translate("PresetDockRando", u"<html><head/><body><p>When using type Doors, enables the use of a revised algorithm for deciding what doors can be.</p></body></html>", None))
