...
def define_search_paths() -> None:
    ...
    utils.os_default_paths = {
        "Windows": [
            utils.utils.os_path("C:\\Windows\\System32"),
            utils.utils.os_path("C:\\Windows\\System32\\wbem")
        ],
        "Linux": [
            utils.utils.os_path("/lib"),
            utils.utils.os_path("/usr/lib"),
            utils.utils.os_path("/usr/local/lib")
        ],
        "Darwin": [
            utils.utils.os_path("/lib"),
            utils.utils.os_path("/usr/lib"),
            utils.utils.os_path("/usr/local/lib"),
            utils.utils.os_path("/opt/homebrew/lib")  # Homebrew on ARM macutils.OS
        ]
    }
