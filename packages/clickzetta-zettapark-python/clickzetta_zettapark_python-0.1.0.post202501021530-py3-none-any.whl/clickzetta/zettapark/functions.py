...
@overload
def datediff(timeunit: str, col1: ColumnOrName, col2: ColumnOrName) -> Column:
    ...  # pragma: no cover


@overload
def datediff(col1: ColumnOrName, col2: ColumnOrName) -> Column:
    ...  # pragma: no cover
...
def is_binary(col: ColumnOrName) -> Column:
    ...
    Examples::
        ...
        >>> from clickzetta.zettapark.types import StructField, VariantType
        >>> df = session.create_dataframe([[b"alice", "alice"]], schema=["a", "b"])
...
def is_object(col: ColumnOrName) -> Column:
    ...
    Example::
        ...
        >>> df = session.create_dataframe([[[1, 2], {"a": "alice"}]], schema=["a", "b"])
