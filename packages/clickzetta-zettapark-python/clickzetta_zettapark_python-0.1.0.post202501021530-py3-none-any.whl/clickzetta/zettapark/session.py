...
from clickzetta.zettapark.functions import col, column, lit
...
"os.name" : {get_os_name()}
"""
        self._session_volume = random_name_for_temp_object(TempObjectType.VOLUME)
    ...
    def create_dataframe(
        ...
        Note:
            ...
            requires permission to (1) CREATE VOLUME (2) CREATE TABLE and (3) CREATE FILE FORMAT under the current
            database and schema.
        """
        if data is None:
