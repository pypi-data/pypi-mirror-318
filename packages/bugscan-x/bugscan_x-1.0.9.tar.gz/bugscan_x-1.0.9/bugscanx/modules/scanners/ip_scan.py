...
from colorama import Fore, Style as colorama_style
...
def perform2_scan(hosts, ports, output_file, threads, method):
    ...
    headers = (Fore.GREEN + "Code  " + Fore.CYAN + "Server               " +
               Fore.YELLOW + "Port   " + Fore.LIGHTBLUE_EX + "Host" + colorama_style.RESET_ALL)
    separator = "----  ----------------   ----  -------------------------"
    ...
    print(f" Results saved to {output_file}.{colorama_style.RESET_ALL}")
