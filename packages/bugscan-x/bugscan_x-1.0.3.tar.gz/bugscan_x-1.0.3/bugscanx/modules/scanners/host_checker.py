...
from bugscanx.modules.utils import get_input, create_prompt, file_path_validator, digit_validator, not_empty_validator, completer
...
def main():
	...
	scanner.threads = int(user_input['threads'])  # Ensure threads is an integer
	scanner.start()
