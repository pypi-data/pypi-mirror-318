...
def generator_sql_switcher(sql_keys:dict)->str:
    ...
    'generator_dependencies_null_value_ratio':generator_dependencies_null_value_ratio,
...
def generator_dependencies_null_value_ratio(conf_dict:dict) -> str:
# 输入 conf_dict:{dep_dbtab:"";part_name:"";part_var:"";fields_code-0:'',fields_code-1:''}
# 输出 测试SQL生成-空值率
    sql_content='''---- welcome hugsql ----\n
select 
