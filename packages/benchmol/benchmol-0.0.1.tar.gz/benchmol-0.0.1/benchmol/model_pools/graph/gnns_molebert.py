...
class GNN(torch.nn.Module):
    ...
    def __init__(self, num_layer, emb_dim, JK="last", drop_ratio=0, gnn_type="gin", need_x_embedding=True):
        super(GNN, self).__init__()
        self.num_layer = num_layer
        self.drop_ratio = drop_ratio
        self.JK = JK
        self.need_x_embedding = need_x_embedding
...
if __name__ == "__main__":
    student_backbone = GNN_graphpred(num_layer=5, emb_dim=300, JK="last", drop_ratio=0.5, gnn_type="gin", num_tasks=1)
    student_backbone.from_pretrained(
        "D:/xianghongxin/work/projects/MultiViewMolKD/distillation/pretrained-gnns/Mole-BERT.pth")