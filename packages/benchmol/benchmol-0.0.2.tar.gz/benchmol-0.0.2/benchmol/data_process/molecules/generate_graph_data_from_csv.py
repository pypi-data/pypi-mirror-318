...
from benchmol.data_process.molecules.graph_helpers.mol2graph import create_graph_from_smiles
...
if __name__ == '__main__':
    ...
    parser.add_argument('--graph_feat_extractor', type=str, default="ogb", choices=["ogb", "jure", "geom3d"], help='')
    ...
    for dataset in datasets:
        ...
        if args.label_column == "label":
            save_path = f"{processed_saveroot}/geometric_data_processed_{args.graph_feat_extractor}_format.pt"
        else:
            save_path = f"{processed_saveroot}/geometric_data_processed_{args.label_column}_{args.graph_feat_extractor}_format.pt"
