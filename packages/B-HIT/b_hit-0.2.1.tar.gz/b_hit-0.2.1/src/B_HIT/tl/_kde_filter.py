...
def kde_filter(adata_tmp,
    ...
    Steps
    -----
    1. Prepare spatial coordinates and compute bin assignments.
    2. Fit a KDE model to the spatial data with scores as weights and compute density.
    3. Filter spatial locations based on a density threshold and retain valid coordinates.

    Example
    -------
    >>> filtered_adata = kde_filter(adata_tmp, score_name='expression_score', high_binSize=100)
    """
