...
- Install: `pip install Knorket-TrustMesh`
...
`Knorket-TrustMesh {paste JWT here}` OR `Knorket-TrustMesh --jwt enrollment.txt`
...
`Knorket-TrustMesh --jwt enrollment.txt --assumePublic`
...
`Knorket-TrustMesh --jwt enrollment.txt --autoTunnelListener`
