...
from openai_tools import OpenAIT
...
@client.add_tool(
    {
        "description": "Get the weather, sunset, sunraise, time and other data about current city",
        "parameters": {
            "type": "object",
            "properties": {
                "city": {"type": "string", "description": "City name on english"},
            },
            "required": ["city"],
        },
    }
