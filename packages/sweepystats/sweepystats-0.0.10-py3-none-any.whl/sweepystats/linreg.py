...
class LinearRegression:
    ...
    # def t_test(self):
    #     """
    #     Get the (2-tailed) t-test statistic and associated p-values for the 
    #     variables that are currently swept in the model. 
    #     """
    #     t_stats = self.coef() / self.coef_std()
    #     df = self.n - self.p - 1
    #     pvals = []
    #     for t_stat in t_stats:
    #         pvals.append(2 * t.sf(abs(t_stat), df))
