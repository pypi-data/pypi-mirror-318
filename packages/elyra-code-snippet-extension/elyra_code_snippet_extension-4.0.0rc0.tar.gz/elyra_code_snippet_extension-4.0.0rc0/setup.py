...
long_desc = "'The Code Snippet editor extension adds support for reusable code fragments, making programming in JupyterLab more efficient by reducing repetitive work. See https://elyra.readthedocs.io/en/v4.0.0rc0/user_guide/code-snippets.html'"
