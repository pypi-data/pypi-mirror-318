...
class OptimizeStateResponseAllOf(BaseModel):
    ...
    __properties = ["config", "status", "tunerJobId", "tunerCoordinatorJobId", "continuationJobId", "tuningAlgorithm", "tunerJobIsRunning", "trials", "projectDataType", "jobError", "workers", "nextRunIndex", "isWhitelabel"]
