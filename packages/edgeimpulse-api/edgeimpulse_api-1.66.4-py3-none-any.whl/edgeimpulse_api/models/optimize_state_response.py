...
class OptimizeStateResponse(BaseModel):
    ...
    __properties = ["success", "error", "config", "status", "tunerJobId", "tunerCoordinatorJobId", "continuationJobId", "tuningAlgorithm", "tunerJobIsRunning", "trials", "projectDataType", "jobError", "workers", "nextRunIndex", "isWhitelabel"]
