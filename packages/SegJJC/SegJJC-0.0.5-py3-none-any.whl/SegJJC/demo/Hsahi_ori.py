...
class HSAHI_det:
    def __init__(self, yaml_path=None,slice_height=256, slice_width=256, overlap_height_ratio=0.25, overlap_width_ratio=0.25):
        ...
        self.slice_regions = []
    def calculate_slice_regions(self, image_height, image_width):
        self.slice_regions = []
...
###获取切图区域内的标注框####
    ...
    def process_imgs(self, image_paths, output_dir):
        ...
        for image_path in image_paths:
            ...
            with Image.open(image_path) as img:
                ...
                self.calculate_slice_regions(image_height=height, image_width=width)
    ...
    def process_data(self):
        ...
        # 获取上两层路径
        parent_dir = os.path.dirname(os.path.dirname(self.yaml_path))
