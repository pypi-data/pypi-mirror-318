...
def sta_dataset_read(name: str) -> DataFrame:
    """
    ...
    >>> df = stm.sta_dataset_read(name='cotes_n8')
    >>> df
              x         y
    0  0.000000  0.200000
    1  0.114286  1.306741
    ...
    >>> sales = stm.sta_dataset_read(name='sales')
    >>> sales
...
def sta_datasets_show(details=True):
    """
    ...
    --------
    >>> import stemlab as stm
    >>> data = stm.sta_datasets_show()
    >>> data
    (DataFrame output omitted)
    >>> data = stm.sta_datasets_show(details=False)
    >>> data
    (list output omitted)
    """
