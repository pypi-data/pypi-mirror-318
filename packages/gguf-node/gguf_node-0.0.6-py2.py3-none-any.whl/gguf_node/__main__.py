...
if __name__ == "__main__":
    ...
    if choice=="1":
        # method#1: download the full pack (no installation needed way)
        ...
        # method#2: clone the repo to custom_nodes only (developer option)
        repo_url = "https://github.com/calcuis/gguf"
        clone_github_repo(repo_url)
    elif choice=="3":
        # method#3: pretend to be an expert (idiot mode)
