...
import Botify
from Botify.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~Botify.Client.start`, :meth:`~Botify.idle` and :meth:`~Botify.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`Botify.compose`.
