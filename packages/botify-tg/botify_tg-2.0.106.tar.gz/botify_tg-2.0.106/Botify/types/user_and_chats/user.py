...
import Botify
from Botify import enums, utils
...
class User(Object, Update):
    ...
    Parameters:
        ...
        status (:obj:`~Botify.enums.UserStatus`, *optional*):
            User's last seen & online status. ``None``, for bots.

        last_online_date (:py:obj:`~datetime.datetime`, *optional*):
            Last online date of a user. Only available in case status is :obj:`~Botify.enums.UserStatus.OFFLINE`.

        next_offline_date (:py:obj:`~datetime.datetime`, *optional*):
            Date when a user will automatically go offline. Only available in case status is :obj:`~Botify.enums.UserStatus.ONLINE`.
        ...
        emoji_status (:obj:`~Botify.types.EmojiStatus`, *optional*):
            Emoji status.
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~Botify.types.User`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~Botify.types.User`.
    ...
    def block(self):
        """Bound method *block* of :obj:`~Botify.types.User`.
    ...
    def unblock(self):
        """Bound method *unblock* of :obj:`~Botify.types.User`.
    ...
    def get_common_chats(self):
        """Bound method *get_common_chats* of :obj:`~Botify.types.User`.
