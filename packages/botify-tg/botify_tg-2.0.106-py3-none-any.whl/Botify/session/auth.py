...
from Botify.crypto import aes, rsa, prime
from Botify.errors import SecurityCheckMismatch
from Botify.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "Botify.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
