...
from Botify.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "Botify.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~Botify.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~Botify.handlers.MessageHandler` the *update* argument will be a :obj:`~Botify.types.Message`; in a :obj:`~Botify.handlers.CallbackQueryHandler` the *update* will be a :obj:`~Botify.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~Botify.filters.command` or :meth:`~Botify.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~Botify.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~Botify.types.Document` objects."""
...
"""Filter messages that contain :obj:`~Botify.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~Botify.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~Botify.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~Botify.types.Game` objects."""
...
"""Filter messages that contain :obj:`~Botify.types.Video` objects."""
...
"""Filter messages that contain :obj:`~Botify.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~Botify.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~Botify.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~Botify.types.Location` objects."""
...
"""Filter messages that contain :obj:`~Botify.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~Botify.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~Botify.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~Botify.types.Message`.
    ...
    async def func(flt, client: Botify.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~Botify.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~Botify.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~Botify.types.InlineQuery`: The filter will match ``query``.
