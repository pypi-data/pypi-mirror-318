...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~Botify.types.InputMediaPhoto`, :obj:`~Botify.types.InputMediaVideo`, :obj:`~Botify.types.InputMediaAudio` and :obj:`~Botify.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~Botify.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from Botify.types import InputMediaPhoto, InputMediaVideo
