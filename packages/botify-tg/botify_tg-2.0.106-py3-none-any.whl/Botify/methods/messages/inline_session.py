...
from Botify.errors import AuthBytesInvalid
from Botify.session import Session
from Botify.session.auth import Auth


async def get_session(client: "Botify.Client", dc_id: int):
