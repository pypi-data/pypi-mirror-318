...
import Botify
from Botify import StopTransmission, enums
from Botify import raw
from Botify import types
from Botify import utils
from Botify.errors import FilePartMissing
from Botify.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~Botify.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~Botify.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~Botify.Client.stop_transmission`, None is returned.
