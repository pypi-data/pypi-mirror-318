...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~Botify.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~Botify.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~Botify.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "Botify". Get the first 50 results
                async for message in app.search_global("Botify", limit=50):
                    print(message.text)
