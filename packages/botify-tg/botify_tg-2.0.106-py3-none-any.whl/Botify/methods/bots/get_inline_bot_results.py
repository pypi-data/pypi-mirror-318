...
from Botify.errors import UnknownError
...
class GetInlineBotResults:
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~Botify.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <Botify.api.types.messages.BotResults>`: On Success.
