...
import Botify
from Botify import __version__, __license__
from Botify import enums
from Botify import raw
from Botify import utils
from Botify.crypto import aes
from Botify.errors import CDNFileHashMismatch
from Botify.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from Botify.handlers.handler import Handler
from Botify.methods import Methods
from Botify.session import Auth, Session
from Botify.storage import FileStorage, MemoryStorage
from Botify.types import User, TermsOfService
from Botify.utils import ainput
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~Botify.Client.export_session_string` before stopping the client to get a session string you can
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~Botify.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.Botify.org/start/auth")
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except Botify.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
