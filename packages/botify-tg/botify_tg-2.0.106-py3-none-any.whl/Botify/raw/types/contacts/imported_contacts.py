...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <Botify.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <Botify.raw.base.PopularContact>`):
            N/A
