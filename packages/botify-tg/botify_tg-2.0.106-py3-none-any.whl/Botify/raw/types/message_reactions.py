...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <Botify.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <Botify.raw.base.MessagePeerReaction>`, *optional*):
            N/A
