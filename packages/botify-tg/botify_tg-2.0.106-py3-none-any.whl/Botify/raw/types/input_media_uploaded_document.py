...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.InputMedia`.
    ...
    Parameters:
        file (:obj:`InputFile <Botify.raw.base.InputFile>`):
            N/A

        mime_type (``str``):
            N/A

        attributes (List of :obj:`DocumentAttribute <Botify.raw.base.DocumentAttribute>`):
            N/A
        ...
        thumb (:obj:`InputFile <Botify.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <Botify.raw.base.InputDocument>`, *optional*):
            N/A
