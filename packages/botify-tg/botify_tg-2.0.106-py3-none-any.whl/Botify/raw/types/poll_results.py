...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <Botify.raw.base.PollAnswerVoters>`, *optional*):
            N/A
        ...
        solution_entities (List of :obj:`MessageEntity <Botify.raw.base.MessageEntity>`, *optional*):
            N/A
