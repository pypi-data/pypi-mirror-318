...
class ChannelAdminLogEventActionParticipantToggleAdmin(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.ChannelAdminLogEventAction`.
    ...
    Parameters:
        prev_participant (:obj:`ChannelParticipant <Botify.raw.base.ChannelParticipant>`):
            N/A

        new_participant (:obj:`ChannelParticipant <Botify.raw.base.ChannelParticipant>`):
            N/A
