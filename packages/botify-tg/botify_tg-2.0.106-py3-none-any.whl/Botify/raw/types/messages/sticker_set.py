...
class StickerSet(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.messages.StickerSet`.
    ...
    Parameters:
        set (:obj:`StickerSet <Botify.raw.base.StickerSet>`):
            N/A

        packs (List of :obj:`StickerPack <Botify.raw.base.StickerPack>`):
            N/A

        keywords (List of :obj:`StickerKeyword <Botify.raw.base.StickerKeyword>`):
            N/A

        documents (List of :obj:`Document <Botify.raw.base.Document>`):
            N/A
