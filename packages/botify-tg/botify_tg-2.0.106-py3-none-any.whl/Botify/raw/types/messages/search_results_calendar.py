...
class SearchResultsCalendar(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.messages.SearchResultsCalendar`.
    ...
    Parameters:
        ...
        periods (List of :obj:`SearchResultsCalendarPeriod <Botify.raw.base.SearchResultsCalendarPeriod>`):
            N/A
