...
class PeerDialogs(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs (List of :obj:`Dialog <Botify.raw.base.Dialog>`):
            N/A

        messages (List of :obj:`Message <Botify.raw.base.Message>`):
            N/A
