...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <Botify.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <Botify.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <Botify.raw.base.InlineBotWebView>`, *optional*):
            N/A
