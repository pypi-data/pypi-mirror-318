...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <Botify.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <Botify.raw.base.Reaction>`, *optional*):
            N/A
