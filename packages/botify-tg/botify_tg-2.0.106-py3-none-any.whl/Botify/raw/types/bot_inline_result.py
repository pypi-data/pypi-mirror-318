...
class BotInlineResult(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.BotInlineResult`.
    ...
    Parameters:
        ...
        send_message (:obj:`BotInlineMessage <Botify.raw.base.BotInlineMessage>`):
            N/A
        ...
        thumb (:obj:`WebDocument <Botify.raw.base.WebDocument>`, *optional*):
            N/A

        content (:obj:`WebDocument <Botify.raw.base.WebDocument>`, *optional*):
            N/A
