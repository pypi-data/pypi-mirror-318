...
class AppUpdate(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.help.AppUpdate`.
    ...
    Parameters:
        ...
        entities (List of :obj:`MessageEntity <Botify.raw.base.MessageEntity>`):
            N/A
        ...
        sticker (:obj:`Document <Botify.raw.base.Document>`, *optional*):
            N/A
