...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <Botify.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <Botify.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <Botify.raw.base.PremiumSubscriptionOption>`):
            N/A
