...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <Botify.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <Botify.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <Botify.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <Botify.raw.base.updates.State>`):
            N/A
