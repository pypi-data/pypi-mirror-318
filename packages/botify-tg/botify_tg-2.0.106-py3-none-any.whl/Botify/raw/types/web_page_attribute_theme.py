...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <Botify.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <Botify.raw.base.ThemeSettings>`, *optional*):
            N/A
