...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <Botify.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <Botify.raw.base.auth.CodeType>`, *optional*):
            N/A
