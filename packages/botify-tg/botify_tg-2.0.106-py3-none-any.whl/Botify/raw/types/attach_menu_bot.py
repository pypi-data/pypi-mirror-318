...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.AttachMenuBot`.
    ...
    Parameters:
        ...
        peer_types (List of :obj:`AttachMenuPeerType <Botify.raw.base.AttachMenuPeerType>`):
            N/A

        icons (List of :obj:`AttachMenuBotIcon <Botify.raw.base.AttachMenuBotIcon>`):
            N/A
