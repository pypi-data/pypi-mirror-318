...
class PageBlockRelatedArticles(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.PageBlock`.
    ...
    Parameters:
        title (:obj:`RichText <Botify.raw.base.RichText>`):
            N/A

        articles (List of :obj:`PageRelatedArticle <Botify.raw.base.PageRelatedArticle>`):
            N/A
