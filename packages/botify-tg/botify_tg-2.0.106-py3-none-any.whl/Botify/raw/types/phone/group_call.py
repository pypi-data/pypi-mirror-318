...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <Botify.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <Botify.raw.base.GroupCallParticipant>`):
            N/A
