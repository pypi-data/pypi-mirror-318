...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <Botify.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <Botify.raw.base.VideoSize>`, *optional*):
            N/A
