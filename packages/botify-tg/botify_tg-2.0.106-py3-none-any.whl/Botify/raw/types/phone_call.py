...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <Botify.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <Botify.raw.base.PhoneConnection>`):
            N/A
