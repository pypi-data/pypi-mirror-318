...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <Botify.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <Botify.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <Botify.raw.base.SecureValueError>`):
            N/A
