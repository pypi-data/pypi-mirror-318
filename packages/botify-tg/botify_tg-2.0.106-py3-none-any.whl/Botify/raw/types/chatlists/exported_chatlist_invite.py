...
class ExportedChatlistInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.chatlists.ExportedChatlistInvite`.
    ...
    Parameters:
        filter (:obj:`DialogFilter <Botify.raw.base.DialogFilter>`):
            N/A

        invite (:obj:`ExportedChatlistInvite <Botify.raw.base.ExportedChatlistInvite>`):
            N/A
