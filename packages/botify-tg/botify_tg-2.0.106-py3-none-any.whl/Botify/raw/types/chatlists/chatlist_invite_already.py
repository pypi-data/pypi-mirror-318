...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <Botify.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <Botify.raw.base.Peer>`):
            N/A
