...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~Botify.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <Botify.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <Botify.raw.base.VideoSize>`, *optional*):
            N/A
