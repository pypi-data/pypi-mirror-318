...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <Botify.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <Botify.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <Botify.raw.base.account.EmailVerified>`
    """
