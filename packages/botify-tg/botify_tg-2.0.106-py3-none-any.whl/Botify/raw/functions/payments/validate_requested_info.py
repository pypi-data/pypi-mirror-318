...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <Botify.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <Botify.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <Botify.raw.base.payments.ValidatedRequestedInfo>`
    """
