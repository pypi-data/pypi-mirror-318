...
class TranslateText(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        peer (:obj:`InputPeer <Botify.raw.base.InputPeer>`, *optional*):
            N/A

        id (List of ``int`` ``32-bit``, *optional*):
            N/A

        text (List of :obj:`TextWithEntities <Botify.raw.base.TextWithEntities>`, *optional*):
            N/A

    Returns:
        :obj:`messages.TranslatedText <Botify.raw.base.messages.TranslatedText>`
    """
