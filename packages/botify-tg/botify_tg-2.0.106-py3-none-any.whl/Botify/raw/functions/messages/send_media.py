...
class SendMedia(TLObject):  # type: ignore
    ...
    Parameters:
        peer (:obj:`InputPeer <Botify.raw.base.InputPeer>`):
            N/A

        media (:obj:`InputMedia <Botify.raw.base.InputMedia>`):
            N/A
        ...
        send_as (:obj:`InputPeer <Botify.raw.base.InputPeer>`, *optional*):
            N/A

    Returns:
        :obj:`Updates <Botify.raw.base.Updates>`
    """
