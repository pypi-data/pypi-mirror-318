...
class Search(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`MessagesFilter <Botify.raw.base.MessagesFilter>`):
            N/A
        ...
        from_id (:obj:`InputPeer <Botify.raw.base.InputPeer>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`messages.Messages <Botify.raw.base.messages.Messages>`
    """
