...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <Botify.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <Botify.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <Botify.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <Botify.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <Botify.raw.base.photos.Photo>`
    """
