...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~Botify.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <Botify.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <Botify.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~Botify.raw.types`
    """
