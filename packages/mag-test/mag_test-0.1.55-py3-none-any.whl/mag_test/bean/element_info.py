...
class ElementInfo:
    ...
    def action(self) -> Optional[ActionType]:
        ...
        操作类型
        """
        return ActionType.of_code(self.menu_item) if self.menu_item else ActionType.default_action(self.control_type)
    ...
    def menu_item(self) -> Optional[str]:
        ...
        return items[2] if items and len(items) == 3 else None
