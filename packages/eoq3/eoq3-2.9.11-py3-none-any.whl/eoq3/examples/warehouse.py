...
def CreateWarehouseM2Model(domain:Domain, sessionId:str=None)->Obj:
    ...
    cmd = Cmp().Crt(STR('*M2MODEL'),U32(1),LST([STR('warehouse')]),NON(),LST([]),resName='o0')\
               ...
               .Crt(STR('*M2CLASS'),U32(1),LST([STR('Article'),BOL(False),His(STR('o0'))]),NON(),LST([]),resName='o3')\
               ...
               .Crt(STR('*M2COMPOSITION'),U32(1),LST([STR('articles'),His(STR('o2')),His(STR('o3')),I64(-1),BOL(False)]),NON(),LST([]),resName='o7')\
...
def CreateWarehouseM1Model(domain:Domain, sessionId=None)->Obj:
          ...
          <categories name="food">
            <categories name="fresh">
              <categories name="fruit">
                <articles name="Apple" sells="400" price="0.25"/>
                <articles name="Banana" sells="1" price="0.35"/>
                <articles name="Orange" sells="20" price="0.45"/>
                <articles name="Melon" sells="2" price="1.1"/>
              </categories>
              <categories name="vegetables">
                <articles name="Cucumber" sells="4" price="0.5"/>
                <articles name="Lettuce" sells="2" price="0.8"/>
              </categories>
              <categories name="milk">
                <articles name="Cream" sells="300" price="0.5"/>
                <articles name="Milk" sells="700" price="0.6"/>
                <categories name="cheese">
                  <articles name="Goat Cheese" price="5.0"/>
                  <articles name="Gouda" sells="100" price="2.0"/>
                </categories>
              </categories>
            </categories>
            <categories name="drinks">
              <articles name="Coffee" sells="100" price="2.0"/>
              <articles name="Hot Chocolate" sells="1" price="2.5"/>
              <categories name="lemonade">
                <articles name="Coke" sells="1000" price="1.0"/>
                <articles name="Energy Drink" price="10.0"/>
              </categories>
            </categories>
          </categories>
        </warehouse>
    ...
    cmd = Cmp().Crt(STR('*M1MODEL'),U32(1),LST([STR('warehouse'),STR('m1model')]),NON(),LST([]),resName='o0')\
               ...
               .Crt(STR('*M1OBJECT'),U32(1),LST([STR('warehouse__Article'),His(STR('o0')),STR('Apple')]),NON(),LST([]),resName='o5')\
               ...
               .Crt(STR('*M1COMPOSITION'),U32(1),LST([STR('articles'),His(STR('o4')),His(STR('o5'))]),NON(),LST([]))\
               .Crt(STR('*M1OBJECT'),U32(1),LST([STR('warehouse__Article'),His(STR('o0')),STR('Banana')]),NON(),LST([]),resName='o6')\
               ...
               .Crt(STR('*M1COMPOSITION'),U32(1),LST([STR('articles'),His(STR('o4')),His(STR('o6'))]),NON(),LST([]))\
               .Crt(STR('*M1OBJECT'),U32(1),LST([STR('warehouse__Article'),His(STR('o0')),STR('Orange')]),NON(),LST([]),resName='o7')\
               ...
               .Crt(STR('*M1COMPOSITION'),U32(1),LST([STR('articles'),His(STR('o4')),His(STR('o7'))]),NON(),LST([]))\
               .Crt(STR('*M1OBJECT'),U32(1),LST([STR('warehouse__Article'),His(STR('o0')),STR('Melon')]),NON(),LST([]),resName='o8')\
               ...
               .Crt(STR('*M1COMPOSITION'),U32(1),LST([STR('articles'),His(STR('o4')),His(STR('o8'))]),NON(),LST([]))\
               ...
               .Crt(STR('*M1OBJECT'),U32(1),LST([STR('warehouse__Article'),His(STR('o0')),STR('Cucumber')]),NON(),LST([]),resName='o10')\
               ...
               .Crt(STR('*M1COMPOSITION'),U32(1),LST([STR('articles'),His(STR('o9')),His(STR('o10'))]),NON(),LST([]))\
               .Crt(STR('*M1OBJECT'),U32(1),LST([STR('warehouse__Article'),His(STR('o0')),STR('Lettuce')]),NON(),LST([]),resName='o11')\
               ...
               .Crt(STR('*M1COMPOSITION'),U32(1),LST([STR('articles'),His(STR('o9')),His(STR('o11'))]),NON(),LST([]))\
               ...
               .Crt(STR('*M1OBJECT'),U32(1),LST([STR('warehouse__Article'),His(STR('o0')),STR('Goat Cheese')]),NON(),LST([]),resName='o14')\
               ...
               .Crt(STR('*M1COMPOSITION'),U32(1),LST([STR('articles'),His(STR('o13')),His(STR('o14'))]),NON(),LST([]))\
               .Crt(STR('*M1OBJECT'),U32(1),LST([STR('warehouse__Article'),His(STR('o0')),STR('Gouda')]),NON(),LST([]),resName='o15')\
               ...
               .Crt(STR('*M1COMPOSITION'),U32(1),LST([STR('articles'),His(STR('o13')),His(STR('o15'))]),NON(),LST([]))\
               .Crt(STR('*M1COMPOSITION'),U32(1),LST([STR('categories'),His(STR('o12')),His(STR('o13'))]),NON(),LST([]))\
               .Crt(STR('*M1OBJECT'),U32(1),LST([STR('warehouse__Article'),His(STR('o0')),STR('Cream')]),NON(),LST([]),resName='o16')\
               ...
               .Crt(STR('*M1COMPOSITION'),U32(1),LST([STR('articles'),His(STR('o12')),His(STR('o16'))]),NON(),LST([]))\
               .Crt(STR('*M1OBJECT'),U32(1),LST([STR('warehouse__Article'),His(STR('o0')),STR('Milk')]),NON(),LST([]),resName='o17')\
               ...
               .Crt(STR('*M1COMPOSITION'),U32(1),LST([STR('articles'),His(STR('o12')),His(STR('o17'))]),NON(),LST([]))\
               ...
               .Crt(STR('*M1OBJECT'),U32(1),LST([STR('warehouse__Article'),His(STR('o0')),STR('Coke')]),NON(),LST([]),resName='o20')\
               ...
               .Crt(STR('*M1COMPOSITION'),U32(1),LST([STR('articles'),His(STR('o19')),His(STR('o20'))]),NON(),LST([]))\
               .Crt(STR('*M1OBJECT'),U32(1),LST([STR('warehouse__Article'),His(STR('o0')),STR('Energy Drink')]),NON(),LST([]),resName='o21')\
               ...
               .Crt(STR('*M1COMPOSITION'),U32(1),LST([STR('articles'),His(STR('o19')),His(STR('o21'))]),NON(),LST([]))\
               .Crt(STR('*M1COMPOSITION'),U32(1),LST([STR('categories'),His(STR('o18')),His(STR('o19'))]),NON(),LST([]))\
               .Crt(STR('*M1OBJECT'),U32(1),LST([STR('warehouse__Article'),His(STR('o0')),STR('Coffee')]),NON(),LST([]),resName='o22')\
               ...
               .Crt(STR('*M1COMPOSITION'),U32(1),LST([STR('articles'),His(STR('o18')),His(STR('o22'))]),NON(),LST([]))\
               .Crt(STR('*M1OBJECT'),U32(1),LST([STR('warehouse__Article'),His(STR('o0')),STR('Hot Chocolate')]),NON(),LST([]),resName='o23')\
               ...
               .Crt(STR('*M1COMPOSITION'),U32(1),LST([STR('articles'),His(STR('o18')),His(STR('o23'))]),NON(),LST([]))\
