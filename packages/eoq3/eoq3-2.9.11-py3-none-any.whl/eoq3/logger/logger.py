...
#     L0_SILENT  = []
#     L1_ERROR   = [LOG_LEVEL_NAMES.ERROR]
#     L2_WARNING = [LOG_LEVEL_NAMES.WARN, LOG_LEVEL_NAMES.ERROR]
#     L3_INFO    = [LOG_LEVEL_NAMES.INFO, LOG_LEVEL_NAMES.WARN, LOG_LEVEL_NAMES.ERROR]
#     L4_DEBUG   = [LOG_LEVEL_NAMES.INFO, LOG_LEVEL_NAMES.WARN, LOG_LEVEL_NAMES.ERROR, LOG_LEVEL_NAMES.DEBUG]
