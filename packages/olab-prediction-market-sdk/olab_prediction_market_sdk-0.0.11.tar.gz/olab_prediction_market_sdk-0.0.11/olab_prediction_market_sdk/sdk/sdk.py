...
class Client:
    ...
    def get_markets(self):
        thread = self.api.openapi_topic_get_with_http_info(self.conf.api_key)
        result = thread.get()
        return result
    ...
    def get_market(self, market_id):
        try:
            ...
            thread = self.api.openapi_topic_topic_id_get_with_http_info(self.conf.api_key, market_id)
            result = thread.get()
            return result
    ...
    def get_categorical_market(self, market_id):
        try:
            ...
            thread = self.api.openapi_topic_multi_topic_id_get_with_http_info(self.conf.api_key, market_id)
            result = thread.get()
            return result
        except InvalidParamError as e:
            logging.error(f"Validation error: {e}")
    ...
    def get_candles(self, token_id, interval="1hour", start_time=int(time.time()), bars=60):
        try:
            ...
            thread = self.api.openapi_order_kline_get_with_http_info(self.conf.api_key, token_id, interval, start_time, bars)
            result = thread.get()
            return result
        except InvalidParamError as e:
            logging.error(f"Validation error: {e}")
    ...
    def get_orderbook(self, token_id):
        try:
            ...
            thread = self.api.openapi_orderbook_get_with_http_info(self.conf.api_key, token_id)
            result = thread.get()
            return result
        except InvalidParamError as e:
            logging.error(f"Validation error: {e}")
    ...
    def get_depth(self, token_id, limit=10):
        try:
            ...
            thread = self.api.openapi_depth_get_with_http_info(self.conf.api_key, token_id, limit)
            result = thread.get()
            return result
        except InvalidParamError as e:
            logging.error(f"Validation error: {e}")
    ...
    def get_my_open_orders(self, market_id=0, limit=10):
        try:
            ...
            thread = self.api.openapi_order_get_with_http_info(self.conf.api_key, market_id, limit)
            return thread.get()
        except InvalidParamError as e:
            logging.error(f"Validation error: {e}")
            raise
    ...
    def get_my_positions(self, market_id=0, page=1, pageSize=10):
        try: 
            ...
            thread = self.api.openapi_portfolio_get_with_http_info(self.conf.api_key, market_id, page, pageSize)
            return thread.get()
        except InvalidParamError as e:
            logging.error(f"Validation error: {e}")
            raise
    ...
    def get_my_balances(self):
        try:
            thread = self.api.openapi_balance_get_with_http_info(self.conf.api_key)
            return thread.get()
        except Exception as e:
            logging.error(f"API error: {e}")
    ...
    def get_my_trades(self, market_id=0, limit=10):
        try:
            ...
            thread = self.api.openapi_trade_get_with_http_info(self.conf.api_key, market_id, limit)
            return thread.get()
        except InvalidParamError as e:
            logging.error(f"Validation error: {e}")
            raise
