...
@jsii.data_type(
    jsii_type="tailscale-lambda-proxy.LambdaOptions",
    jsii_struct_bases=[],
...
class LambdaOptions:
    def __init__(self, *, function_name: typing.Optional[builtins.str] = None) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6fa062c2508f4ee3debb78110b5b47a992fad612025d42175749ce804159b8d3)
...
class TailscaleLambdaProxy(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        options: typing.Union["TailscaleLambdaProxyPropsOptions", typing.Dict[builtins.str, typing.Any]],
        ts_hostname: builtins.str,
        ts_secret_api_key: _aws_cdk_aws_secretsmanager_ceddda9d.Secret,
    ) -> None:
        '''
        :param scope: -
        :param id: -
...
class TailscaleLambdaProxyProps:
    ...
    @builtins.property
    def options(self) -> "TailscaleLambdaProxyPropsOptions":
        result = self._values.get("options")
        assert result is not None, "Required property 'options' is missing"
        return typing.cast("TailscaleLambdaProxyPropsOptions", result)
    ...
    @builtins.property
    def ts_secret_api_key(self) -> _aws_cdk_aws_secretsmanager_ceddda9d.Secret:
...
class TailscaleLambdaProxyPropsOptions:
    def __init__(
        self,
        *,
        extension: typing.Union[_tailscale_lambda_extension_3efe799a.TailscaleLambdaExtensionProps, typing.Dict[builtins.str, typing.Any]],
        lambda_: typing.Union[LambdaOptions, typing.Dict[builtins.str, typing.Any]],
    ) -> None:
        '''
        :param extension: 
        :param lambda_: 
        ...
        if isinstance(extension, dict):
            extension = _tailscale_lambda_extension_3efe799a.TailscaleLambdaExtensionProps(**extension)
        if isinstance(lambda_, dict):
            lambda_ = LambdaOptions(**lambda_)
        if __debug__:
    ...
    def extension(
        self,
    ) -> _tailscale_lambda_extension_3efe799a.TailscaleLambdaExtensionProps:
        result = self._values.get("extension")
        assert result is not None, "Required property 'extension' is missing"
        return typing.cast(_tailscale_lambda_extension_3efe799a.TailscaleLambdaExtensionProps, result)

    @builtins.property
    def lambda_(self) -> LambdaOptions:
        result = self._values.get("lambda_")
        assert result is not None, "Required property 'lambda_' is missing"
        return typing.cast(LambdaOptions, result)
...
def _typecheckingstub__6fa062c2508f4ee3debb78110b5b47a992fad612025d42175749ce804159b8d3(
    *,
