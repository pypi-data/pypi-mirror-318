...
from .compute_statistics_off import ComputeStatisticsOff
from .compute_statistics_on import ComputeStatisticsOn
from .time_explicit import TimeExplicit
from .time_implicit import TimeImplicit
from .time_marching import TimeMarching
from .time_step_ramp import TimeStepRamp
from .time_step_ramp_off import TimeStepRampOff
from .time_step_ramp_on import TimeStepRampOn
...
class Time(ParamGroupWrapper[clientpb.Time]):
    ...
    def _to_proto(self) -> clientpb.Time:
        ...
        _proto.time_step_val.value = self.time_step
        ...
        if isinstance(self.time_step_ramp, TimeStepRampOn):
            ...
            _proto.time_step_ramp_initial_val.value = self.time_step_ramp.inital_time_step
    ...
    def _from_proto(self, proto: clientpb.Time) -> None:
        ...
        self.time_step = proto.time_step_val.value
        if proto.time_step_ramp == clientpb.INVALID_TIME_STEP_RAMP:
            ...
            self.time_step_ramp.inital_time_step = proto.time_step_ramp_initial_val.value
