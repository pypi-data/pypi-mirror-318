...
class AdjointControlsFluid(ParamGroupWrapper[clientpb.AdjointControlsFluid]):
    ...
    def _to_proto(self) -> clientpb.AdjointControlsFluid:
        ...
        _proto.adjoint_solution_method = self.solution_method
        _proto.adjoint_gmres_restart_iters.value = self.gmres_restart_iters
        _proto.adjoint_second_order_damping.value = self.second_order_damping
        if self.frozen_turbulence is not None:
            _proto.adjoint_frozen_turbulence = self.frozen_turbulence
        if self.frozen_transition is not None:
    ...
    def _from_proto(self, proto: clientpb.AdjointControlsFluid) -> None:
        ...
        self.second_order_damping = proto.adjoint_second_order_damping.value
