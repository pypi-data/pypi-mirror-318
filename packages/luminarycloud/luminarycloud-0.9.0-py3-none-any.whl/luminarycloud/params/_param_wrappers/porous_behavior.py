...
class PorousBehavior(ParamGroupWrapper[clientpb.PorousBehavior]):
    ...
    def _to_proto(self) -> clientpb.PorousBehavior:
        ...
        if self.power_per_unit_volume is not None:
            _proto.porous_heat_source_power_per_unit_volume.value = self.power_per_unit_volume
    ...
    def _from_proto(self, proto: clientpb.PorousBehavior) -> None:
        ...
        self.power_per_unit_volume = proto.porous_heat_source_power_per_unit_volume.value
