...
class HeatBcHeatFlux(BoundaryConditionsHeat):
    ...
    def _to_proto(self) -> clientpb.BoundaryConditionsHeat:
        ...
        _proto.heat_physical_boundary = enum.HeatPhysicalBoundary.HEAT_BC_HEAT_FLUX
        _proto.fixed_heat_flux.value = self.heat_flux
        return _proto

    def _from_proto(self, proto: clientpb.BoundaryConditionsHeat) -> None:
        super()._from_proto(proto)
        assert proto.heat_physical_boundary == enum.HeatPhysicalBoundary.HEAT_BC_HEAT_FLUX
        self.heat_flux = proto.fixed_heat_flux.value
        return None
