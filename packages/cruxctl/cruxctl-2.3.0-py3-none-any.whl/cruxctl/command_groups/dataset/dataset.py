...
def get_logs(
    ...
    execution_date: Annotated[
        str,
        typer.Option("--execution-date", "-ed", help="Optional Execution date filter"),
    ] = None,
        ...
        try:
            ...
            if "entries" in response and response["entries"]:
                for entry in response["entries"]:
                    ...
                    json_payload = entry.get("jsonPayload", None)

                    if json_payload:
                        msg = json_payload.get("msg", None)
                        if msg:
                            console.print(f"[{entry_time}] {msg}")
                    if text_payload:
