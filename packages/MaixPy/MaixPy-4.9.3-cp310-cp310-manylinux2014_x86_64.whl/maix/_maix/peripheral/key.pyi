...
import typing
__all__ = ['Key', 'Keys', 'State', 'add_default_listener', 'rm_default_listener']
class Key:
...
class Keys:
    ...
    __members__: typing.ClassVar[dict[str, Keys]]  # value = {'KEY_NONE': <Keys.KEY_NONE: 0>, 'KEY_ESC': <Keys.KEY_ESC: 1>, 'KEY_POWER': <Keys.KEY_POWER: 116>, 'KEY_OK': <Keys.KEY_OK: 352>, 'KEY_OPTION': <Keys.KEY_OPTION: 357>, 'KEY_NEXT': <Keys.KEY_NEXT: 407>, 'KEY_PREV': <Keys.KEY_PREV: 412>}
