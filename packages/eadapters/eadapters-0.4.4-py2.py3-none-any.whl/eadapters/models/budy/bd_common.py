...
class BDCommon(object):
    ...
    def bd_id_e(cls, value, default=None):
        return cls._bd_type_e(value, int, default=default)

    @classmethod
    def bd_unicode_e(cls, value, default=None):
        return cls._bd_type_e(value, appier.legacy.UNICODE, default=default)
    ...
    def bd_unicode_d(cls, model, attribute, default=None):
        return cls._bd_type_d(model, attribute, appier.legacy.UNICODE, default=default)
...
def handle_error(function, fallback=None, code=400, encoding="utf-8"):
    def decorator(*args, **kwargs):
        try:
            ...
            _handle_error(error, fallback=fallback, code=code, encoding=encoding)
