...
from duppla_slack.models import (
    ...
    SlackApiError,
    SlackProfile,
    SlackResponse as SlackResponse,
)
...
class SlackService(SlackLibClient):
    ...
    def send_msg_(
        ...
        **kwargs: Any,
        ...
        return SlackResponse.from_(result)
    ...
    def invitar_canal(self, channel: str, *users: str):
        ...
        try:
            return self.conversations_invite(channel=channel, users=users)
        except SlackApiError as e:
    ...
    def uninvitar_canal(self, channel: str, *users: str) -> list[dict[str, Any]]:
        ...
        for user in users:
            try:
                result = self.conversations_kick(channel=channel, user=user)
