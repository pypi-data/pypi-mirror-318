...
class CircularStraightLineLayoutConfiguration(LayoutConfigurationInterface):
    """Configuration for circular straight line layout."""
    def __init__(self):
        super().__init__('circular_straight_line')
