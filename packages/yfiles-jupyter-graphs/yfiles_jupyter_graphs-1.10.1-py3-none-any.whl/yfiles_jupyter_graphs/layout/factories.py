...
from .configurations import \
    ...
    CircularStraightLineLayoutConfiguration, \
...
class CircularStraightLineLayoutConfigurationFactory(LayoutConfigurationFactoryInterface):
    """factory providing circular straight line layout configuration"""

    # noinspection PyMethodMayBeStatic
    def _get_configuration(self) -> LayoutConfigurationInterface:
        return CircularStraightLineLayoutConfiguration()
...
def _get_layout_factory(name) -> LayoutConfigurationFactoryInterface:
    factories = {
        ...
        "circular_straight_line": CircularStraightLineLayoutConfigurationFactory(),
