...
class PadOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input, paddingsT, left_select, right_select, buffer, paddings, *, val=None, mode=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(input))
    operands.append(_get_op_result_or_value(paddingsT))
