...
const extension = {
    ...
    activate: (app, palette, editorServices, status, componentRegistry, translator) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const openMetadataEditor = (args) => {
            ...
            const openWidget = (0, algorithm_1.find)(app.shell.widgets('main'), (widget, index) => {
        ...
        app.commands.addCommand(closeTabCommand, {
            ...
            execute: (args) => {
                ...
                if (contextNode) {
                    ...
                    const widget = (0, algorithm_1.find)(app.shell.widgets('left'), (widget, index) => {
                        return widget.id === id;
                    });
                    if (widget) {
                        widget.dispose();
...
//# sourceMappingURL=lib_index_js.a5e69f609589dad7b337.js.map