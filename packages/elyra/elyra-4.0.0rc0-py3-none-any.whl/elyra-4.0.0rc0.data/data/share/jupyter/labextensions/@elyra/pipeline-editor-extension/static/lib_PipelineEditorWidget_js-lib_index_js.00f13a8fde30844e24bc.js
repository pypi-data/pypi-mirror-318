...
const EmptyPlatformSpecificPipeline = ({ onOpenCatalog, onOpenSettings }) => {
    ...
    const customComponentsHelpTopicURL = 'https://elyra.readthedocs.io/en/v4.0.0rc0/user_guide/pipeline-components.html';
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(ui_components_1.dragDropIcon.react, { className: "drag-drop-icon", tag: "div", elementPosition: "center", height: "120px" }),
        react_1.default.createElement("h3", { className: HEADER_CLASS },
    ...
    constructor(options) {
        ...
        this.context.fileChanged.connect(() => {
            if (this.context.model.toJSON() === null) {
                const pipelineJson = (0, index_1.getEmptyPipelineJson)(this.defaultRuntimeType);
...
const PipelineWrapper = ({ context, browserFactory, shell, commands, addFileToPipelineSignal, refreshPaletteSignal, settings, widgetId }) => {
                        ...
                        if (migrationError instanceof pipeline_services_1.ComponentNotFoundError) {
                            (0, apputils_1.showDialog)({
                                ...
                                body: (react_1.default.createElement("p", null,
                                    ...
                                    ' ',
                                    react_1.default.createElement("a", { href: "https://elyra.readthedocs.io/en/v4.0.0rc0/user_guide/pipeline-components.html#example-custom-components", target: "_blank", rel: "noreferrer" }, "Example Custom Components"),
                                    ' ',
                                    "and try again.")),
    ...
    const onFileRequested = (args) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if ((_f = args.propertyID) === null || _f === void 0 ? void 0 : _f.includes('dependencies')) {
            const res = yield (0, ui_components_1.showBrowseFileDialog)(browserFactory.model.manager, {
                multiselect: true,
                includeDir: true,
        ...
        if (!componentId) {
            ...
            return (0, apputils_1.showDialog)({
                ...
                body: (react_1.default.createElement("p", null,
                    ...
                    react_1.default.createElement("br", null),
                    react_1.default.createElement("br", null),
                    react_1.default.createElement("a", { href: "https://elyra.readthedocs.io/en/v4.0.0rc0/user_guide/best-practices-custom-pipeline-components.html#troubleshooting-missing-pipeline-components", target: "_blank", rel: "noreferrer" }, "Learn more..."))),
                buttons: [apputils_1.Dialog.okButton()]
            });
        }
    ...
    const handleSubmission = (0, react_1.useCallback)((actionType) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const errorMessages = (0, pipeline_services_1.validate)(JSON.stringify(pipelineJson), getAllPaletteNodes(palette), palette.properties);
        ...
        pipelineJson.pipelines[0].app_data.properties.pipeline_parameters =
            (_j = pipelineJson.pipelines[0].app_data.properties.pipeline_parameters) === null || _j === void 0 ? void 0 : _j.filter((param) => {
        ...
        pipelineJson.pipelines[0].app_data.name =
            (_k = dialogResult.value.pipeline_name) !== null && _k !== void 0 ? _k : pipelineName;
        ...
        // Pipeline name
        pipelineJson.pipelines[0].app_data.name =
            (_p = dialogResult.value.pipeline_name) !== null && _p !== void 0 ? _p : pipelineName;
        // Runtime info
        pipelineJson.pipelines[0].app_data.runtime_config =
            (_q = configDetails === null || configDetails === void 0 ? void 0 : configDetails.id) !== null && _q !== void 0 ? _q : null;
        // Export info
    ...
    const handleClearPipeline = (0, react_1.useCallback)((data) => __awaiter(void 0, void 0, void 0, function* () {
        return (0, apputils_1.showDialog)({
...
class SubmitFileButtonExtension {
    constructor() {
        this.showWidget = (document) => __awaiter(this, void 0, void 0, function* () {
            ...
            const _b = dialogResult.value, { runtime_config, framework, cpu, cpu_limit, gpu, memory, memory_limit, dependency_include, dependencies } = _b, envObject = __rest(_b, ["runtime_config", "framework", "cpu", "cpu_limit", "gpu", "memory", "memory_limit", "dependency_include", "dependencies"]);
            ...
            app.commands.addCommand(openPipelineEditorCommand, {
                label: (args) => {
                    ...
                    if (args.isContextMenu) {
                        return `New ${(_c = args.runtimeType) === null || _c === void 0 ? void 0 : _c.display_name} ${PIPELINE_EDITOR}`;
                    }
...
//# sourceMappingURL=lib_PipelineEditorWidget_js-lib_index_js.00f13a8fde30844e24bc.js.map