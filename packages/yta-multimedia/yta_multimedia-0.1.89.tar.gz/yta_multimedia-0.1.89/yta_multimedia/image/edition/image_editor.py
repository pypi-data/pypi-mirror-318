...
COLOR_HUE_CHANGE_LOWER_LIMIT = 0
COLOR_HUE_CHANGE_UPPER_LIMIT = 360
...
def change_image_color_hue(image: any, hue: int = 0) -> np.ndarray:
    """
    ...
    """
    if not NumberValidator.is_number_between(hue, COLOR_HUE_CHANGE_LOWER_LIMIT, COLOR_HUE_CHANGE_UPPER_LIMIT):
