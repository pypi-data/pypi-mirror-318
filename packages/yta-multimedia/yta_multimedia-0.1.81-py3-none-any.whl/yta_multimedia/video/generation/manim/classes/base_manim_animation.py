...
class NewBaseManimAnimation(Scene):
    def setup(self):
        """
...
# TODO: Remove this when completely confirmed that 
# the class above is working perfectly
class BaseManimAnimation(Scene):
    ...
    def animate(self):
        # This must be implemented by the subclass. This is the
        # that actually generates the animation
        pass
