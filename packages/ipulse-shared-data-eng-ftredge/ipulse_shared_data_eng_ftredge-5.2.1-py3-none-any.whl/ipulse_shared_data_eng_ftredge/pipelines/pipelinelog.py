...
from ipulse_shared_base_ftredge import (ReviewStatus, LogLevel, Unit,
...
class PipelineLog:
    def __init__(
        ...
        **kwargs
        ...
        self._level = self._to_enum(level, LogLevel, default =LogLevel.NOTSET)

        # Convert optional enums - allow None
        self._action = self._to_enum(value=action, enum_class=Action, default=Alert.UNKNOWN)
        self._resource = self._to_enum(resource, Resource, default=DataResource.UNKNOWN)
        self._progress_status = self._to_enum(progress_status, ProgressStatus, default=ProgressStatus.UNKNOWN)
        self._alert = self._to_enum(alert, Alert, default=Alert.UNKNOWN)
        self._log_review_status = self._to_enum(log_review_status, ReviewStatus, default=ReviewStatus.OPEN)

        self._q = q
        self._q_unit = self._to_enum(q_unit, Unit)
    ...
    def level(self, value: Union[LogLevel, str]):
        self._level = self._to_enum(value, LogLevel, required=True)
    ...
    def resource(self, value: Optional[Union[Resource, str]]):
        self._resource = self._to_enum(value, Resource)
    ...
    def action(self, value: Optional[Union[Action, str]]):
        self._action = self._to_enum(value, Action)
    ...
    def progress_status(self, value: Optional[Union[ProgressStatus, str]]):
        self._progress_status = self._to_enum(value, ProgressStatus)
    ...
    def alert(self, value: Optional[Union[Alert, str]]):
        self._alert = self._to_enum(value, Alert)
    ...
    def log_review_status(self, value: ReviewStatus):
        self._log_review_status = self._to_enum(value, ReviewStatus, default=ReviewStatus.OPEN)
    ...
    def q_unit(self, value: Optional[Union[Unit, str]]):
        self._q_unit = self._to_enum(value, Unit)
    ...
    def getEvent(self, exclude_none: bool = True, as_dict: bool = False) -> Union[Dict[str, Any], Tuple[Any, ...]]:
        """
    ...
    def _to_enum(self, value: Any, enum_class: type, required: bool = False, default: Any = None) -> Optional[Any]:
    ...
    def _format_traceback(self, e_traceback, e_message:Optional[str]=None ) -> Optional[str]:
        ...
        if len(e_traceback) > self.max_field_len:
            self.truncated = True
            truncated_length = self.max_field_len - len('... (truncated) ...')
    ...
    def _create_initial_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "q": self.q,  # Already string from property
            "q_unit": self.q_unit.name if self.q_unit else None, # Enum
            "collector_id": self.collector_id,  # Already string from property
            ...
            "log_review_status": self.log_review_status.name,  # Enum
