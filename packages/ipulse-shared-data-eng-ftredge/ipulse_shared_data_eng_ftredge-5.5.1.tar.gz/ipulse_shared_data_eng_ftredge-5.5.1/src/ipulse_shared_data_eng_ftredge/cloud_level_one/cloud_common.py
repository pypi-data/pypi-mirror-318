...
from .cloud_gcp import (write_file_to_gcs_extended,
                        ...
                        get_secret_from_gcp_secret_manager_extended)
...
def get_secret_from_cloud_provider_extended(
    secret_id: str,
    secret_manager_type: DataResource=DataResource.SECRET_MANAGER,
    ...
    supported_providers = [DataResource.SECRET_MANAGER]

    if secret_manager_type == DataResource.SECRET_MANAGER:
...
def write_file_to_cloud_storage_extended(cloud_storage:CloudProvider | DataResource, storage_client, data:dict | list | str, bucket_name: str, file_path: str,
                      duplication_handling:DuplicationHandling,  duplication_match_condition_type: MatchCondition, duplication_match_condition: str = "",
