...
from ipulse_shared_data_eng_ftredge.pipelines.op_result import OpResult
...
class TestHandlePipelineOperationException(unittest.TestCase):
    ...
    def test_handle_exception_with_op_result(self):
        ...
        self.assertTrue("EXCEPTION" in self.op_result.execution_state[-2])
    ...
    def test_handle_exception_with_dict_result(self):
        ...
        self.assertEqual(result_dict["status"]["overall_status"], ProgressStatus.FAILED)
