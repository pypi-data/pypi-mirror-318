...
class Wav(Modulation):
    ...
    def with_timeout(self: Wav, timeout: Duration | None) -> DatagramWithTimeout[Wav]: ...
    ...
    @staticmethod
    def new_with_resample(path: Path, target: SamplingConfig | Freq[int] | Freq[float] | Duration, resampler: Resampler) -> Wav: ...
