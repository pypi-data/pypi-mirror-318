...
class _TwinCATBuilder(LinkBuilder[TwinCAT]):
    def _resolve_link(self: _TwinCATBuilder, handle: HandlePtr, ptr: ControllerPtr) -> TwinCAT: ...
...
class _RemoteTwinCATBuilder(LinkBuilder[RemoteTwinCAT]):
    ...
    def _resolve_link(self: _RemoteTwinCATBuilder, handle: HandlePtr, _ptr: ControllerPtr) -> RemoteTwinCAT: ...
