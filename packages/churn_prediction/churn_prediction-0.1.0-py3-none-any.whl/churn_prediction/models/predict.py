"""
Este módulo carrega um modelo treinado, realiza predições em um conjunto de teste e
calcula métricas de avaliação. Os resultados e métricas são salvos em arquivos CSV e de texto.
"""
...
from src.config import MODEL_PATH, TEST_DATA_PATH, PREDICTIONS_PATH, PREDICTIONS_FILE
