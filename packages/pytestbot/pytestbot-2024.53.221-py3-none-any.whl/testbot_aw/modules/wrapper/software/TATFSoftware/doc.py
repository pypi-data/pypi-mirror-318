...
import types
import importlib
from testbot.resource.module import TATFSoftwareWrapperModuleBase


class DocWrapperModule(TATFSoftwareWrapperModuleBase):
    """
    TATF测试软件源封装接口文档模块类
    """
