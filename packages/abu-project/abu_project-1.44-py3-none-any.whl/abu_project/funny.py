...
class FunnyFuncs:
    ...
    def fahrenheit_to_celsius(self, fahrenheit_temperatures: int) -> str:
        """
    ...
    def celsius_to_fahrenheit(self, celsius: int) -> str:
        """
...
if __name__ == "__main__":
    f: FunnyFuncs = FunnyFuncs()
    print(f.celsius_to_fahrenheit(40))