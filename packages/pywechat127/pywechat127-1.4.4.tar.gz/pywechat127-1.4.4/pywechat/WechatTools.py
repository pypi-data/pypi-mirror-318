...
class API():
    ...
    '''
    @staticmethod
    def open_wechat_miniprogram(program_name:str,load_delay:int=2,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True,close_program_pane:bool=True):
        '''
    ...
    @staticmethod
    def open_wechat_official_account(official_acount_name:str,load_delay:int=2,wechat_path:str=None,is_maximize:bool=True,close_wechat:bool=True):
        '''
