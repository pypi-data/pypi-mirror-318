...
from Helpers.Message import BLOB_STORAGE_SAVE_FAILED, BLOB_STORAGE_DELETE_FAILED
from Helpers.Constant import STATUS_ERROR, CONNECTION_STRING, CONTAINER_NAME
...
class BlobStorage: 
    ...
    def store_file(self, file_bytes:bytes, file_path:str) -> str:
        try:
