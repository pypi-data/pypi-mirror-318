...
@pytest.mark.vcr
def test_error_long(fake_accident_id, capall):
    bingo = BingoService()
    ...
    assert capall.log() == [
        (
            "INFO",
            f"[pid:{getpid()}] Setting up BingoService with BASE_URL='https://httpbingo.org' TIMEOUT=60 RETRIES=3 VERIFY=True",
        ),
        (
            "WARNING",
            "[01:79200.00] __exit__ !> OkError(1, event_id=20241212:01:79200.00)",
        ),
        (
            "WARNING",
            f""" (renderer: NoneType)
...
Traceback (most recent call last):
  File "{__file__}", line 69, in error_long_wrap_2
    return error_long_wrap_3()"""
            + (
                """
           ^^^^^^^^^^^^^^^^^^^"""
            ...
            + f"""
  File "{__file__}", line 67, in error_long_wrap_3
    return error_long_wrap_4()"""
            + (
                """
           ^^^^^^^^^^^^^^^^^^^"""
            ...
            + f"""
  File "{__file__}", line 65, in error_long_wrap_4
    return error_long_wrap_5()"""
            + (
                """
           ^^^^^^^^^^^^^^^^^^^"""
            ...
            + f"""
  File "{__file__}", line 63, in error_long_wrap_5
    return error_long_wrap_6()"""
            + (
                """
           ^^^^^^^^^^^^^^^^^^^"""
            ...
            + f"""
  File "{__file__}", line 61, in error_long_wrap_6
    raise OkError(details=[1], event_id=ctx.event_id)
...
def test_error(fake_accident_id, capall):
    ...
    assert capall.log() == [
        ...
        (
            "INFO",
            "[01:79200.00] GET https://httpbingo.org/status/599 +[]",
        ),
        (
            "INFO",
...
============================================================================================================================================""",
        ...
        (
            "WARNING",
            "[01:79200.00] __exit__ !> OkError(event_id=20241212:01:79200.00)",
        ),
    ]
...
def test_decoding(fake_accident_id, capall):
    ...
    assert capall.log() == [
        ...
        (
            "INFO",
            "[01:79200.00] GET https://httpbingo.org/status/418 +[]",
        ),
        (
            "INFO",
...
============================================================================================================================================""",
        ...
        (
            "ERROR",
            "[01:79200.00] GET https://httpbingo.org/status/418 !> failed: DecodeError(418, event_id=20241212:01:79200.00)",
        ),
        (
            "WARNING",
            "[01:79200.00] __exit__ !> DecodeError(418, event_id=20241212:01:79200.00)",
        ),
        (
            "ERROR",
            f""" (renderer: NoneType)
...
---------------------------------------------------------------- traceback -----------------------------------------------------------------
Traceback (most recent call last):
  File "{__file__}", line 260, in test_decoding
    bingo.json()
  File "{__file__}", line 78, in json
    return ctx.request("GET", "status/418", accept_statuses=[418]).json"""
            + (
                """
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^"""
            ...
            + f"""
  File "{service.__file__}", line 164, in request
    return self.handle_process_response("""
           ...
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^"""
            ...
            + f"""
  File "{service.__file__}", line 137, in handle_process_response
  ...
  File "{service.__file__}", line 164, in request
    return self.handle_process_response("""
           ...
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^"""
            ...
            + f"""
  File "{service.__file__}", line 131, in handle_process_response
...
Traceback (most recent call last):
  File "{__file__}", line 333, in test_logging
    bingo.error()
