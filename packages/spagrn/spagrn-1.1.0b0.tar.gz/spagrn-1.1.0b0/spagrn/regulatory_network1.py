...
from .autocor import spatial_autocorrelation, combind_fdrs, new_autocorrelation
from .corexp import global_bivariate_morans_R, global_bivariate_gearys_C
...
class InferNetwork(Network):
    ...
    def spg(self,
        ...
        if cache and os.path.isfile(fn):
            ...
            hs_genes = select_genes(more_stats, fdr_threshold=fdr_threshold, local=local, combine=combine)
