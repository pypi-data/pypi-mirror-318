...
class AssetServer:
    ...
    def __init__(self, logger: Logger):
        ...
        self.id_symbol_map: bidict[str, str] = bidict()
        self.id_token_map: defaultdict[str, set[Token]] = defaultdict(set)
    ...
    async def _register_token[ChainType: Chain](
        self,
        *,
        coingecko_id: str,
        ...
        self.id_symbol_map.forceput(coingecko_id, symbol)
        ...
        self.id_token_map[coingecko_id].add(token)
    ...
    async def get_asset_info(
        ...
        token = await self._register_token(
            coingecko_id=asset_info.id,
