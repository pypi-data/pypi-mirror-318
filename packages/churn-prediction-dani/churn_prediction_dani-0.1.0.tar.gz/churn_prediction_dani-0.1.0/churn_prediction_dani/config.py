"""
Este módulo define os caminhos principais e específicos do projeto, como diretórios para dados,
modelos, e arquivos processados. Ele centraliza as definições de caminhos para facilitar a
manutenção e reutilização em diferentes partes do código.
"""
...
RAW_DATA_PATH = RAW_DIR / "churn.xlsx"
