...
Arguments:
    ...
    colors: Make the Pixel Art with the colors of your choice. You also can choose the number of colors, here is the choices : 2_COLORS, 16_VGA_COLORS and 256_VGA_COLORS.
    by: You decide the Pixel Art is by how much .
