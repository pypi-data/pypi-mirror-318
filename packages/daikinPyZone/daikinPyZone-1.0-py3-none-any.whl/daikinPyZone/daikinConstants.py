...
C_DaikinDataAcState = \
    bytearray([0xE1, 0x01, 0x13, 0x01, 0x01, 0xB0, 0x08, 0xFF, 0xFF, 0x0, 0xFF, 0x0, 0xFF, 0xFF, 0xFF])

# Daikin Data Request - 8 bytes. Byte 8 is used to select ac internal mode
...
# Daikin Data Request - 9 bytes. Byte 8 is used to select desired temp sensor (in this case refrigerant)
C_DaikinDataControlInfoTemp = bytearray([0xE1, 0x01, 0x13, 0x01, 0x01, 0xC0, 0x02, 0x41, 0xFF])

# Daikin Checksum - 2bytes.
...
C_DaikinDelay_SyncSetting = 5               # Delay between submitting a setting and being able to read it back again
