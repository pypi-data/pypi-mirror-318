...
class ChatHFClient:
    ...
    async def create(cls, headless=True):
        instance = cls()
        await instance._init(headless=headless)
        return instance
    ...
    class Completions:
        ...
        async def create(
            ...
            **kwargs
            ...
            try:
                if stream:
                    return self._create_streaming(prompt,system_prompt, web_search, max_wait_time,
                                                  conversation_id=conversation_id
                                                  )
                else:
                    return await self._create_normal(prompt, system_prompt,web_search, max_wait_time,
                    conversation_id = conversation_id
                    )
        ...
        async def _create_normal(self, prompt: str, system_prompt,web_search: bool, max_wait_time: int,
                                 conversation_id:str="") -> ChatCompletion:
        ...
        async def _create_streaming(self, prompt: str, system_prompt,web_search: bool, max_wait_time: int,
                                    conversation_id:str = "") -> AsyncIterator[ChatCompletionChunk]:
