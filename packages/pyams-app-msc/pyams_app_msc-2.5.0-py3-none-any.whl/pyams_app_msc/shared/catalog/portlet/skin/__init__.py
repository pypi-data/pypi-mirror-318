...
@implementer(IAggregatedPortletRendererSettings)
class CatalogViewItemsPortletPanelsRendererSettings(FilterContainer, ViewItemsPortletPanelsRendererSettings):
    """Catalog view items portlet panels renderer settings"""

    filters_css_class = FieldProperty(ICatalogViewItemsPortletPanelsRendererSettings['filters_css_class'])
    results_css_class = FieldProperty(ICatalogViewItemsPortletPanelsRendererSettings['results_css_class'])
