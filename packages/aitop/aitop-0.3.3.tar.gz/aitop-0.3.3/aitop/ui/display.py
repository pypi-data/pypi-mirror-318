...
class Display:
    ...
    def __init__(self, stdscr, theme_file: Optional[Path] = None):
        ...
        self.current_theme = self._detect_distribution() 
    ...
    def _load_themes(self, theme_file: Optional[Path] = None) -> Dict:
        ...
        try:
            ...
            import logging
            logging.error(f"Theme loading error: {e}")
    ...
    def _detect_distribution(self) -> str:
        ...
        # Fallback to terminal color detection
        return self._detect_terminal_theme()
