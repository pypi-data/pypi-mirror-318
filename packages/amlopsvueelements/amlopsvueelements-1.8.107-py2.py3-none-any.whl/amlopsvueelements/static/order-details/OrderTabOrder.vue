        ...
        <div class="order-step-content compliance-status w-full flex flex-col p-[0.75rem] gap-2">
          ...
          <div class="w-full flex gap-2">
            ...
            <div
              ...
              :style="{
                color: orderStatus?.status?.status_details?.text_colour_hex,
                backgroundColor: orderStatus?.status?.status_details?.fill_colour_hex
              }"
            >
              {{ orderStatus?.status?.status_details?.name }}
            </div>
          </div>
        </div>
      </div>
